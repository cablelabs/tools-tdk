...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'boxManufacturer.label', default: 'BoxManufacturer')}" />
	...
	<body>
		...
		<div id="list-boxManufacturer" class="content scaffold-list" role="main">
			...
			<table style="width:70%; align: left;">
				<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'boxManufacturer.name.label', default: 'Name')}" />					
					</tr>
				</thead>
				<tbody>
				<% int count = 0; %> 
			...
			<div class="pagination"  style="width:70%; align: left;">
				<g:paginate total="${boxManufacturerInstanceTotal}" />
			</div>
