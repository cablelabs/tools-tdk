...
<div class="fieldcontain ${hasErrors(bean: scriptGroupInstance, field: 'scripts', 'error')} ">
	<label for="scripts">
		<g:message code="scriptGroup.scripts.label" default="Scripts" />		
	</label>
	<g:select name="scripts" from="${com.comcast.rdk.Script.list()}" multiple="multiple" optionKey="id" style="width: 250px;height:350px;" size="5" value="${scriptGroupInstance?.scripts*.id}" class="many-to-many"/>
</div>
