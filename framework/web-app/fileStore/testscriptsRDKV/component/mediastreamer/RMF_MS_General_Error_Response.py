...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1620</id>
  <version>2</version>
  <name>RMF_MS_General_Error_Response</name>
...
Test Case ID: CT_MediaStreamer_20</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Mediastreamer_20</test_case_id>
    <test_objective>RMFStreamer – This test is to simulate General Error response for curl request</test_objective>
...
Eg: "http://Ip:Port/videoStreamInit?live="</input_parameters>
...
1.TestMgr_RMFStreamer_InterfaceTesting</test_stub_interface>
    <test_script>RMF_MS_General_Error_Response</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadModuleStatus.upper():        
	#Set the module loading status
        ...
        url="http://"+streamDetails.getGatewayIp()+":8080/videoStreamInit?live="; 
