...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>384</id>
  <version>1</version>
  <name>CC_SetGet_DigitalChannel_17</name>
...
Test Case ID :CT_ClosedCaption_17</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_17</test_case_id>
    <test_objective>Closed Caption - Set and get digital channel number.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite>Channel number must be between 1 to 63</pre_requisite>
    ...
    <input_parameters>Categories : CCSetGetDigitalChannel :   Userselection - A channel number must be &lt;=63 (Since, digital channels support 64 channels).                                           Example : 5</input_parameters>
    <automation_approch>1. TM loads the ClosedCaption_Manager_Agent via the test agent.
2.ClosedCaption_Manager_Agent will initialize/start the ClosedCaption Manager.                        3.ClosedCaption_Manager_Agent will set the channel number as 5 to the ClosedCaption Manager component.                                                    4. ClosedCaption Manager will return the digital channel number through the ClosedCaption_Manager_Agent to the TM.                                                                          5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_SetGet_DigitalChannel_17</test_script>
    <skipped>No</skipped>
