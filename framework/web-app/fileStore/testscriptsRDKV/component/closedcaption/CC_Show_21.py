...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>332</id>
  <version>1</version>
  <name>CC_Show_21</name>
  <primitive_test_id>155</primitive_test_id>
  <primitive_test_name>CC_Show</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script is used to show all closed caption displays.
Test Case ID : CT_ClosedCaption_21</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_21</test_case_id>
    <test_objective>Closed Caption - To show all closed caption displays.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite/>
    <api_or_interface_used>vlGfxInit(0)                                                     vlMpeosCCManagerInit()                                                                     ccShow()</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>1. TM loads the ClosedCaption_Manager_Agent via the test agent.
2.ClosedCaption_Manager_Agent will initialize/start the  ClosedCaption Manager.                                                                      4. ClosedCaption Manager will return all the closed caption displays through the ClosedCaption_Manager_Agent to the TM.                                                                          5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>TestMgr_CC_Init   TestMgr_CC_Show</test_stub_interface>
    <test_script>CC_Show_21</test_script>
    <skipped>No</skipped>
