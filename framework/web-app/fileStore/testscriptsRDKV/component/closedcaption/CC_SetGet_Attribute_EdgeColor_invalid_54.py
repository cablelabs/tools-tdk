...
Test case Id - CT_ClosedCaption_54</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_54</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of font edge color with invalid parameter.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 13 (list value of edgecolor not in the structure)(invalid value), ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_EdgeColor_invalid_54</test_script>
    <skipped>No</skipped>
