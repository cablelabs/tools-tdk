...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1255</id>
  <version>1</version>
  <name>CC_Get_Attribute_EdgeColor_default_38</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - To check the default  attribute value of font edge color.	
Test case Id - CT_ClosedCaption_38</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_38</test_case_id>
    <test_objective>Closed Caption - To check the default  attribute value of font edge color.</test_objective>
    ...
    <input_parameters>Categories : CCGetAttribute : *attrib - Pointer to cc attribute structure list, type - 13 (list value of edgecolor in the structure), ccType - Digital/Analog.</input_parameters>
...
5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_Get_Attribute_EdgeColor_default_38</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_Get_Attribute_EdgeColor_default_38');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    edge_color = 1001; # default Edge color
    #print "Edge color value set to: %d" %edge_color
    ...
    print "Expected default Edge color is:  %s" %iterator[0];
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if flag == 0:
        ...
        print "-- default value of Edge color is as expected --";
      else:
        tdkTestObj.setResultStatus("FAILURE");
        print "-- default value of Edge color is not as expected --";
