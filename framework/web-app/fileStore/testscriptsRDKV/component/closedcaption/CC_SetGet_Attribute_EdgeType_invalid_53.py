...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1266</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_EdgeType_invalid_53</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - Set and get the  closed caption attribute of font edge type with invalid parameter.
Test case Id - CT_ClosedCaption_53</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_53</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of font edge type with invalid parameter.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 12 (list value of font edgetype not in the structure)(invalid value), ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_EdgeType_invalid_53</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_EdgeType_invalid_53');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to set the attribute (Edge type Invalid) of the closed caption
    ...
    edge_type = 1000; 
    #print "Edge type invalid value set to: %d" %edge_type
    ...
    attrib_type =  "%s" % edge_type;
    print "Set Edge type : invalid Edge type 123456789";
	...
	flag = 1;             
      ...
      if flag == 0:
        ...
        print "-- Get and set invalid value of edge type are not same as expected  --";
      else:
        tdkTestObj.setResultStatus("FAILURE");
        print "-- Get and set values of invalid edge type are same --";
       
    else:
      tdkTestObj.setResultStatus("FAILURE");
      print "FAILURE: Edge type invalid attribute is not set with %s" %tdkTestObj.getResultDetails();
