...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1259</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_FontSize_invalid_46</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - Set and get the  closed caption attribute of font size with invalid parameter.		
Test case Id - CT_ClosedCaption_46</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_46</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of font size with invalid parameter.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 6 (list value of font size not in the structure)(invalid value), ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_FontSize_invalid_46</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_FontSize_invalid_46');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to get the attribute (Font size Invalid) of the closed caption
    ...
    font_size = 1000; 
    #print "font_size value set to: %d" %font_size
    ...
    print "Set Font size : invalid font size 123456789";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if flag == 0:
        ...
        print "-- Get and set values of invalid font size are same --";
      else:
        tdkTestObj.setResultStatus("SUCCESS");
        print "-- Get and set values of invalid font size are not same --";
	  
    else:
      tdkTestObj.setResultStatus("SUCCESS");
      print "FAILURE: Font size invalid attribute is not set with %s" %tdkTestObj.getResultDetails();
