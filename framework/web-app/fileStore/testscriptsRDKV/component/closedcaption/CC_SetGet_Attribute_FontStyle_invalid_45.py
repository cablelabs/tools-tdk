...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1258</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_FontStyle_invalid_45</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - Set and get the  closed caption attribute of font style with invalid parameter.			
Test case Id - CT_ClosedCaption_45</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_45</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of font style with invalid parameter.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 7 (list value of font style not in the structure)(invalid value), ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_FontStyle_invalid_45</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_FontStyle_invalid_45');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to get the attribute (Font style Invalid) of the closed caption
    ...
    font_style = 1000; 
    #print "font_style invalid value set to: %d" %font_style
    ...
    print "Set Font style : invalid font style 123456789";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      print "Get Font style invalid  %s" %cc_Get_Attribute_details;
      ...
      if flag == 0:
        ...
        print "-- Get and set invalid value of font style are same --";
      else:
        tdkTestObj.setResultStatus("SUCCESS");
        print "-- Get and set invalid value of font style are not same --";
	  
    else:
      tdkTestObj.setResultStatus("SUCCESS");
      print "FAILURE: Font style invalid attribute is not set with %s" %tdkTestObj.getResultDetails();
