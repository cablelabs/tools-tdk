...
Test case Id - CT_ClosedCaption_192</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_192</test_case_id>
    <test_objective>Closed Caption - When CC is set to Background Color: White and Font Color: Yellow; the CC text is displayed black.</test_objective>
...
5.Test Manger will request the font color by calling get attributes.                                                                          6. ClosedCaption_Manager_Agent will return SUCCESS status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_SetGet_Attribute_FontColor_192</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
