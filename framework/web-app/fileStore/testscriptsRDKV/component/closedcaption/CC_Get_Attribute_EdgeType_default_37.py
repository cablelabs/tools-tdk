...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1254</id>
  <version>1</version>
  <name>CC_Get_Attribute_EdgeType_default_37</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - To check the default  attribute value of font edge type.		
Test case ID - CT_ClosedCaption_37</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_37</test_case_id>
    <test_objective>Closed Caption - To check the default  attribute value of font edge type.</test_objective>
    ...
    <input_parameters>Categories : CCGetAttribute : *attrib - Pointer to cc attribute structure list, type - 12 (list value of font edgetype in the structure), ccType - Digital/Analog.</input_parameters>
...
5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_Get_Attribute_EdgeType_default_37</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_Get_Attribute_EdgeType_default_37');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to get the attribute (Edge Type) of the closed caption
    ...
    edge_type = 1001; 
    #print "Edge type value set to: %d" %edge_type
    ...
    attrib_type = "0";
    print "Expected default Edge type is: 0";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if attrib_type in cc_Get_Attribute_details:
        ...
        print "-- Default value of Edge type is as expected --";
      else:
        tdkTestObj.setResultStatus("FAILURE");
        print "-- Default value of Edge type is not as expected --";
        print "FAILURE: with %s " %tdkTestObj.getResultDetails(); 

    else:
      tdkTestObj.setResultStatus("FAILURE");
      print "FAILURE: Edge type attribute is not returned";
