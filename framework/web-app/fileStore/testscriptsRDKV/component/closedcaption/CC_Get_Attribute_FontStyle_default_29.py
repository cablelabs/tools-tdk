...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1246</id>
  <version>1</version>
  <name>CC_Get_Attribute_FontStyle_default_29</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption -To check the default  attribute value of font style.		
Test case ID - CT_ClosedCaption_29</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_29</test_case_id>
    <test_objective>Closed Caption -To check the default  attribute value of font style.</test_objective>
    ...
    <input_parameters>Categories : CCGetAttribute : *attrib - Pointer to cc attribute structure list, type - 7 (list value of font style in the structure), ccType - Digital/Analog.</input_parameters>
...
5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_Get_Attribute_FontStyle_default_29</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_Get_Attribute_FontStyle_default_29');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to get the attribute (Font Style) of the closed caption
    ...
    font_style = 1001; 
    print "font_style value set to: %d" %font_style 
    ...
    attrib_type = "MonospacedSansSerif";
    print "Expected default font Style is: MonospacedSansSerif ";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if attrib_type in cc_Get_Attribute_details:
        ...
        print "-- Default value of Font Style is as expected --";
      else:
        tdkTestObj.setResultStatus("FAILURE");
        print "-- Default value of Font Style is not as expected --";
        print "FAILURE: with %s " %tdkTestObj.getResultDetails(); 

    else:
      tdkTestObj.setResultStatus("FAILURE");
      print "FAILURE: Font Style attribute is not returned";
