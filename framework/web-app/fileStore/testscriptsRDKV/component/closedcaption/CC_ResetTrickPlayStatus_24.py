...
Test Case ID :CT_ClosedCaption_24</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_24</test_case_id>
    <test_objective>Closed Caption - To reset the trickplay status of the closed caption to ON / OFF.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite/>
    <api_or_interface_used>vlGfxInit(0)                                                     vlMpeosCCManagerInit()                             resetTrickPlayStatus()</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>1. TM loads the ClosedCaption_Manager_Agent via the test agent.
2.ClosedCaption_Manager_Agent will initialize/start the ClosedCaption Manager.                                                                      4. ClosedCaption Manager will set ON if trickplay status is OFF and to OFF if trickplay status is ONthrough the ClosedCaption_Manager_Agent to the TM.                                                                           5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>TestMgr_CC_Init      TestMgr_CC_ResetTrickPlayStatus</test_stub_interface>
    <test_script>CC_ResetTrickPlayStatus_24</test_script>
    <skipped>No</skipped>
