...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1256</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_BgColor_invalid_42</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - Set and get the  closed caption attribute of background color with invalid parameter.
Test case ID - CT_ClosedCaption_42</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_42</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of background color with invalid parameter.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list,         type - 0 (list value of charBgColor not in the structure) BgColor(invalid value),                             ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_BgColor_invalid_42</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_BgColor_invalid_42');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    iterator = ['0', 'FFFFFF', 'FF0000', '00FF00', '0000FF', 'FFFF00', 'FF00FF', '00FFFF'];

    #calling closed caption API "CC_SetGetAttribute" to set the attribute (Bg Color invalid) of the closed caption
    ...
    color_type = 1000; # invalid color type
    #print "Bg color invalid value set to: %d" %color_type
    ...
    print "Set Bg color : invalid color_type 123456789";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      print "get bg color invalid %s" %cc_Get_Attribute_details;
      ...
      if flag == 0:
        ...
        print "-- Get and set values of BG color are same --";
      else:
      ...
      tdkTestObj.setResultStatus("SUCCESS");
      print "FAILURE: BG color attribute is not set with %s" %tdkTestObj.getResultDetails();
