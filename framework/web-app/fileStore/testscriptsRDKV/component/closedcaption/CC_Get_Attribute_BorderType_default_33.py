...
Test case ID - CT_ClosedCaption_33</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_33</test_case_id>
    <test_objective>Closed Caption - To check the default  attribute value of border type (window border type).</test_objective>
    ...
    <input_parameters>Categories : CCGetAttribute : *attrib - Pointer to cc attribute structure list, type - 10 (list value of window border type the structure), ccType - Digital/Analog.</input_parameters>
...
5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_Get_Attribute_BorderType_default_33</test_script>
    <skipped>No</skipped>
