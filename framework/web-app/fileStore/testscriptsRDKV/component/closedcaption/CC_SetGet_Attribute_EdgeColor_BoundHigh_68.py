...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_EdgeColor_BoundHigh_68');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to set the attribute (Edge Color bound high) of the closed caption
    ...
    edge_color = 7;
    print "Edge color bound high value set to: %s" %edge_color
    ...
    print "Set edge color bound high %s" %iterator[edge_color];
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      print "get edge color bound high %s" %cc_Get_Attribute_details;
      ...
      if flag == 0:    
        ...
        print "-- Get and set higher values of edge color are same --";
      else:
        tdkTestObj.setResultStatus("FAILURE");
        print "-- Get and set higher values of edge color are not same --";
