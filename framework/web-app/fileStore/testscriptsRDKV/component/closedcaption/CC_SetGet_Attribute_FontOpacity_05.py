...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>371</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_FontOpacity_05</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script is used toSet and get the  closed caption attribute of foreground opacity.
Test Case ID :CT_ClosedCaption_05</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_05</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of foreground opacity .</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 4 (list value of charFgOpacity in the structure), ccType - Digital/Analog.</input_parameters>
...
2.ClosedCaption_Manager_Agent will initialize/start the closed caption manager with ClosedCaption Manager component.                        3.ClosedCaption_Manager_Agent will set the foreground opacity of the closed caption manager with ClosedCaption Manager component.                           4. ClosedCaption Manager component will return the foreground opacity through the ClosedCaption_Manager_Agent to the TM.                  5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_SetGet_Attribute_FontOpacity_05</test_script>
    <skipped>No</skipped>
