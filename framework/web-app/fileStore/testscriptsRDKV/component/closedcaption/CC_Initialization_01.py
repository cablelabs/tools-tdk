...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>312</id>
  <version>1</version>
  <name>CC_Initialization_01</name>
  <primitive_test_id>148</primitive_test_id>
  <primitive_test_name>CC_Initialization</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Initializes the closed caption manager.
Test Case ID : CT_ClosedCaption_01</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_01</test_case_id>
    <test_objective>Closed Caption – Initialization of closed caption manager.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite/>
    <api_or_interface_used>vlGfxInit(0)
vlMpeosCCManagerInit()</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>1. TM loads the ClosedCaption_Manager_Agent via the test agent.
2.ClosedCaption_Manager_Agent will initialize the  ClosedCaption Manager.
3. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status</except_output>
    <priority>High</priority>
    <test_stub_interface>TestMgr_CC_Init</test_stub_interface>
    <test_script>CC_Initialization_01</test_script>
    <skipped>No</skipped>
