...
Test Case ID : CT_ClosedCaption_23</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_23</test_case_id>
    <test_objective>Closed Caption - To get the number of services supported by the closed caption and the supported service numbers.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3-1/XG1-1</test_setup>
    <pre_requisite/>
    <api_or_interface_used>vlGfxInit(0)                                                     vlMpeosCCManagerInit() ccGetSupportedServiceNumbersCount(stubservicesArraySize)</api_or_interface_used>
    <input_parameters>ccGetSupportedServiceNumbersCount :stubservicesArraySize - Pointer to the services array.</input_parameters>
    <automation_approch>1. TM loads the ClosedCaption_Manager_Agent via the test agent.
2.ClosedCaption_Manager_Agent will initialize/start the ClosedCaption Manager.                                                                      4. ClosedCaption Manager will return the supported service count number and service number through the ClosedCaption_Manager_Agent to the TM.                                                                          5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>TestMgr_CC_Init  TestMgr_CC_GetSupportedServiceNumberCount   TestMgr_CC_GetSupportedServiceNumber</test_stub_interface>
    <test_script>CC_Get_SupportedServiceNumberCount_ServiceNumber_23</test_script>
    <skipped>No</skipped>
