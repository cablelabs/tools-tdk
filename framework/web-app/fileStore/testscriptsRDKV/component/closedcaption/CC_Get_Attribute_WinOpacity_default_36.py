...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1253</id>
  <version>1</version>
  <name>CC_Get_Attribute_WinOpacity_default_36</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - To check the default  attribute value of window opacity .	
Test case Id - CT_ClosedCaption_36</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_36</test_case_id>
    <test_objective>Closed Caption - To check the default  attribute value of window opacity .</test_objective>
    ...
    <input_parameters>Categories : CCGetAttribute : *attrib - Pointer to cc attribute structure list, type - 5 (list value of winOpacity in the structure), ccType - Digital/Analog.</input_parameters>
...
5. ClosedCaption_Manager_Agent will return SUCCESS/FAILURE status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_Get_Attribute_WinOpacity_default_36</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_Get_Attribute_WinOpacity_default_36');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    #calling closed caption API "CC_SetGetAttribute" to get the attribute (Win Opacity) of the closed caption
    ...
    attrib_type = "3";
    print "Expected default Win opacity is: 3";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if attrib_type in cc_Get_Attribute_details:
        ...
        print "-- Default value of Win opacity is as expected --";
      else:
        tdkTestObj.setResultStatus("FAILURE");
        print "-- Default value of Win opacity is not as expected --";
        print "FAILURE: with %s " %tdkTestObj.getResultDetails(); 

    else:
      tdkTestObj.setResultStatus("FAILURE");
      print "FAILURE: Win opacity attribute is not returned";
