...
Test Case ID :CT_ClosedCaption_16</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_16</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of font edge color.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 13 (list value of edgecolor in the structure), ccType - Digital/Analog.</input_parameters>
...
2.ClosedCaption_Manager_Agent will initialize/start the  ClosedCaption Manager.                        3.ClosedCaption_Manager_Agent will set the font edge color to the ClosedCaption Manager.                                                    4. ClosedCaption Manager will return the font edge color through the ClosedCaption_Manager_Agent to the TM.                                                                          5. ClosedCaption_Manager_Agent will return SUCCESS status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_SetGet_Attribute_EdgeColor_16</test_script>
    <skipped>No</skipped>
