...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>376</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_FontUnderline_10</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script is used to Set and get the  closed caption attribute of font underline.
Test Case ID : CT_ClosedCaption_10</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_10</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of font underline.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 9 (list value of fontUnderline in the structure), ccType - Digital/Analog.</input_parameters>
...
2.ClosedCaption_Manager_Agent will initialize/start the  ClosedCaption Manager.                        3.ClosedCaption_Manager_Agent will set the underlined font to the ClosedCaption Manager.                                                    4. ClosedCaption Manager will return the underlined font through the ClosedCaption_Manager_Agent to the TM.                                                                          5. ClosedCaption_Manager_Agent will return SUCCESS status based on the return value of  APIs.</automation_approch>
    ...
    <test_script>CC_SetGet_Attribute_FontUnderline_10</test_script>
    <skipped>No</skipped>
