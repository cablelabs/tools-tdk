...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1233</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_FontColor_invalid_41</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - Set and get the  closed caption attribute of foreground color with invalid parameter.
Test case Id - CT_ClosedCaption_41</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_41</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of foreground color with invalid parameter</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 1 (list value of charFgColor not in the structure)(invalid value), ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_FontColor_invalid_41</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_FontColor_invalid_41');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    attrib_type = 1; # To set FGColor
    print "attrib_type value set to: %d" %attrib_type
    color_type = 1000; # invalid color type
    print "Font color invalid value set to: %d" %color_type
    ...
    print "Set font color : invalid color_type 123456789";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if flag == 0:
        ...
        print "-- Get and set values of invalid font color are same --";
      else:
        tdkTestObj.setResultStatus("SUCCESS");
        print "-- Get and set values of invalid font color are not same --";
       
    else:
      tdkTestObj.setResultStatus("SUCCESS");
      print "FAILURE: font color invalid attribute is not set with %s" %tdkTestObj.getResultDetails();
