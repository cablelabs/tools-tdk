...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1244</id>
  <version>1</version>
  <name>CC_SetGet_Attribute_BGOpacity_invalid_44</name>
  <primitive_test_id>194</primitive_test_id>
  <primitive_test_name>CC_SetGetAttribute</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Closed Caption - Set and get the  closed caption attribute of background opacity with invalid parameter.		
Test case Id - CT_ClosedCaption_44</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ClosedCaption_44</test_case_id>
    <test_objective>Closed Caption - Set and get the  closed caption attribute of background opacity with invalid parameter.</test_objective>
    ...
    <input_parameters>Categories : CCSetGetAttribute : *attrib - Pointer to cc attribute structure list, type - 4 (list value of charBgOpacity not \in the structure)(invalid value), ccType - Digital/Analog.</input_parameters>
...
Checkpoint 2.Check the value which is being set is being got back by the get API.</except_output>
    ...
    <test_script>CC_SetGet_Attribute_BGOpacity_invalid_44</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CC_SetGet_Attribute_BGOpacity_invalid_44');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in loadmodulestatus.upper():
    ...
    opacity_type = 1000; 
    print "Opacity type invalid value set to: %s" %opacity_type
    ...
    attrib_type = "123456789";
    print "Set BG opacity : invalid opacity_type 123456789";
    ...
    if cc_Set_Attribute_expectedresult in cc_Set_Attribute_actualresult:
      ...
      if attrib_type not in cc_Get_Attribute_details:
        tdkTestObj.setResultStatus("SUCCESS");
        print "-- Get and set values of Bg opacity are not same --";
      else:
      ...
      tdkTestObj.setResultStatus("FAILURE");
      print "FAILURE: Bg opacity attribute is not set with %s" %tdkTestObj.getResultDetails();
