...
<xml>
  ...
  <name>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardCardFailed_93</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test is executed to get the value for  "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.CardFailed"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
