...
<xml>
  ...
  <name>TR069_Get_DeviceXCOMSTBMAC_13</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective: To fetch the device interface MAC address by querying  the tr69Hostif through curl.  Query string "Device.DeviceInfo.X_COMCAST_COM_STB_MAC". No set operation avaliable for this parameter.
TestCaseID: CT_TR69_13
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceXCOMSTBMAC_13');
...
profilePath = "Device.DeviceInfo.X_COMCAST-COM_STB_MAC"
