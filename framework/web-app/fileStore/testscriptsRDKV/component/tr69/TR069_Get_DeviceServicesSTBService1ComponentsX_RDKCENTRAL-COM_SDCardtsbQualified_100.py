...
<xml>
  ...
  <name>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardtsbQualified_100</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test is executed to get the value for  "DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardtsbQualified"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
No set operation available for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.tsbQualified"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.tsbQualified" to fetch the IP Address of the interface.
...
Checkpoint 2. Can verify returned IP address is correct or not through ifconifg cmd.</except_output>
    ...
    <test_script>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardtsbQualified_100</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardtsbQualified_100');
