...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks if setting multiple applications sets the values correctly</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_VideoApplicationEventsService_SetMultipleApplication_13978_5');
