...
<xml>
  ...
  <name>SM_FP_setbrightness_reboot_2424</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>SM_FP_setbrightness_reboot_
RDK-2424</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_FP_setbrightness_reboot_2424');
dsobj.configureTestCase(ip,port,'SM_FP_setbrightness_reboot_2424');
