...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>returns list of supported audio ports
  TestCase ID : CT_14319_2</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SupportedAudioPort_14319_2');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SupportedAudioPort_14319_2');
