...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_System_SetandGet_Default_TimeandOffset</name>
  <primitive_test_id/>
  <primitive_test_name>SM_Generic_CallMethod</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set default time and offset	in timezone</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_ServiceManager_137</test_case_id>
    <test_objective>To check whether the time zones with default time and offset are set and get successfully</test_objective>
...
Checkpoint 2.Check the timezone is set properly.</except_output>
    ...
    <test_script>SM_System_SetandGet_Default_TimeandOffset</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_SetandGet_DefaultTimeZone');
...
if "SUCCESS" in smLoadStatus.upper():
    ...
    if "SUCCESS" in register:
        ...
        if expectedresult in actualresult:
            ...
            settimeZone="EST+5EDT,M9.3.3,M9.3.3"
            tdkTestObj.addParameter("service_name", serviceName);
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    ...
                    if gettimeZone == settimeZone:
                        tdkTestObj.setResultStatus("SUCCESS");
                        print "Successfully gets the time zone as " ,settimeZone
                    else:
                        print "Unable to get time zone as " , settimeZone
