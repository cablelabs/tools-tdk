...
<xml>
  ...
  <name>SM_DisplaySettings_ConnectedAudioPort_WithoutHDMI_14319_20</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests getConnectedAudioPorts() without HDMI port connected
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_ConnectedAudioPort_WithoutHDMI_14319_20');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_ConnectedAudioPort_WithoutHDMI_14319_20');
