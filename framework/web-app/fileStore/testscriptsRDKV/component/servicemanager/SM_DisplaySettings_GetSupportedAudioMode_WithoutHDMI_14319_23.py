...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedAudioMode_WithoutHDMI_14319_23</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks supported audio modes of HDMI port when HDMI is not connected
  Test Case ID : CT_14319_23</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_WithoutHDMI_14319_23');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_WithoutHDMI_14319_23');
