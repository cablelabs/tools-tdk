...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedAudioMode_SPDIF_14319_4</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks supported audio modes of SPDIF port
  Test Case ID : CT_14319_4</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_SPDIF_14319_4');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_SPDIF_14319_4');
