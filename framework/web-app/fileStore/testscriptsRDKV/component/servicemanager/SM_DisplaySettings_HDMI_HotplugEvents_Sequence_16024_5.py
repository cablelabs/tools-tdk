...
<xml>
  ...
  <name>SM_DisplaySettings_HDMI_HotplugEvents_Sequence_16024_5</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invokes HotplugEventConnected and HotplugEventDisconnected event sequentially
  TestCase ID : CT_16024_5</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_DisplaySettings_HDMI_HotplugEvents_Sequence_16024_5');
