...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1532</id>
  <version>1</version>
  <name>SM_WebSocket_GetReadyState</name>
  <primitive_test_id>649</primitive_test_id>
  <primitive_test_name>SM_WebSocket_GetReadyState</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verify get ready state on WebSocketService.
Test Case ID: CT_Service Manager_28</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_28</test_case_id>
    <test_objective>To verify get ready state on WebSocketService</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-1</test_setup>
    <pre_requisite>None</pre_requisite>
    <api_or_interface_used>ServiceManager::getGlobalService
WebSocketService::readyState</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>1. TM loads the Service_Manager_Agent via the test agent.
2.Service_Manager_Agent will register DeviceSettingService with ServiceManager component.
3.On Success of registerService , Service_Manager_Agent will get readyState info from WebSocketService readyState method.
...
2.TestMgr_SM_WebSocket_GetReadyState
3.TestMgr_SM_UnRegisterService</test_stub_interface>
    <test_script>SM_WebSocket_GetReadyState</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'CT_Service Manager_28');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if expectedresult in actualresult:
                ...
                #Call GetReadyState API
                tdkTestObj = obj.createTestStep('SM_WebSocket_GetReadyState');
                expectedresult="SUCCESS"
                tdkTestObj.executeTestCase(expectedresult);
                actualresult = tdkTestObj.getResult();
                serviceDetail = tdkTestObj.getResultDetails();
                print "[TEST EXECUTION DETAILS] : %s"%serviceDetail;
                #Check for SUCCESS/FAILURE return value of SM_WebSocket_GetReadyState
                if expectedresult in actualresult:
                        print "SUCCESS: GetReadyState successful";
                        tdkTestObj.setResultStatus("SUCCESS");
                else:
                        print "FAILURE: GetReadyState failure";
