...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedAudioMode_WithoutHDMI_14319_6</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks supported audio modes of HDMI port when port is not connected. Output should be same as getSupportedAudioModes()
  Test Case ID : CT_14319_6</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_WithoutHDMI_14319_6');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                print "[TEST EXECUTION DETAILS] supported modes are: %s"%serviceDetail_hdmi;
                #Check for SUCCESS/FAILURE return value of SM_DeviceSetting_GetAppInfo
                if expectedresult in actualresult:
                        print "SUCCESS: GetSupportedModes(HDMI) successful";
                        tdkTestObj.setResultStatus("SUCCESS");
                else:
