...
Test case ID: CT_Service Manager_17</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_17</test_case_id>
    <test_objective>Script to check if a service exists on all available services ("deviceSettingService", "screenCaptureService", "WebSocketService")</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-1</test_setup>
    <pre_requisite>None</pre_requisite>
    <api_or_interface_used>ServiceManager::doesServiceExist</api_or_interface_used>
...
3. On Success of registerService ,Service_Manager_Agent will check for the service registration status with ServiceManager.
...
2.TestMgr_SM_DoesServiceExist
3.TestMgr_SM_UnRegisterService</test_stub_interface>
    <test_script>SM_DoesServiceExist_All</test_script>
    <skipped>No</skipped>
