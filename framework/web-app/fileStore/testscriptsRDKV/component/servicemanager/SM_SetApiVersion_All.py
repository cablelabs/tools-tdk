...
Test Case ID: CT_Service Manager_19</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_19</test_case_id>
    <test_objective>Script to setApiVersionNumber/getApiVersionNumber on all available services ("deviceSettingService", "screenCaptureService", "WebSocketService")</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-1</test_setup>
    <pre_requisite>None</pre_requisite>
    <api_or_interface_used>Service::setApiVersionNumber
Service::getApiVersionNumber </api_or_interface_used>
    <input_parameters>string service_name ("deviceSettingService", "screenCaptureService", "WebSocketService")
interger apiVersion (1-1000)
</input_parameters>
...
8. Service_Manager_Agent will compare both API version number and return SUCCESS/FAILURE status.</automation_approch>
...
3.TestMgr_SM_UnRegisterService</test_stub_interface>
    <test_script>SM_SetApiVersion_All</test_script>
    <skipped>No</skipped>
