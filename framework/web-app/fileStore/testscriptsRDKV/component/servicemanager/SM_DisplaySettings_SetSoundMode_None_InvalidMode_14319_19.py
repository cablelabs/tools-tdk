...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_None_InvalidMode_14319_19</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test setSoundMode with no port specified and with an invalid audio mode. Audiomode should not change
  Test Case Id : CT_14319_19</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_None_InvalidMode_14319_19');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_None_InvalidMode_14319_19');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                #calling DisplaySettings_SetSoundMode
		...
		portName = "";
                ...
                get_ret = servicemanager.DS_getSoundMode(obj,"SPDIF0");
                if expectedresult in get_ret[0]:
                        print "SUCCESS: GetSoundMode() successful";
                        if get_ret[1]!=audioMode :
                                print "SUCCESS: audiomode not set with invalid mode"
                                tdkTestObj.setResultStatus("SUCCESS");
                        else:
                                print "FAILURE: audiomode set with invalid mode"
                                tdkTestObj.setResultStatus("FAILURE");
                else:
