...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>SM_StorageManagerService_GetTSBCapacityMins</name>
  <primitive_test_id/>
  <primitive_test_name>SM_Generic_CallMethod</primitive_test_name>
  <primitive_test_version>7</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checks if the service manager API getTSBCapacityMinutes returns the correct value for TSBCapacityMinutes</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_103</test_case_id>
    <test_objective>Checks if the service manager API getTSBCapacityMinutes returns the correct value for TSBCapacityMinutes</test_objective>
...
CallMethod : const QString - "getTSBCapacityMinutes" ,const ServiceParams - bool
...
4. Service_Manager_Agent will get the value corresponding to the field  for TSB maxDuration from the file /etc/rmfconfig.ini.
...
Checkpoint 2.Check the value returned using the API getTSBCapacityMinutes is same as the value of field TSB maxDuration from the file /etc/rmfconfig.ini.</except_output>
    <priority>High</priority>
    <test_stub_interface>libservicemanagerstub.so</test_stub_interface>
    <test_script>SM_StorageManagerService_GetTSBCapacityMins</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_StorageManagerService_GetTSBCapacityMins');
iarmObj.configureTestCase(ip,port,'SM_StorageManagerService_GetTSBCapacityMins');
