...
<xml>
  ...
  <name>SM_VideoApplicationEventsService_SetSingleApplication_13978_4</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks if setting a single application sets the parameters properly</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_VideoApplicationEventsService_SetSingleApplication_13978_4');
...
if "SUCCESS" in smLoadStatus.upper():
        ...
        if "SUCCESS" in register:
                ...
                appString = "advertisement,15,NULL";
                count = 1;
