...
<xml>
  ...
  <name>SM_LP_Iskeystrokemaskenable_true_9580</name>
...
<xml>
  ...
  <version>3</version>
  <!-- Do not edit version. This will be auto incremented while updating. If you are adding a new script you can keep the vresion as 1 -->
  <name>SM_LP_Iskeystrokeaskenable_false_9580</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id> </primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>SM_Generic_CallMethod</primitive_test_name>
...
ibusobj = tdklib.TDKScriptingLibrary("iarmbus","2.0");
ibusobj.configureTestCase(ip,port,'SM_LP_isKeystrokeMaskEnabled_true_9580');
smobj = tdklib.TDKScriptingLibrary("servicemanager","2.0");
smobj.configureTestCase(ip,port,'SM_LP_isKeystrokeMaskEnabled_true_9580');
loadmodulestatus =smobj.getLoadModuleResult();
loadmodulestatus1 =ibusobj.getLoadModuleResult();
print "[LIB LOAD STATUS]  :  %s" %loadmodulestatus ;
print "[LIB LOAD STATUS]  :  %s" %loadmodulestatus1 ;
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus.upper():
           smobj.setLoadModuleStatus("SUCCESS");
           ibusobj.setLoadModuleStatus("SUCCESS");
           #calling IARMBUS API "IARM_Bus_Init"
           tdkTestObj = ibusobj.createTestStep('IARMBUS_Init');
           ...
           if ("SUCCESS" in actualresult):
               ...
               tdkTestObj = ibusobj.createTestStep('IARMBUS_Connect');
               expectedresult="SUCCESS"
               tdkTestObj.executeTestCase(expectedresult);
               actualresult = tdkTestObj.getResult();
               details=tdkTestObj.getResultDetails();
               ...
               if expectedresult in actualresult:
                       ...
                       expectedresult = "SUCCESS"
                       service_name = "org.rdk.LoggingPreferences"
                       ...
                       if expectedresult in actualresult:
                          ...
                          tdkTestObj.addParameter("service_name", service_name);
                          tdkTestObj.addParameter("method_name", "setKeystrokeMaskEnabled");
                          ...
                          if expectedresult in actualresult:
                              print "SUCCESS: Mask  enabled successful";
                              tdkTestObj.setResultStatus("SUCCESS");
                              tdkTestObj = smobj.createTestStep('SM_Generic_CallMethod');
                              expectedresult="SUCCESS"
                              tdkTestObj.addParameter("service_name", service_name);
                              tdkTestObj.addParameter("method_name", "isKeystrokeMaskEnabled");
                              tdkTestObj.executeTestCase(expectedresult);
                              actualresult = tdkTestObj.getResult();
                              serviceDetail = tdkTestObj.getResultDetails();
                              print "[TEST EXECUTION DETAILS]: %s"%serviceDetail;
                              ...
                              if expectedresult in actualresult:
                                  print "SUCCESS: get mask successful";
                                  tdkTestObj.setResultStatus("SUCCESS");
                              else:
                                  print "FAILURE: get mask failed";
                                  tdkTestObj.setResultStatus("FAILURE");
                              if (inputList==1) and ("TRUE" in serviceDetail.upper()):
                                  print " both  set and get are same"
                              else:
                                  print "set and get are different"
                          else:
                              print "FAILURE: Mask  enable failure";
                              tdkTestObj.setResultStatus("FAILURE");
                ...
                #Check for SUCCESS/FAILURE return value of SM_UnRegisterService
                       ...
                       tdkTestObj = ibusobj.createTestStep('IARMBUS_DisConnect');
                       expectedresult="SUCCESS"
                       tdkTestObj.executeTestCase(expectedresult);
                       actualresult = tdkTestObj.getResult();
                       details=tdkTestObj.getResultDetails();
               ...
               tdkTestObj = ibusobj.createTestStep('IARMBUS_Term');
               expectedresult="SUCCESS";
               tdkTestObj.executeTestCase(expectedresult);
               actualresult = tdkTestObj.getResult();
               details=tdkTestObj.getResultDetails();
           ...
           ibusobj.unloadModule("iarmbus");
else:
        print "Load module failed";
        smobj.setLoadModuleStatus("FAILURE");
        ibusobj.setLoadModuleStatus("FAILURE");
