...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_SPDIF_ValidMode_14319_9</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Sets the audio mode of a port to given mode
  Test Case Id : 14319_9</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_SPDIF_ValidMode_14319_9');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_SPDIF_ValidMode_14319_9');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                #calling DisplaySetting_SetSoundMode
                ...
                #calling GetSoundMode
                get_ret = servicemanager.DS_getSoundMode(obj,portName);
                if expectedresult in get_ret[0]:
                        print "SUCCESS: GetSoundMode() successful";
                        if modeCheck in get_ret[1]:
                                print "SUCCESS: audiomode set for a connected port"
                                tdkTestObj.setResultStatus("SUCCESS");
                        else:
