...
<xml>
  ...
  <name>SM_DisplaySettings_HDMI_HotplugEvents_Sequence_16024_6</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invokes HotplugEventDisconnected and HotplugEventConnected event sequentially
  TestCase ID : CT_16024_6</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_DisplaySettings_HDMI_HotplugEvents_Sequence_16024_6');
