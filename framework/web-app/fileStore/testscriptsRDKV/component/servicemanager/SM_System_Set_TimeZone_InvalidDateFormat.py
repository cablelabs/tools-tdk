...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_System_Set_TimeZone_InvalidDateFormat</name>
  <primitive_test_id/>
  <primitive_test_name>SM_Generic_CallMethod</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To test if timezone with invalid date and time.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_139</test_case_id>
    <test_objective>To check whether the time zones are set when invalid date format is given</test_objective>
...
Checkpoint 2.Check the timezone is set properly.</except_output>
    ...
    <test_script>SM_System_Set_TimeZone_InvalidDateFormat</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_Set_TimeZone_InvalidDateFormat');
...
if "SUCCESS" in smLoadStatus.upper():
    ...
    if "SUCCESS" in register:
        ...
        if expectedresult in actualresult:
            ...
            #Invalid month in Mm.w.d
            settimeZone = "EST+12:12:34EDT+09:12:23,M13.1.2/+12,M12.3.4/+5"
            setTimeZone(settimeZone)

            #Invalid week
            settimeZone = "EST+12:11:13EDT+09:12:23,M10.8.2/+12,M12.3.4/+5"
            setTimeZone(settimeZone)

            #Invalid day
            settimeZone = "EST+12:23:27EDT+09:12:23,M10.1.2/+12,M12.3.9/+5"
            setTimeZone(settimeZone)
