...
<xml>
  ...
  <name>SM_AVInputService_AVInputActive_BackToBack_1259</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invokes AVInputActiveEvent event multiple times
  TestCase ID : CT_1259_3</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_AVInputService_AVInputActive_BackToBack_1259');
