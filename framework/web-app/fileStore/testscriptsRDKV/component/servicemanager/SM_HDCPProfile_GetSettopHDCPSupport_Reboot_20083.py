...
<xml>
  ...
  <name>SM_HDCPProfile_GetSettopHDCPSupport_Reboot_20083</name>
...
dsObj.configureTestCase(ip,port,'CT_SM_HDCP_GetSettopHDCPSupport_Reboot_20083');
...
smobj.configureTestCase(ip,port,'CT_SM_HDCP_GetSettopHDCPSupport_Reboot_20083');
