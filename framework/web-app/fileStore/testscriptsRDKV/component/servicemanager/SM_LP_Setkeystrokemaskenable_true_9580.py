...
ibusobj.configureTestCase(ip,port,'SM_LP_setKeystrokeMaskEnabled_true_9580');
smobj = tdklib.TDKScriptingLibrary("servicemanager","2.0");
smobj.configureTestCase(ip,port,'SM_LP_setKeystrokeMaskEnabled_true_9580');
        ...
        if ("SUCCESS" in actualresult):
               ...
               if expectedresult in actualresult:
                   ...
                   if expectedresult in actualresult:
                          ...
                          expectedresult="SUCCESS"
                          tdkTestObj.addParameter("params",1);
                          tdkTestObj.addParameter("service_name", service_name);
