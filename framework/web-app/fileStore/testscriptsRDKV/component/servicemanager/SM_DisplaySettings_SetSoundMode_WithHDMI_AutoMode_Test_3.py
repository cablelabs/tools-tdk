...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_WithHDMI_AutoMode_Test_3</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test setSoundMode on a connected HDMI port with a valid audio auto mode
  ...
  <test_cases>
    <test_case_id>CT_18842_03</test_case_id>
    <test_objective>Service Manager âTest DisplaySettingService::setSoundMode()  on a connected HDMI port with a valid audio mode</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-V3</test_setup>
    <pre_requisite>HDMI out of STB should be connected to a TV</pre_requisite>
...
"</test_stub_interface>
    <test_script>SM_DisplaySettings_SetSoundMode_WithHDMI_AutoMode_Test_3</test_script>
    <skipped>No</skipped>
    <release_version>M49</release_version>
    <remarks>Set AUTO mode</remarks>
  </test_cases>
  <script_tags />
</xml>
'''
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_WithHDMI_AutoMode_Test_2');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_WithHDMI_AutoMode_Test_3');
...
if "SUCCESS" in result.upper():
		...
		if expectedresult in get_ret[0]:
			...
			if "AUTO" in get_ret[1]:
				tdkTestObj.setResultStatus("SUCCESS");
				print "The Audio mode is allready set to Auto :No need to set the same again"
		...
		#Call ServiceManger - UnregisterService API
                ...
                #heck for SUCCESS/FAILURE return value of SM_UnRegisterService
                if expectedresult in actualresult:
                       tdkTestObj.setResultStatus("SUCCESS");
