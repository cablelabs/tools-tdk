...
Test Case ID: CT_Service Manager_23</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_23</test_case_id>
    <test_objective>Script to create all available services ("deviceSettingService", "screenCaptureService", "WebSocketService")</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-1</test_setup>
    <pre_requisite>None</pre_requisite>
    <api_or_interface_used>ServiceManager::doesServiceExist
ServiceManager::createService</api_or_interface_used>
...
3. On Success of registerService , Service_Manager_Agent will create an instance of a given service using service name.
4.Service_Manager_Agent will delete the instance of the service.
...
2.TestMgr_SM_CreateService
3.TestMgr_SM_UnRegisterService</test_stub_interface>
    <test_script>SM_CreateService_All</test_script>
    <skipped>No</skipped>
