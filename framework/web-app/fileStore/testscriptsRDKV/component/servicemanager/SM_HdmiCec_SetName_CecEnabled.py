...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>SM_HdmiCec_SetName_CecEnabled</name>
  <primitive_test_id>106</primitive_test_id>
  <primitive_test_name>SM_RegisterService</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: Service Manager – Setting the STB device name and fetch the name after enabling CEC.
Test Case Id: CT_Service Manager_37.
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_37</test_case_id>
    <test_objective>Service Manager â&#128;&#147; Setting the STB device name and fetch the name after enabling CEC.</test_objective>
...
4. On Success of enabling cec, Service_Manager_Agent will set the name for CEC device.
...
7. Service_Manager_Agent will compare the name set with current name returned.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of APIs for success status.

Checkpoint 2.Compare the name set with current name returned.</except_output>
...
smObj.configureTestCase(ip,port,'SM_HdmiCec_SetName_CecEnabled');
iarmObj.configureTestCase(ip,port,'SM_HdmiCec_SetName_CecEnabled');
