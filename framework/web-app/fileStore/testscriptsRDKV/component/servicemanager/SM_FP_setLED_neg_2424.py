...
<xml>
  ...
  <name>SM_FP_setLED_neg_2424</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>SM_FP_setLED_neg_value
RDK-2424</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_FP_setLED_neg_2424');
dsobj.configureTestCase(ip,port,'SM_FP_setLED_neg_2424');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
        ...
        if "SUCCESS" in result.upper():
                    ...
                    if expectedresult in actualresult:
                            ...
                            if expectedresult in actualresult:
                                    print "SUCCESS: Application failed to set negative value for SM_FP_SetLED API";
                                    tdkTestObj.setResultStatus("SUCCESS");
