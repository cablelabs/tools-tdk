...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <test_objective>Checks if the service manager wrapper for TR-181 returns the correct value for Pre-equalization data for the down stream channel 49</test_objective>
