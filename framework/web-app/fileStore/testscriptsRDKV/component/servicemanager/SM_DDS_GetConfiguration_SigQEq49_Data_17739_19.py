...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns non empty value for Pre-equalization data for the down stream channel 49</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_17739_19</test_case_id>
    <test_objective>Checks if the service manager wrapper for TR-181 returns non empty value for Pre-equalization data for the down stream channel 49</test_objective>
...
3.On Success of registerService , Service_Manager_Agent will invoke "getConfiguration" API to get the value of the object "Device.X_RDKCENTRAL-COM_DocsIf.docsIfSigQEqualizationData_49".
...
Checkpoint 2. Check the value retrieved using API is non empty.</except_output>
    ...
    <test_script>SM_DDS_GetConfiguration_SigQEq49_Data_17739_19</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
