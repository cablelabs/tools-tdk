...
<xml>
  ...
  <name>SM_DisplaySettings_HDMI_HotplugEventConnected_BackToBack_16024_3</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invokes HotplugEventConnected event multiple times
  TestCase ID : CT_16024_3</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_DisplaySettings_HDMI_HotplugEventConnected_BackToBack_16024_3');
