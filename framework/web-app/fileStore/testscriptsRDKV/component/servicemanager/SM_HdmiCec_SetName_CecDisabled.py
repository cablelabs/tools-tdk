...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>SM_HdmiCec_SetName_CecDisabled</name>
  <primitive_test_id>106</primitive_test_id>
  <primitive_test_name>SM_RegisterService</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: Service Manager – Setting the STB device name and fetch the name after disabling CEC.
Test Case Id: CT_Service Manager_39.
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_39</test_case_id>
    <test_objective>Service Manager – Setting the STB device name and fetch the name after disabling CEC.</test_objective>
...
4. On Success of disabling cec, Service_Manager_Agent will set the name for CEC device.
...
Checkpoint 2.Compare the name set with current name returned.
    ...
    <test_script>SM_HdmiCec_SetName_CecDisabled</test_script>
    <skipped>Yes</skipped>
    <release_version>M25</release_version>
    <remarks>SM_HdmiCec_DisableCec_SetGetDeviceName changed to SM_HdmiCec_SetName_CecDisabled during M-29 release</remarks>
  </test_cases>
</xml>
...
smObj.configureTestCase(ip,port,'SM_HdmiCec_SetName_CecDisabled');
iarmObj.configureTestCase(ip,port,'SM_HdmiCec_SetName_CecDisabled');
