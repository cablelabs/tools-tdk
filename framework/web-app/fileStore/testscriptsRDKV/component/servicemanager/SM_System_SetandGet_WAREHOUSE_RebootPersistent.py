...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_System_SetandGet_WAREHOUSE_RebootPersistent</name>
  <primitive_test_id/>
  <primitive_test_name>SM_Generic_CallMethod</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the mode as WAREHOUSE, reboot the box and then get the mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_123</test_case_id>
    <test_objective>To set WAREHOUSE mode , reboot the box and then get the mode using system service</test_objective>
...
Checkpoint 2.Check the  mode set with setMode by getting it using getMode</except_output>
    ...
    <test_script>SM_System_SetandGet_WAREHOUSE_RebootPersistent</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_SetandGet_WAREHOUSE_RebootPersistent');
iarmObj.configureTestCase(ip,port,'SM_System_SetandGet_WAREHOUSE_RebootPersistent');
        ...
        if "SUCCESS" in connect:
            ...
            if "SUCCESS" in register:
                ...
                if expectedresult in actualresult:
                    ...
                    paramValue = {"duration":1000,"mode":"WAREHOUSE"}
                    methodName="setMode"
                    tdkTestObj.addParameter("service_name", serviceName);
