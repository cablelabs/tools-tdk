...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_WithHDMI_ValidMode_14319_15</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test setSoundMode on a connected HDMI port with a valid audio mode
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_WithHDMI_ValidMode_14319_15');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_WithHDMI_ValidMode_14319_15');
