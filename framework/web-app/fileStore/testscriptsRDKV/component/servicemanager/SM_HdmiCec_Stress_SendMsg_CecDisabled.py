...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_43</test_case_id>
    <test_objective>Service Manager – Send message to the STB device multiple times (5 times) with disabling CEC.</test_objective>
...
4. On Success of disabling cec, Service_Manager_Agent will send message for a CEC device continues 5 times.
...
Checkpoint 2.Check for the message pattern for message sent in cec.txt.
    ...
    <test_script>SM_HdmiCec_Stress_SendMsg_CecDisabled</test_script>
    <skipped>No</skipped>
    <release_version>M25</release_version>
    <remarks>SM_HdmiCec_DisableCec_SendMsgFiveTimes Changed to SM_HdmiCec_Stress_SendMsg_CecDisabled during M-29 release </remarks>
  </test_cases>
</xml>
