...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_77</test_case_id>
    <test_objective>To  set and get the power state using system service</test_objective>
...
5.if LIGHT_SLEEP is available then set mode as LIGHT_SLEEP and the power state as STANDBY
...
Checkpoint 2.Check the power state is set as STANDBY</except_output>
    ...
    <test_script>SM_System_SetandGet_PowerState_Standby</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_SetandGet_PowerState_Standby');
iarmObj.configureTestCase(ip,port,'SM_System_SetandGet_PowerState_Standby');
