...
<xml>
  ...
  <name>SM_Generic_light_reset_Reboot_19465_2</name>
...
obj.configureTestCase(ip,port,'SM_WH_light_reset_19465_1');
ibusobj.configureTestCase(ip,port,'SM_WH_light_reset_19465_1');
               ...
               if expectedresult in actualresult:
                   ...
                   if "SUCCESS" in result.upper():
                       ...
                       if expectedresult in actualresult:
                          ...
                          expectedresult="SUCCESS"
                          tdkTestObj.addParameter("service_name", service_name);
                          tdkTestObj.addParameter("method_name", "lightReset");
                          tdkTestObj.executeTestCase(expectedresult);
                          actualresult = tdkTestObj.getResult();
                          serviceDetail = tdkTestObj.getResultDetails();
                          print "[TEST EXECUTION DETAILS]: %s"%serviceDetail;
                          if expectedresult in actualresult:
                              print "SUCCESS: lightReset successful";
                              tdkTestObj.setResultStatus("SUCCESS");
                          else:
                              print "FAILURE: lightReset failure";
                ...
                #Check for SUCCESS/FAILURE return value of SM_UnRegisterService
                   ...
                   #Reboot
                   ibusobj.initiateReboot();
                   ibusobj.resetConnectionAfterReboot();
                   #calling IARMBUS API "IARM_Bus_Init"
                   tdkTestObj = ibusobj.createTestStep('IARMBUS_Init');
                   expectedresult="SUCCESS"
                   tdkTestObj.executeTestCase(expectedresult);
