...
<xml>
  ...
  <name>SM_FP_setpreferences_reboot_2424</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>SM_FP_setpreferences_reboot_test
RDK-2424</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_FP_setpreferences_reboot_2424');
dsobj.configureTestCase(ip,port,'SM_FP_setpreferences_reboot_2424');
                                    ...
                                    if expectedresult in actualresult and str(LEDColorRed) in details and str(LEDColorBlue) in details and str(LEDColorGreen) in details and str(LEDBrightness) in details:
                                            ...
                                            if "SUCCESS" in result.upper():
                                                        ...
                                                        if expectedresult in actualresult:
                                                                ...
                                                                #Check for SUCCESS/FAILURE return value of SM_DisplaySetting_SetbrightnessSettings
                                                                if expectedresult in actualresult and str(LEDColorRed) in details and str(LEDColorBlue) in details and str(LEDColorGreen) in details and str(LEDBrightness) in details:
                                                                        print "SUCCESS: Application succesfully retains the value after Reboot SM_FP_GetPreferences API";
                                                                        tdkTestObj.setResultStatus("SUCCESS");
                                                                        print brightnessdetails;
                                                                else:
