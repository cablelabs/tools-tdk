...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_44</test_case_id>
    <test_objective>Service Manager â&#128;&#147; Setting the STB device name and fetch the name multiple times (5 times) after enabling CEC.</test_objective>
...
4. On Success of enabling cec, Service_Manager_Agent will set the name for CEC device 5 times.
