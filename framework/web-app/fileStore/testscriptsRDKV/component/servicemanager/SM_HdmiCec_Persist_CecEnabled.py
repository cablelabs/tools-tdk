...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_53</test_case_id>
    <test_objective>Service Manager – Checking whether HdmiCecService::getEnabled() returns true without enabling cec, but obtained from persisted status</test_objective>
...
Checkpoint 2. Checking the cec service status persists even after deregister the service</except_output>
    ...
    <test_script>SM_HdmiCec_Persist_CecEnabled</test_script>
    <skipped>No</skipped>
