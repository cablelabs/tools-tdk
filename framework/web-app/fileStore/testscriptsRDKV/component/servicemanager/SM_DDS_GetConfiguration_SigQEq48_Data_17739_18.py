...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns non empty value for Pre-equalization data for the down stream channel 48</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Checks if the service manager wrapper for TR-181 returns non empty value for Pre-equalization data for the down stream channel 48</test_objective>
