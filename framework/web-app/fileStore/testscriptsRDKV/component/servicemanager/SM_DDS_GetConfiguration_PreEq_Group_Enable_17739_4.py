...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_DDS_GetConfiguration_PreEq_Group_Enable_17739_4</name>
  <primitive_test_id/>
  <primitive_test_name>SM_DDS_GetConfiguration</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns the correct value corresponding to enable/disable for pre-equalization(80-81) on the upstream channel</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_17739_4</test_case_id>
    <test_objective>Checks if the service manager wrapper for TR-181 returns the correct value corresponding to enable/disable for pre-equalization on the upstream channel (80-81)</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-V3	</test_setup>
    <pre_requisite>HostIF should be enabled
...
3.On Success of registerService , Service_Manager_Agent will invoke "getConfiguration" API to get the value of the objects "Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelPreEqEnable_80,Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelPreEqEnable_81".
...
Checkpoint 2. Check the value retrieved using API is same as the value retrieved using snmp command.	</except_output>
    ...
    <test_script>SM_DDS_GetConfiguration_PreEq_Group_Enable_17739_4</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_PreEq_Group_Enable_17739_4');
snmpObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_PreEq_Group_Enable_17739_4');
...
if "SUCCESS" in smLoadStatus.upper() and "SUCCESS" in snmpLoadStatus.upper():
        ...
        if "SUCCESS" in register:
                ...
                names = "Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelPreEqEnable_80,Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelPreEqEnable_81";
                ...
                if "SUCCESS" in register:
                        ...
                        if expectedresult in actualresult:
                                ...
                                if ecmIp != "":
                                        ...
                                        snmpOid = [".1.3.6.1.2.1.10.127.1.1.2.1.19.80",".1.3.6.1.2.1.10.127.1.1.2.1.19.81"]
                                        status = "SUCCESS";
