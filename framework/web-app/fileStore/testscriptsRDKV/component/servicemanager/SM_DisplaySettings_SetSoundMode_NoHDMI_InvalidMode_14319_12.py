...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_NoHDMI_InvalidMode_14319_12</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test setSoundMode on unconnected HDMI port with a invalid audio mode
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_NoHDMI_InvalidMode_14319_12');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_NoHDMI_InvalidMode_14319_12');
