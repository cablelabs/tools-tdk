...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_DDS_GetConfiguration_BandWidth82_17739_8</name>
  <primitive_test_id/>
  <primitive_test_name>SM_DDS_GetConfiguration</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns the correct value for bandwidth of upstream interface(82)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_17739_8</test_case_id>
    <test_objective>Checks if the service manager wrapper for TR-181 returns the correct value for bandwidth of upstream interface(82)</test_objective>
...
3.On Success of registerService , Service_Manager_Agent will invoke "getConfiguration" API to get the value of the object "Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelWidth_82".
...
Checkpoint 2. Check the value retrieved using API is same as the value retrieved using snmp command.	</except_output>
    ...
    <test_script>SM_DDS_GetConfiguration_BandWidth82_17739_8</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_BandWidth82_17739_8');
snmpObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_BandWidth82_17739_8');
...
if "SUCCESS" in smLoadStatus.upper() and "SUCCESS" in snmpLoadStatus.upper():
		...
		ecmIp = getECMIp();
			...
			if commString != "":
        	        	actResponse =snmplib.SnmpExecuteCmd("snmpwalk", commString, "-v 2c", ".1.3.6.1.2.1.10.127.1.1.2.1.3", ecmIp);
				if "127.1.1.2.1.3.82" in actResponse:
                                        actResponse =snmplib.SnmpExecuteCmd("snmpget", commString, "-v 2c", ".1.3.6.1.2.1.10.127.1.1.2.1.3.82", ecmIp);
					snmpValue = actResponse.split(": ");
                                        print snmpValue[-1].strip();				

					#Prmitive test case which associated to this Script
                			tdkTestObj = smObj.createTestStep('SM_DDS_GetConfiguration');
                			names = "Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelWidth_82";
