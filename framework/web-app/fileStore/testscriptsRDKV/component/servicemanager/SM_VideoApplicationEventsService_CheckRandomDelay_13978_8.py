...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Verify that randomdelay is zero when application is set with 0 max random delay</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_VideoApplicationEventsService_CheckRandomDelay_13978_8');
