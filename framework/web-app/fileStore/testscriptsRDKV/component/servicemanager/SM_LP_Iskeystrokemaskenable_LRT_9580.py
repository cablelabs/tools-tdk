...
<xml>
  ...
  <name>SM_LP_Iskeystrokemaskenable_LRT_9580</name>
...
ibusobj.configureTestCase(ip,port,'SM_LP_LRT_isKeystrokeMaskEnabled_LRT_9580');
smobj = tdklib.TDKScriptingLibrary("servicemanager","2.0");
smobj.configureTestCase(ip,port,'SM_LP_LRT_isKeystrokeMaskEnabled_LRT_9580');
               ...
               if expectedresult in actualresult:
                       ...
                       #Prmitive test case which associated to this Script
                          for i in range(200):
                                  ...
                                  expectedresult="SUCCESS"
                                  tdkTestObj.addParameter("params", flag);
                                  tdkTestObj.addParameter("service_name", service_name);
                                  ...
                                  if expectedresult in actualresult:
                                      ...
                                      if expectedresult in actualresult:
                                          ...
                                          print "FAILURE: get mask failure";
                                          tdkTestObj.setResultStatus("FAILURE");
                                      if ((1==flag) and ("TRUE" in serviceDetail.upper())) or ((0==flag) and ("FALSE" in serviceDetail.upper())):
                                          print " both  set and get are same"
                                      else:
                                          print "set and get are different"
                                  else:
                                      print "FAILURE: Mask enabled failure";
                                      tdkTestObj.setResultStatus("FAILURE");
