...
<xml>
  ...
  <name>SM_DisplaySettings_HDMI_HotplugEvent_Connected_16024_1</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests HDMI_HotplugEvent_Connected event
  TestCase ID : CT_16024_1</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_DisplaySettings_HDMI_HotplugEvent_Connected_16024_1');
