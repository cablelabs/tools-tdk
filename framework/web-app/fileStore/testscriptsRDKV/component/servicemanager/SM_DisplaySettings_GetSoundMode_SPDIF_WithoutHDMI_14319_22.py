...
<xml>
  ...
  <name>SM_DisplaySettings_GetSoundMode_SPDIF_WithoutHDMI_14319_22</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id></primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>SM_DisplaySetting_GetSoundMode</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>returns the audio output mode of SPDIF port when HDMI is not connected
  Test Case ID : CT_14319_22</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_SPDIF_WithoutHDMI_14319_22');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_SPDIF_WithoutHDMI_14319_22');
