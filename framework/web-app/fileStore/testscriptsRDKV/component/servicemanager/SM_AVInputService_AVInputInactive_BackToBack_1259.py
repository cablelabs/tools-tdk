...
<xml>
  ...
  <name>SM_AVInputService_AVInputInactive_BackToBack_1259</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invokes AVInputInactiveEvent event multiple times
  TestCase ID : CT_1259_4</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_AVInputService_AVInputInactive_BackToBack_1259');
