...
<xml>
  ...
  <name>SM_AVInputService_AVInputInactiveEvent_1259</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tets AVInputInactiveEvent event
  TestCase ID : CT_1259_2</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_AVInputService_AVInputInactiveEvent_1259');
