...
<xml>
  ...
  <name>SM_StorageManagerService_SetTSBMaxMinutesValueZero</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks if the service manager API setTSBMaxMinutes sets TSBMaxMinutes lower border value of 0 successfully</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_97</test_case_id>
    <test_objective>Checks if the service manager API setTSBMaxMinutes sets TSBMaxMinutes lower border value of 0 successfully</test_objective>
...
4. Service_Manager_Agent will invoke "setTSBMaxMinutes" API to change the TSBMaxMinutes value to lower border value of 0.
5. Service_Manager_Agent will invoke "getTSBMaxMinutes" API to check if TSBMaxMinutes value changed to 0 and return SUCCESS/FAILURE status.
...
Checkpoint 2.Check the return value of the get API is same as the one set using set API.</except_output>
    ...
    <test_script>SM_StorageManagerService_SetTSBMaxMinutesValueZero</test_script>
    <skipped>No</skipped>
					...
					#Get the result of execution
						...
						if expectedresult in actualresult:
							...
							if tsbMaxMinutes == valueToSet:
			                                        print "TSBMaxMinutes value set to 0";
								tdkTestObj.setResultStatus("SUCCESS");
							else: 
