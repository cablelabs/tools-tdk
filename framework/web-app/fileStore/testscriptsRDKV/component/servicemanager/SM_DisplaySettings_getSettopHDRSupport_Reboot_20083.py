...
<xml>
  ...
  <name>SM_DisplaySettings_getSettopHDRSupport_Reboot_20083</name>
...
dsObj.configureTestCase(ip,port,'CT_SM_DisplaySettings_GetSettopHDRSupport_Reboot_20083');
...
smobj.configureTestCase(ip,port,'CT_SM_DisplaySettings_GetSettopHDRSupport_reboot_20083');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("service_name", service_name);
                tdkTestObj.addParameter("method_name", "getSettopHDRSupport");
                ...
                if ("AX014" or "PX051") in imagename:
                        if ((expectedresult in actualresult) and ("HDR10" in serviceDetail)):
                                print "SUCCESS: getSettopHDRSupport successful"; 
                                tdkTestObj.setResultStatus("SUCCESS");
                        else: 
                                print "FAILURE: getSettopHDRSupport  failure"; 
                                tdkTestObj.setResultStatus("FAILURE");
                elif "AX061" in imagename:
                        if ((expectedresult in actualresult) and ("HDR10" and "Dolby Vision" and "TechniColor Prime") in serviceDetail):
                                print "SUCCESS: getSettopHDRSupport successful"; 
                                tdkTestObj.setResultStatus("SUCCESS");
                        else: 
                                print "FAILURE: getSettopHDRSupport failure"; 
                        ...
                        if ((expectedresult in actualresult) and ("none" in serviceDetail)):
                                print "SUCCESS: getSettopHDRSupport successful"; 
                                tdkTestObj.setResultStatus("SUCCESS");
                        else: 
                                print "FAILURE: getSettopHDRSupport failure3"; 
                                tdkTestObj.setResultStatus("FAILURE");
