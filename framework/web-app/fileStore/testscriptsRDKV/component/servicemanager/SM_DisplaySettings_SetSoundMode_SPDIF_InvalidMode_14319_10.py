...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_SPDIF_InvalidMode_14319_10</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests setsoundMode on spdif port with an incompatible audio mode
  Test Case Id : CT_14319_10</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_SPDIF_InvalidMode_14319_10');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_SPDIF_InvalidMode_14319_10');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                        print "SUCCESS: SetAudiomode failed with invalid mode";
                        tdkTestObj.setResultStatus("SUCCESS");
                else:
                        print "FAILURE: SetAudiomode success with invalid mode";
