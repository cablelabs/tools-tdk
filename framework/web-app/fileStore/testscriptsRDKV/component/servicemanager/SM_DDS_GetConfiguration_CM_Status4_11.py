...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_DDS_GetConfiguration_CM_Status4_11</name>
  <primitive_test_id/>
  <primitive_test_name>SM_DDS_GetConfiguration</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns the correct value for CM Status (4)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_17739_11</test_case_id>
    <test_objective>Checks if the service manager wrapper for TR-181 returns the correct value for CM Status (4)</test_objective>
...
3.On Success of registerService , Service_Manager_Agent will invoke "getConfiguration" API to get the value of the object "Device.X_RDKCENTRAL-COM_DocsIf.docsIf3CmStatus_4".
...
Checkpoint 2. Check the value retrieved using API is same as the value retrieved using snmp command.</except_output>
    ...
    <test_script>SM_DDS_GetConfiguration_CM_Status4_11</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_CM_Status4_11');
snmpObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_CM_Status4_11');
...
if "SUCCESS" in smLoadStatus.upper() and "SUCCESS" in snmpLoadStatus.upper():
        ...
        if "SUCCESS" in register:
                ...
                names = "Device.X_RDKCENTRAL-COM_DocsIf.docsIf3CmStatus_4";
                ...
                if "SUCCESS" in register:
                        ...
                        if expectedresult in actualresult:
                                ...
                                if ecmIp != "":
                                        ...
                                        snmpOid = ["1.3.6.1.4.1.4491.2.1.20.1.2.1.6.4"];
                                        status = "SUCCESS";
