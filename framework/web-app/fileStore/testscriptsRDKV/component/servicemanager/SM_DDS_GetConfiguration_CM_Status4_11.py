...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns non empty value for CM Status (4)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Checks if the service manager wrapper for TR-181 returns non empty value for CM Status (4)</test_objective>
...
4. TM will check if the valueis non empty and return SUCCESS/FAILURE status.
