...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedAudioMode_ParamNone_14319_7</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests GetSupportedAudioModes api with no parameter
  Test Case Id : CT_14319_7</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_14319_3');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_ParamNone_14319_7');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                #calling GetSupportedAudioModes
                ...
                #Check for SUCCESS/FAILURE return value of SM_GetSupportedAudioModes
                if expectedresult in actualresult:
