...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_65</test_case_id>
    <test_objective>Enable the VPOP using home networking service</test_objective>
...
Checkpoint 2. Check the value retrieved using is_vpop_enabled API is same as the value set using set_vpop_enabled API.</except_output>
    ...
    <test_script>SM_HN_Enable_VPOP</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_HN_Enable_VPOP');
