...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>SM_DDS_GetConfiguration_BandWidth_Group_17739_7</name>
  <primitive_test_id/>
  <primitive_test_name>SM_DDS_GetConfiguration</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns the correct value for bandwidth of upstream interface(80-81)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_17739_7</test_case_id>
    <test_objective>Checks if the service manager wrapper for TR-181 returns the correct value for bandwidth of upstream interface(80-81)</test_objective>
...
3.On Success of registerService , Service_Manager_Agent will invoke "getConfiguration" API to get the value of the objects "Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelWidth_80,Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelWidth_81,Device.X_RDKCENTRAL-COM_DocsIf.docsIfUpChannelWidth_82".
...
Checkpoint 2. Check the value retrieved using API is same as the value retrieved using snmp command.	</except_output>
    ...
    <test_script>SM_DDS_GetConfiguration_BandWidth_Group_17739_7</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_BandWidth_Group_17739_7');
snmpObj.configureTestCase(ip,port,'SM_DDS_GetConfiguration_BandWidth_Group_17739_7');
