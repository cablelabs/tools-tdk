...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_WithHDMI_InValidMode_14319_16</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test setSoundMode on a connected HDMI port with a invalid audio mode
  Test Case Id : CT_14319_161</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_WithHDMI_InValidMode_14319_16');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_WithHDMI_InValidMode_14319_16');
