...
<xml>
  ...
  <name>SM_Generic_Reset_Flag_set_Cname_match_18573_1</name>
...
ibusobj.configureTestCase(ip,port,'SM_WH_Reset_Flag_set_Cname_match_18573_1');
obj = tdklib.TDKScriptingLibrary("servicemanager","1.3");
obj.configureTestCase(ip,port,'SM_WH_Reset_Flag_set_Cname_match_18573_1');
