...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>Checks if the service manager wrapper for TR-181 returns non empty values for CM Status (80,81)</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Checks if the service manager wrapper for TR-181 returns non empty values for CM Status (80,81)</test_objective>
...
4. TM will check if the values non empty and return SUCCESS/FAILURE status.
...
Checkpoint 2. Check the values retrieved using API are non empty </except_output>
