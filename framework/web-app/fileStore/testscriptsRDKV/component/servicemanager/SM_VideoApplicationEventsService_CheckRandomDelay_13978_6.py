...
<xml>
  ...
  <name>SM_VideoApplicationEventsService_CheckRandomDelay_13978_6</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks if the random delay is calculated correctly</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_VideoApplicationEventsService_CheckRandomDelay_13978_6');
