...
ibusobj.configureTestCase(ip,port,'SM_LP_isKeystrokeMaskEnabled_false_9580');
smobj = tdklib.TDKScriptingLibrary("servicemanager","2.0");
smobj.configureTestCase(ip,port,'SM_LP_isKeystrokeMaskEnabled_false_9580');
                       ...
                       if expectedresult in actualresult:
                          ...
                          if expectedresult in actualresult:
                              ...
                              if expectedresult in actualresult:
                                  ...
                                  tdkTestObj.setResultStatus("FAILURE");
                              if (inputList==0) and ("FALSE" in serviceDetail.upper()):
