...
<xml>
  ...
  <name>SM_DisplaySettings_SetSoundMode_None_WithHDMI_14319_17</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test setSoundMode with no parameters. mode of connected port should change
  Test Case Id : CT_14319_17</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_None_WithHDMI_14319_17');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_SetSoundMode_None_WithHDMI_14319_17');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
			...
			if "AUTO" in get_ret[1]:
                ...
                if expectedresult in get_ret[0]:
                        print "SUCCESS: GetSoundMode() successful";
			if audioMode.upper() in get_ret[1]:
