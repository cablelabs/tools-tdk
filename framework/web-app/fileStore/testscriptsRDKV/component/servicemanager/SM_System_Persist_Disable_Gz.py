...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_85</test_case_id>
    <test_objective>To check whether disable the GZ using system service is persisting or not</test_objective>
...
Checkpoint 2.Check the GZ value as False</except_output>
    ...
    <test_script>SM_System_Persist_Disable_Gz</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_Persist_Disable_Gz');
                ...
                if expectedresult in actualresult:
                    ...
                    if "SUCCESS" in register:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if gzNewValue == "false":
                                tdkTestObj.setResultStatus("SUCCESS");
                                print "Successfully GZ is disabled and it is persisted also"
