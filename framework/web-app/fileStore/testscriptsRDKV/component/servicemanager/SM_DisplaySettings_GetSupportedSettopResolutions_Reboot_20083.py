...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedSettopResolutions_Reboot_20083</name>
...
dsObj.configureTestCase(ip,port,'CT_SM_DisplaySettings_GetSupportedSettopResolutions_Reboot_20083');
...
smobj.configureTestCase(ip,port,'CT_SM_DisplaySettings_GetSupportedSettopResolutions_reboot_20083');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("service_name", service_name);
                tdkTestObj.addParameter("method_name", "getSupportedSettopResolutions");
                ...
                if (("AX014" or "AX061") in imagename):
                        if ((expectedresult in actualresult) and ("2160p30" and "2160p60") in serviceDetail):
                                print  "SUCCESS: GetSupportedSettopResolutions successful";  
                                tdkTestObj.setResultStatus("SUCCESS");
                        else: 
                                print "FAILURE: GetSupportedSettopResolutions failure"; 
                                tdkTestObj.setResultStatus("FAILURE");
                else:
                        if expectedresult in actualresult:
                                print "SUCCESS: GetSupportedSettopResolutions successful"; 
