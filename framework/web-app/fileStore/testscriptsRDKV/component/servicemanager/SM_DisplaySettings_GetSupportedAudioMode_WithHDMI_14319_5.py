...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedAudioMode_WithHDMI_14319_5</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks supported audio modes of HDMI port when port is connected
  Test Case ID : CT_14319_5</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_WithHDMI_14319_5');
