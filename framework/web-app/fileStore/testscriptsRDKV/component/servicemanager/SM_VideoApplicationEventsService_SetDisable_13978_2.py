...
<xml>
  ...
  <name>SM_VideoApplicationEventsService_SetDisable_13978_2</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if Video Application events service can be disabled</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_VideoApplicationEventsService_SetDisable_13978_2');
		...
		if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                                ...
                                if valueToSetEnabled == int(resultDetails):
                                        ...
                                        print "video application ervice event disabling failed\n";
                        else:
                                tdkTestObj.setResultStatus("FAILURE");
