...
<xml>
  ...
  <name>SM_System_SetandGet_EAS_PositiveDuration</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set the EAS mode for a particular duration and verify if it gets the NORMAL mode after that duration</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_113</test_case_id>
    <test_objective>To set EAS mode with positive duration and to verify that the mode is switched to NORMAL after a particular duration seconds using system service</test_objective>
...
Checkpoint 2.Check the  mode set with setMode by getting it using getMode</except_output>
    ...
    <test_script>SM_System_SetandGet_EAS_PositiveDuration</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_SetandGet_EAS_PositiveDuration');
iarmObj.configureTestCase(ip,port,'SM_System_SetandGet_EAS_PositiveDuration');
        ...
        if "SUCCESS" in connect:
            ...
            if "SUCCESS" in register:
                ...
                if expectedresult in actualresult:
                    ...
                    paramValue = {"duration":20,"mode":"EAS"}
                    methodName="setMode"
                    tdkTestObj.addParameter("service_name", serviceName);
