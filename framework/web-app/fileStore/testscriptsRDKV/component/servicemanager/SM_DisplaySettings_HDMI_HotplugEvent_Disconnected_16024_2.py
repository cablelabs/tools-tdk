...
<xml>
  ...
  <name>SM_DisplaySettings_HDMI_HotplugEvent_Disconnected_16024_2</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests HDMI_HotplugEvent_Disconnected event
  TestCase ID : CT_16024_2</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_DisplaySettings_HDMI_HotplugEvent_Disconnected_16024_2');
