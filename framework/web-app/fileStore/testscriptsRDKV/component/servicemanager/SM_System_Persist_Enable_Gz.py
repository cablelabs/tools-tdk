...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_84</test_case_id>
    <test_objective>To check whether enable the GZ using system service is persisting or not</test_objective>
...
5.Get the existing GZ value then enable the GZ 
6.Unregister the service and register again .Get the GZ state and revert the value. 
...
Checkpoint 2.Check the GZ value as True</except_output>
    <priority>High</priority>
    <test_stub_interface>libservicemanagerstub.so</test_stub_interface>
    <test_script>SM_System_Persist_Enable_Gz</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_System_Enable_Gz');
...
if "SUCCESS" in smLoadStatus.upper():
    ...
    if "SUCCESS" in register:
        ...
        if expectedresult in actualresult:
            ...
            tdkTestObj.addParameter("method_name", methodName);
            tdkTestObj.executeTestCase(expectedresult);
            print "Calling method :",methodName, "before enabling GZ"
            actualresult = tdkTestObj.getResult();
            ...
            if expectedresult in actualresult:
                ...
                print "GZ value before enabling is" , gzValue
                #Enable GZ 
                tdkTestObj = smObj.createTestStep('SM_Generic_CallMethod');
                methodName="setGzEnabled";
                ...
                if expectedresult in actualresult:
                    ...
                    if "SUCCESS" in register:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if gzNewValue == "true":
                                tdkTestObj.setResultStatus("SUCCESS");
                                print "Successfully GZ is enabled and it is persisted also"
