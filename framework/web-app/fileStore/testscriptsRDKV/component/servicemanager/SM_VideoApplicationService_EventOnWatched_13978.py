...
<xml>
  ...
  <name>SM_VideoApplicationService_EventOnWatched_13978</name>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_VideoApplicationService_EventOnWatched_13978');
