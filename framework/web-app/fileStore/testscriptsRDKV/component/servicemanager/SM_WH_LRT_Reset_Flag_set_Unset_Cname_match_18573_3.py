...
<xml>
  ...
  <name>SM_Generic_LRT_Reset_Flag_set_Unset_Cname_match_18573_3</name>
...
ibusobj = tdklib.TDKScriptingLibrary("iarmbus","1.3");
obj = tdklib.TDKScriptingLibrary("servicemanager","1.3");
obj.configureTestCase(ip,port,'SM_WH_LRT_Reset_Flag_set_unset_18573_3');
ibusobj.configureTestCase(ip,port,'SM_WH_LRT_Reset_Flag_set_unset_18573_3');

result = ibusobj.getLoadModuleResult();
print "[Iarmbus module loading status]  :  %s" %result;
ibusobj.setLoadModuleStatus(result.upper());
                   ...
                   if "SUCCESS" in result.upper():
                       ...
                       if expectedresult in actualresult:
                          ...
                          for i in range(200):
                              ...
                              expectedresult="SUCCESS"
                              inputList = []
                              inputValue = {"suppressReboot":supress_flag}
                              inputList.append(inputValue.copy())
                              tdkTestObj.addParameter("params", inputList);
                              tdkTestObj.addParameter("service_name", service_name);
                              tdkTestObj.addParameter("method_name", "resetDevice");
                              tdkTestObj.executeTestCase(expectedresult);
                              actualresult = tdkTestObj.getResult();
                              serviceDetail = tdkTestObj.getResultDetails();
                              print "[TEST EXECUTION DETAILS]: %s"%serviceDetail;
                              if expectedresult in actualresult:
                                  print "SUCCESS: resetDevice successful";
                                  tdkTestObj.setResultStatus("SUCCESS");
                              else:
                                  print "FAILURE: resetDevice failure";
