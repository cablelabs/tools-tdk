...
<xml>
  ...
  <name>SM_DisplaySettings_GetTvHDRSupport_Reboot_20083</name>
...
dsObj.configureTestCase(ip,port,'CT_SM_DisplaySettings_GetTvHDRSupport_Reboot_20083');
...
smobj.configureTestCase(ip,port,'CT_SM_DisplaySettings_GetTvHDRSupport_reboot_20083');
...
if "SUCCESS" in result.upper():
        ...
        if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("service_name", service_name);
                tdkTestObj.addParameter("method_name", "getTvHDRSupport");
                ...
                if expectedresult in actualresult:
                        print "SUCCESS: getTvHDRSupport successful";
                        tdkTestObj.setResultStatus("SUCCESS");
                else:
                        print "FAILURE: getTvHDRSupport failure";
                        tdkTestObj.setResultStatus("FAILURE");
