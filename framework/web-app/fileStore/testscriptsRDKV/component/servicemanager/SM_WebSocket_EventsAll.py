...
Test Case ID: CT_Service Manager_21</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_21</test_case_id>
    <test_objective>Script to registerForEvents/unregisterEvents all available events ("onOpen","onError","onClose","onMessage") for service "WebSocketService"</test_objective>
...
Service::UnregisterEvents</api_or_interface_used>
    <input_parameters>string service_name ("WebSocketService")
string event_name ("onOpen","onError","onClose","onMessage")</input_parameters>
...
3.TestMgr_SM_UnRegisterService</test_stub_interface>
    <test_script>SM_WebSocket_EventsAll</test_script>
    <skipped>No</skipped>
