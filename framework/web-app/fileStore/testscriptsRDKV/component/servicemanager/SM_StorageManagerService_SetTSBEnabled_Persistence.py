...
<xml>
  ...
  <name>SM_StorageManagerService_SetTSBEnabled_Persistence</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks if the value of TSBEnabled status persists across different instances of service manager</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_109</test_case_id>
    <test_objective>Checks if the value of TSBEnabled status persists across different instances of service manager</test_objective>
...
8. Service_Manager_Agent will invoke "isTSBEnabled" API to check if TSB status is same as the value set in step 4 and return SUCCESS/FAILURE status.
...
Checkpoint 2.Check the value of TSBEnabled status persists across different instances of service manager.</except_output>
    <priority>High</priority>
    <test_stub_interface>libservicemanagerstub.so</test_stub_interface>
    <test_script>SM_StorageManagerService_SetTSBEnabled_Persistence</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_StorageManagerService_SetTSBEnabled_Persistence');
iarmObj.configureTestCase(ip,port,'SM_StorageManagerService_SetTSBEnabled_Persistence');
                ...
                if "SUCCESS" in init:
					...
					tdkTestObj = smObj.createTestStep('SM_Generic_CallMethod');
						...
						if enableStatus == enable:
							print "TSB status persists";
							tdkTestObj.setResultStatus("SUCCESS");
						else:
							print "TSB status do not persist";
							tdkTestObj.setResultStatus("FAILURE");
