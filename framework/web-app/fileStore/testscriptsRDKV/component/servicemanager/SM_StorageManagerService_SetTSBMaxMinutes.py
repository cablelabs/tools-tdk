...
<xml>
  ...
  <name>SM_StorageManagerService_SetTSBMaxMinutes</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks if the service manager API setTSBMaxMinutes sets TSBMaxMinutes value successfully</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_96</test_case_id>
    <test_objective>Checks if the service manager API setTSBMaxMinutes sets TSBMaxMinutes value successfully</test_objective>
...
4. Service_Manager_Agent will invoke "setTSBMaxMinutes" API to change the TSBMaxMinutes value within valid range.
5. Service_Manager_Agent will invoke "getTSBMaxMinutes" API to check if TSBMaxMinutes value changed to the value set in step 4 and return SUCCESS/FAILURE status.
...
Checkpoint 2.Check the return value of the get API is same as the one set using set API.</except_output>
    ...
    <test_script>SM_StorageManagerService_SetTSBMaxMinutes</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
smObj.configureTestCase(ip,port,'SM_StorageManagerService_SetTSBMaxMinutes');
iarmObj.configureTestCase(ip,port,'SM_StorageManagerService_SetTSBMaxMinutes');
