...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_41</test_case_id>
    <test_objective>Service Manager – Send message to the STB device without enabling CEC.</test_objective>
...
Checkpoint 2.Check for the message pattern for message sent in cec.txt.
    ...
    <test_script>SM_HdmiCec_SendMsgGetCECVersion_CecDisabled</test_script>
    <skipped>No</skipped>
    <release_version>M25</release_version>
    <remarks>SM_HdmiCec_DisableCec_SendMsg cahnged to SM_HdmiCec_SendMsgGetCECVersion_CecDisabled during M-29 release</remarks>
  </test_cases>
</xml>
