...
<xml>
  ...
  <name>SM_DisplaySettings_GetSoundMode_HDMI_14319_8</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests audio output mode of HDMI port
  Test Case ID : CT_14319_8</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_HDMI_14319_8');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_HDMI_14319_8');
