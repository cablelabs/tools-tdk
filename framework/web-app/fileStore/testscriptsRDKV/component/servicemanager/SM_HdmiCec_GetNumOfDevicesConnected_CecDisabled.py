...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Service Manager_52</test_case_id>
    <test_objective>Service Manager – Checking the number of cec devices connected after disabling CEC. Atleast one hdmicec device is connected.</test_objective>
