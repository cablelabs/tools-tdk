...
<xml>
  ...
  <name>SM_DisplaySettings_GetSoundMode_SPDIF_14319_3</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>returns the audio output mode of SPDIF port.
  Test Case ID : CT_14319_3</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_SPDIF_14319_3');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSoundMode_SPDIF_14319_3');
