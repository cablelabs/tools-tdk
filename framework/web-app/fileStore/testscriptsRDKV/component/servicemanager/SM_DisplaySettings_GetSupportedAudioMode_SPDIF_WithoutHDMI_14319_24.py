...
<xml>
  ...
  <name>SM_DisplaySettings_GetSupportedAudioMode_SPDIF_WithoutHDMI_14319_24</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Checks supported audio modes of SPDIF port when HDMI is not connected
  Test Case ID : CT_14319_24</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
dsObj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_SPDIF_WithoutHDMI_14319_24');
...
obj.configureTestCase(ip,port,'SM_DisplaySettings_GetSupportedAudioMode_SPDIF_WithoutHDMI_14319_24');
