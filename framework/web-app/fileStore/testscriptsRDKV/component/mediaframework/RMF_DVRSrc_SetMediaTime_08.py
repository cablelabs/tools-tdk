...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_08</test_case_id>
    <test_objective>RMF_DVRSrc  – To set mediaTime by setMediaTime API of DVRSource element.</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>RMFResult init()       
RMFResult setMediaTime()
RMFResult    term()</api_or_interface_used>
    <input_parameters>Init(): None   
SetMediaTime():float time 
...
3. Mediaframework agent will call setMediaTime API by passing the mediatime value to be set, of DVRSrc element.
4. Mediaframework agent will terminate the  DVRSrc element.
5. For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_DVRSrc_SetMediaTime_08</test_script>
    <skipped>No</skipped>
