...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>888</id>
  <version>1</version>
  <name>RMF_HNSrc_MPSink_InvalidMediaTime_14</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework to set mediatime with negative big numbers in HNSrc MPSink pipeline. Test Case ID: CT_RMF_HNSrc_MPSink_14.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSrc_MPSink_14</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –To set the play position to big negative numbers on the HNSrc -MPSink pipeline</test_objective>
...
6.Mediaframework agent will set media time with big number,Set mediatime should not set and expecting failure from SetMediatime().
7.Mediaframework agent will get the media time value from the pipeline.
...
2.Check the failure return for setmediatime()</except_output>
    <priority>High</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_HNSrc_MPSink_InvalidMediaTime_14</test_script>
    <skipped>No</skipped>
