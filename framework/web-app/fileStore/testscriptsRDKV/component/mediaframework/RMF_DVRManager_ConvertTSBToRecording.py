...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>568</id>
  <version>1</version>
  <name>RMF_DVRManager_ConvertTSBToRecording</name>
  <primitive_test_id>443</primitive_test_id>
  <primitive_test_name>RMF_DVRManager_ConvertTSBToRecording</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This tests the convert TSB to recording functionality of dvr manager class.
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_11</test_case_id>
    <test_objective>RMF_DVRMgr –  To Convert TSB To Recording</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance()
ConvertTSBToRecording</api_or_interface_used>
    <input_parameters>CreateTSB: long long duration</input_parameters>
    <automation_approch>1.TM loads RMFStub_agent via the test agent.
2.TM will invoke “TestMgr_ConvertTSBToRecording ” with duration as a parameter in RMFStub_agent.
3.RMFStub_agent will call getinstance of Dvr Manager 
4.Call the methods  createTSB() and upon success it will call convertTSBToRecording using tsbId. 
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status. Checkpoint 2.Check the return value of the RecordingId and comapare against the actual value.</except_output>
    <priority>High</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_DVRManager_ConvertTSBToRecording</test_script>
    <skipped>No</skipped>
