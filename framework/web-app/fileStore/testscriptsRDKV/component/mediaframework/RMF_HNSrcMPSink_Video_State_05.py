...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSrc_MPSink_05</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –To  get the state of the RMF in HNSRC-MPSINK pipeline</test_objective>
...
2.TM will invoke “TestMgr_HNSrcMPSink_Video_State”.
...
9.After defined period of play,get the state of the pipeline using getstate() and return the status based on the API return. 
10.On Success of getstate(),close the video using close() and return the status based on the API return.
...
12.RMFStub_Agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_HNSrcMPSink_Video_State_05</test_script>
    <skipped>No</skipped>
