...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_10</test_case_id>
    <test_objective>RMF_DVRSrc  – To call Open API by passing valid as ocap url as input to its parameters and Close a DVRsource element.</test_objective>
...
open():char*-dvr locator(ocap url),char*- mimetype(NULL)
close():None 
...
3. Mediaframework agent will open the DVRSrc element with the valid ocap url (Ex: ocap://ocapId i.e, ocap://0xa1).
...
Checkpoint 2. Check the return value of open API  “RMF_RESULT_INVALID_ARGUMENT” for success.</except_output>
    ...
    <test_script>RMF_DVRSrc_Open_10</test_script>
    <skipped>No</skipped>
