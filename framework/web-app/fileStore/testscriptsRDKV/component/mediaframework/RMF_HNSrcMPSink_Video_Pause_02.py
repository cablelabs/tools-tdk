...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>890</id>
  <version>1</version>
  <name>RMF_HNSrcMPSink_Video_Pause_02</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework video paused in HNSrc MPSink pipeline. 
Test Case ID: CT_RMF_HNSrc_MPSink_02.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSrc_MPSink_02</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –To check the pause functionality while playing the playback URL on the HNSRC-MPSINK pipeline</test_objective>
...
2.TM will invoke “TestMgr_HNSrcMPSink_Video_Pause”.
...
9.After defined period of play,pause the video using pause() and return the status based on the API return. 
10.On Success of pause(),close the video using close() and return the status based on the API return.
...
12.RMFStub_Agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_HNSrcMPSink_Video_Pause_02</test_script>
    <skipped>No</skipped>
