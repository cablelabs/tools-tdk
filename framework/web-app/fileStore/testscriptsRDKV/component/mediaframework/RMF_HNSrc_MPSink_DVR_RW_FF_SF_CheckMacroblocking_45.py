...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_45</test_case_id>
    <test_objective>RMF_HNSRC_MPSink – 
Do RW FW  and Skip Front on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.</test_objective>
...
8. Mediaframework agent will call setMediaTime() to skip front.
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_RW_FF_SF_CheckMacroblocking_45</test_script>
    <skipped>No</skipped>
