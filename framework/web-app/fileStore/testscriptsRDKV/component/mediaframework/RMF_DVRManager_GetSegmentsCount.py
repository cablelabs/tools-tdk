...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_15</test_case_id>
    <test_objective>RMF_DVRMgr – To get Segments Count</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance()
 GetSegmentsCount</api_or_interface_used>
...
4.Call the methods  getSegmentsCount(), 
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_DVRManager_GetSegmentsCount</test_script>
    <skipped>No</skipped>
