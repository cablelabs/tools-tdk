...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1639</id>
  <version>6</version>
  <name>RMF_HNSrc_MPSink_DVR_RW_FF_CheckMacroblocking_43</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: RMF_HNSRC_MPSink –  Do RW FW on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.
Test CaseID: CT_RMF_HNSRC_MPSink_43
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_43</test_case_id>
    <test_objective>RMF_HNSRC_MPSink – 
Do RW FW on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.</test_objective>
...
6. Mediaframework agent will call setSpeed() to do RW.
7. Mediaframework agent will call setSpeed() to do FW.
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_RW_FF_CheckMacroblocking_43</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'RMF_HNSrc_MPSink_DVR_RW_FF_CheckMacroblocking_43');
