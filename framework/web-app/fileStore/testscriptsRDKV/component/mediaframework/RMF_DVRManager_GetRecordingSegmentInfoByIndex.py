...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>563</id>
  <version>1</version>
  <name>RMF_DVRManager_GetRecordingSegmentInfoByIndex</name>
  <primitive_test_id>449</primitive_test_id>
  <primitive_test_name>RMF_DVRManager_GetRecordingSegmentInfoByIndex</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This tests the get recording segment info by index functionality of dvr manager class	
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_18</test_case_id>
    <test_objective>RMF_DVRMgr – To get recording segment info by index.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>Recording should not be present</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance()
GetRecordingSegmentInfoByIndex()</api_or_interface_used>
...
2.TM will invoke “TestMgr_ getRecordingCount” in RMFStub_agent.
3.RMFStub_agent will call getinstance of Dvr Manager 
4.Call the methods  getRecordingSegmentInfoByIndex(), 
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status. Checkpoint 2.Check the return value of the segment count and compare against the actual value.</except_output>
    <priority>High</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_DVRManager_GetRecordingSegmentInfoByIndex</test_script>
    <skipped>No</skipped>
