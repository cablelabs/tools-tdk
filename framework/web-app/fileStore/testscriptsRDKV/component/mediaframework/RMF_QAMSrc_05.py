...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1138</id>
  <version>1</version>
  <name>RMF_QAMSrc_05</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RMF_QAMSrc – To Get List of sourceIds corresponding to the instance when factory method flag is set to false.
Test CaseId: CT_RMF_QAMSrc_05</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_05</test_case_id>
    <test_objective>RMF_QAMSrc – To Get List of sourceIds corresponding to the instance when factory method flag is set to false.</test_objective>
...
RMFResult getLTSID: unint32_t tsID.
Close(): None              
rmfqamsrc Term(): None   RMFQAMSrc::uninit_platform() : None                                rmf_platform Uninit(): None</input_parameters>
...
8.On success, Mediaframework agent will call getLTSID() of  QAMSrc element.
...
13.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_05</test_script>
    <skipped>No</skipped>
                        ...
                        if "SUCCESS" in result.upper():
                                ...
                                if "SUCCESS" in result.upper():
                                        ...
                                        if "SUCCESS" in result.upper():
                                                src_parameter=[]
                                                src_element=[]
                                                result=Create_and_ExecuteTestStep('RmfElement_QAMSrc_GetLTSID',obj,"SUCCESS",src_parameter,src_element);
