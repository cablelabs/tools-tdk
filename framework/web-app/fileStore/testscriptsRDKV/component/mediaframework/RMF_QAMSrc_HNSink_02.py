...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1155</id>
  <version>1</version>
  <name>RMF_QAMSrc_HNSink_02</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RMF_QAMSrc – To Stream out the live content through HNSink on to the network when factory method flag is set to false.
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_HNSink_02</test_case_id>
    <test_objective>RMF_QAMSrc – To Stream out the live content through HNSink on to the network when factory method flag is set to false.</test_objective>
...
10. On success, Mediaframework agent will call HNSink setHNSinkProperties().
...
20.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_HNSink_02</test_script>
    <skipped>No</skipped>
