...
Test Case ID: CT_RMF_MPSink_03.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_MPSink_03</test_case_id>
    <test_objective>RMF_MPSink – To change audio from mute to unmute and vice versa</test_objective>
...
2.TM will invoke “TestMgr_MPSink_SetGetMute” in RMFStub_agent.
3.RMFStub_agent will call init() API of the component and get the result.
4.On the Success of init() API, RMFStub_agent will call setMute() API of the component and get the result. 
5.On the Success of setMute() API RMFStub will call getMute() API of the component and get the result.
6.On the Success of getMute() API of the component RMFStub_agent will call term() API of the component and get the result.
7.RMFStub_Agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1..Check for the value of  Mute boolean after and before setting.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_MPSink_SetGetMute_03</test_script>
    <skipped>No</skipped>
