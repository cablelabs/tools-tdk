...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_17</test_case_id>
    <test_objective>RMF_DVRMgr – To get the recording info by using invalid Id</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>Invalid recordingId</pre_requisite>
...
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_DVRManager_GetRecordingInfoById_17</test_script>
    <skipped>No</skipped>
