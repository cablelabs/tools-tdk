...
<xml>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_40</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Calling play call for multiple times on the HNSrc -MPSink pipeline</test_objective>
...
5.Mediaframework agent will call play() twice.
6.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_DoublePlay_40</test_script>
    <skipped>No</skipped>
