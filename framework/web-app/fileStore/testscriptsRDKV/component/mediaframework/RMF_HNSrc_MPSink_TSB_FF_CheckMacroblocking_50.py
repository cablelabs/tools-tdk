...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>RMF_HNSRC_MPSink –After 5 mins of tsb, Do FF from the middle of buffer to the live point. And make sure no freeze while approaching the live point.</test_objective>
...
7. Mediaframework agent will call get speed fetch the speed, which is expected to be 1.0 as it reached the live streaming.
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_TSB_FF_CheckMacroblocking_50</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'RMF_HNSrc_MPSink_TSB_FF_CheckMacroblocking_50');
