...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>These Script tests the RDK Mediaframework to check the DVR content replay . Test Case ID: CT_RMF_HNSrc_MPSink_37.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_37</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Restart  the dvr content   on the HNSrc -MPSink pipeline</test_objective>
...
8.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_DVRReplay_37</test_script>
    <skipped>No</skipped>
