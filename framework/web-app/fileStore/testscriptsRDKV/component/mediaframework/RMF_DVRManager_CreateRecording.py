...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>567</id>
  <version>1</version>
  <name>RMF_DVRManager_CreateRecording</name>
  <primitive_test_id>444</primitive_test_id>
  <primitive_test_name>RMF_DVRManager_CreateRecording</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This tests the create recording functionality of DVR manager class.
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_12</test_case_id>
    <test_objective>RMF_DVRMgr –  To createRecording</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance()
createRecording</api_or_interface_used>
    <input_parameters>setRecordingId: long long recordingId setProperties: char *recordingTitle setStartTime: long long recordContentStart setDuration: long long recordDuration  addLocator: char* qamLocator  createRecording:RecordingSpec</input_parameters>
...
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_DVRManager_CreateRecording</test_script>
    <skipped>No</skipped>
