...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>892</id>
  <version>1</version>
  <name>RMF_HNSrc_MPSink_Rewind&amp;CheckSpeed_16</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework to check media time by REW  the pipeline . Test Case ID: CT_RMF_HNSrc_MPSink_16.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_16</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Rewind the tsb and check whether speed value should not change  on the HNSrc -MPSink pipeline</test_objective>
...
8.Should not be any change in the media time through out rewind.
...
10.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_Rewind&amp;CheckSpeed_16</test_script>
    <skipped>No</skipped>
