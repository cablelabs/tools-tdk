...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1638</id>
  <version>10</version>
  <name>RMF_HNSrc_MPSink_DVR_FF_RW_CheckMacroblocking_42</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: RMF_HNSRC_MPSink –  Do FW RW on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.
Test caseID: CT_RMF_HNSRC_MPSink_42
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_42</test_case_id>
    <test_objective>RMF_HNSRC_MPSink – 
Do FW RW on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.</test_objective>
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_FF_RW_CheckMacroblocking_42</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'RMF_HNSrc_MPSink_DVR_FF_RW_CheckMacroblocking_42');
