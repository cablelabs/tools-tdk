...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>853</id>
  <version>1</version>
  <name>RMF_DVRSrc_Open_12</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This script tests the RDK Mediaframework DVRSrc element to call Open API by passing invalid url as input to its parameters and Close a DVRsource element.
...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_12</test_case_id>
    <test_objective>RMF_DVRSrc  – To call Open API by passing invalid url as input to its url parameter and Close a DVRsource element.</test_objective>
...
Checkpoint 2. Check the return value of open API  “RMF_RESULT_INVALID_ARGUMENT” for success.</except_output>
    ...
    <test_script>RMF_DVRSrc_Open_12</test_script>
    <skipped>No</skipped>
