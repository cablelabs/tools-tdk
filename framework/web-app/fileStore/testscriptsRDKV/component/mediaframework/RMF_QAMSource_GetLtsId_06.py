...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1126</id>
  <version>3</version>
  <name>RMF_QAMSource_GetLtsId_06</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RMF_QAMSrc – To Get List of sourceIds corresponding to the instance when factory method flag is set to true.
Test Case ID: CT_RMF_QAMSrc_MPSink_06.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_MPSink_06</test_case_id>
    <test_objective>RMF_QAMSrc – To Get List of sourceIds corresponding to the instance when factory method flag is set to true.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>monitorRMF.sh
RmfStreamer
Process should be stopped before runing the script.</pre_requisite>
    <api_or_interface_used>rmf_Error init RMFResult RMFQAMSrc::init_platform()                  RMFQAMSrc::disableCaching();                       RMFQAMSrc* RMFQAMSrc::getQAMSourceInstance()           RMFResult getLTSID()     void RMFQAMSrc::freeQAMSourceInstance()           RMFResult RMFQAMSrc::uninit_platform()              rmf_Error uninit()</api_or_interface_used>
    <input_parameters>rmf_platform Init(): int- argc, char * argv[]            RMFQAMSrc::init_platform() : None                       RMFQAMSrc::disableCaching() : None                                         RMFQAMSrc::getQAMSourceInstance(): char* uri                         RMFResult getLTSID: unint32_t LtsID   RMFQAMSrc::freeQAMSourceInstance(): RMFQAMSrc* uri RMFQAMSrc::uninit_platform() : None                                rmf_platform Uninit(): None</input_parameters>
...
6.On success, Mediaframework agent will call getLTSID()() to get LSTS Id corresponding to this instance.
...
10.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSource_GetLtsId_06</test_script>
    <skipped>No</skipped>
