...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>889</id>
  <version>1</version>
  <name>RMF_HNSrc_MPSink_Pause&amp;CheckMediaTime_15</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework to check media time by pausing the pipeline . Test Case ID: CT_RMF_HNSrc_MPSink_15.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_15</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –To check the play position during the time of pause on the HNSrc -MPSink pipeline</test_objective>
...
7.Mediaframework agent will pause the pipeline and get the media time value from the pipeline.
8.Should not be any change in the media time.
...
10.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_Pause&amp;CheckMediaTime_15</test_script>
    <skipped>No</skipped>
