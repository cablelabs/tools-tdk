...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>863</id>
  <version>1</version>
  <name>RMF_HNSrcMPSink_InvalidSpeed_09</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework to FF the video with positive big numbers in HNSrc MPSink pipeline. Test Case ID: CT_RMF_HNSrc_MPSink_09.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSrc_MPSink_09</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –To set the speed to big numbers on the HNSrc -MPSink pipeline</test_objective>
...
6.Mediaframework agent will set speed with big number,Set speed should be set and expecting failure from SetSpeed().
...
2.Check the failure return for setspeed()</except_output>
    ...
    <test_script>RMF_HNSrcMPSink_InvalidSpeed_09</test_script>
    <skipped>No</skipped>
