...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>This script tests the RDK Mediaframework DVRSrc element to play with speed and time parameter a DVRSource element without MPSink Element.
...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_04</test_case_id>
    <test_objective>RMF_DVRSrc  – To play with speed and time parameter a DVRSource element without MPSink Element.</test_objective>
...
4. Mediaframework agent will call play with parameters speed and time passed, of DVRSrc element without MPSink element set as sink element. And DVRSrc play fails returning “RMF_RESULT_NO_SINK” value.
...
Checkpoint 2.Check the return value “RMF_RESULT_NO_SINK” for play API for success status.</except_output>
    ...
    <test_script>RMF_DVRSrc_Play_04</test_script>
    <skipped>No</skipped>
