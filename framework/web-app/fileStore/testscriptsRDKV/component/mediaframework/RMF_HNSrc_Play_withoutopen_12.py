...
Test Case ID: CT_RMF_HNSource_12.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSource_12</test_case_id>
    <test_objective>RMF_HNSrc – initiate the play call without calling open call</test_objective>
...
3.mediaframework agent will play the  Hnsrc element
...
5..For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_Play_withoutopen_12</test_script>
    <skipped>No</skipped>
