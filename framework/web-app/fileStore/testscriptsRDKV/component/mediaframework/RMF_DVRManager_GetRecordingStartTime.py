...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_08</test_case_id>
    <test_objective>RMF_DVRMgr –  Get the start time of the record</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>valid recordingId</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance()
getRecordingStartTime</api_or_interface_used>
...
2.TM will invoke “TestMgr_ getRecordingStartTime” with recordingId as a parameter in RMFStub_agent.
3.RMFStub_agent will call getinstance of Dvr Manager 
4.Call the methods  getRecordingStartTime 
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status. Checkpoint 2.Check the return value of the recording start time and compare against the actual value.</except_output>
    <priority>High</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_DVRManager_GetRecordingStartTime</test_script>
    <skipped>No</skipped>
