...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_49</test_case_id>
    <test_objective>RMF_HNSRC_MPSink – 
Do Skip back and front on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.</test_objective>
...
6. Mediaframework agent will call setMediaTime() to skip back and front.
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_SB_SF_CheckMacroblocking_49</test_script>
    <skipped>No</skipped>
