...
Test Case ID: CT_RMF_QAMSrc_MPSink_13.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_MPSink_13</test_case_id>
    <test_objective>RMF_QAMSrc – To Pause the live content when factory method flag is set to true.</test_objective>
...
RMFQAMSrc play
RMFQAMSrc pause
RMFStateChangeReturn RMFQAMSrc::freeQAMSourceInstance()           RMFResult RMFQAMSrc::uninit_platform()              rmf_Error uninit()</api_or_interface_used>
...
11.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSource_Pause_13</test_script>
    <skipped>No</skipped>
