...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>856</id>
  <version>10</version>
  <name>RMF_DVRSrc_Open_15</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests the RDK Mediaframework DVRSrc element to call Open API with valid url being framed with segmentName and Close a DVRsource element.
...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_15</test_case_id>
    <test_objective>RMF_DVRSrc  – To call Open API with valid url being framed with segmentName and Close a DVRsource element.</test_objective>
...
open():char*-dvr locator(validurl with segmentname ),char*- mimetype(NULL)
close():None 
...
6. For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_DVRSrc_Open_15</test_script>
    <skipped>No</skipped>
