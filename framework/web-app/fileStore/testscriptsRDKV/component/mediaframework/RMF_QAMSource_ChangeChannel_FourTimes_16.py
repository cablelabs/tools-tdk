...
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_MPSink_16</test_case_id>
    <test_objective>RMFQAMSrc –  Tune to a  channel, and change the channel after play back for sometime, and change channel for 4 more times. So, all 5 tunners are cached.  When factory method flag is set to true.</test_objective>
...
Checkpoint 2. Search the log of the API() calls to see “SPTS Read Timeout Error” as occured or not.</except_output>
    ...
    <test_script>RMF_QAMSource_ChangeChannel_FourTimes_16</test_script>
    <skipped>No</skipped>
