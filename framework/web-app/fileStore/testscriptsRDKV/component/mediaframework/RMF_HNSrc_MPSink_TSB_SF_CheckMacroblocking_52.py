...
Test CaseID: CT_RMF_HNSRC_MPSink_52</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_52</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –After 5 mins of tsb, Skip front 50 sec three times from the middle of buffer and play till  live point. And make sure no freeze while approaching the live point also during the trickplay.</test_objective>
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_TSB_SF_CheckMacroblocking_52</test_script>
    <skipped>No</skipped>
