...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>933</id>
  <version>9</version>
  <name>RMF_HNSrc_MPSink_GetState_25</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>These Script tests the RDK Mediaframework to get state while playing on live content . Test Case ID: CT_RMF_HNSrc_MPSink_25.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_25</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Check the pause state after pausing the HNSrc -MPSink pipeline</test_objective>
...
6.Mediaframework agent will get the state of the pipeline.
...
8.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_GetState_25</test_script>
    <skipped>No</skipped>
