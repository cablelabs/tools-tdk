...
<xml>
  ...
  <name>RMF_DVRSrcMPSink_SkipNumOfSeconds_SkipFront_07</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This script tests the RDK Mediaframework DVRSrc element to skip specified number of seconds front from the current point of play.
