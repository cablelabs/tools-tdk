...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_17</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –To flush the live buffer by tunning in to different channel and check whether live buffer is flushed out on the HNSrc -MPSink pipeline</test_objective>
...
7.Mediaframework agent will play with different ocap id.
8.Mediaframework agent get the media time.
...
10.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_BufferClearing_17</test_script>
    <skipped>No</skipped>
