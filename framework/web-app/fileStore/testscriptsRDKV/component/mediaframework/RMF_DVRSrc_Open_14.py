...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>This script tests the RDK Mediaframework DVRSrc element to call Open API by passing valid url but invalid segmentNumber as input to its url parameter and Close a DVRsource element.
...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_14</test_case_id>
    <test_objective>RMF_DVRSrc  – To call Open API by passing valid url but invalid segmentNumber as input to its url parameter and Close a DVRsource element.</test_objective>
...
Checkpoint 2. Check the return value of open API  “RMF_RESULT_INVALID_ARGUMENT” for success.</except_output>
    ...
    <test_script>RMF_DVRSrc_Open_14</test_script>
    <skipped>No</skipped>
