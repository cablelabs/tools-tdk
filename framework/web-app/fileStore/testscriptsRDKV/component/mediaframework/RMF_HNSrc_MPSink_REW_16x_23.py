...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_23</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Rewind the tsb with 16x  on the HNSrc -MPSink pipeline</test_objective>
...
9.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_REW_16x_23</test_script>
    <skipped>No</skipped>
