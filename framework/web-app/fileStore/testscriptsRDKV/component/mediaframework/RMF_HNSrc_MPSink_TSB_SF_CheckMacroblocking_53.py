...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1652</id>
  <version>3</version>
  <name>RMF_HNSrc_MPSink_TSB_SF_CheckMacroblocking_53</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: RMF_HNSRC_MPSink –After 5 mins of tsb, Skip front 50 sec three times from the middle of buffer and play till  live point and also skip back 50 sec.
Test CaseID: CT_RMF_HNSRC_MPSink_53</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_53</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –After 5 mins of tsb, Skip front 50 sec three times from the middle of buffer and play till  live point and also skip back 50 sec. And make sure no freeze while approaching the live point and also during the trickplay.</test_objective>
...
6.Mediaframework agent will call setMediaTime to skip 50 sec three times, play untill it reaches live streaming and get the media time of the pipeline.
7. Mediaframework agent will call setMediaTime to skip back 50 sec and get media time.
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_TSB_SF_CheckMacroblocking_53</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'RMF_HNSrc_MPSink_TSB_SF_CheckMacroblocking_53');
