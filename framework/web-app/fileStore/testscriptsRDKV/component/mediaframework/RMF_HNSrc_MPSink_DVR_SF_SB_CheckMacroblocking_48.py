...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1645</id>
  <version>7</version>
  <name>RMF_HNSrc_MPSink_DVR_SF_SB_CheckMacroblocking_48</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: RMF_HNSRC_MPSink –  Do Skip front and back on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.
Test CaseID: CT_RMF_HNSRC_MPSink_48
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_48</test_case_id>
    <test_objective>RMF_HNSRC_MPSink – 
Do Skip front and back on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.</test_objective>
...
6. Mediaframework agent will call setMediaTime() to skip front and back.
7.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_SF_SB_CheckMacroblocking_48</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'RMF_HNSrc_MPSink_DVR_SF_SB_CheckMacroblocking_48');
