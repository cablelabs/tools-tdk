...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>878</id>
  <version>6</version>
  <name>RMF_HNSrc_MPSink_DVR_REW_16x_35</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>These Script tests the RDK Mediaframework to rewind with 16x speed on dvr content . Test Case ID: CT_RMF_HNSrc_MPSink_35.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_35</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Rewind  the dvr content  with 16x  on the HNSrc -MPSink pipeline</test_objective>
...
9.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_REW_16x_35</test_script>
    <skipped>No</skipped>
