...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_44</test_case_id>
    <test_objective>RMF_HNSRC_MPSink – 
Do FW RW  and Skip Front on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.</test_objective>
...
CheckPoint 2. Check the Audio and Video quality using CheckAudioStatus.sh and CheckVideoStatus.sh scripts.</except_output>
    ...
    <test_script>RMF_HNSrc_MPSink_DVR_FF_RW_SF_CheckMacroblocking_44</test_script>
    <skipped>No</skipped>
