...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1164</id>
  <version>1</version>
  <name>RMF_QAMSrc_HNSink_13</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RMF_QAMSrc – To Stream out the live content through HNSink on to the network when factory method flag is set to true but set invalid streamingIp.
...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_HNSink_13</test_case_id>
    <test_objective>RMF_QAMSrc – To Stream out the live content through HNSink on to the network when factory method flag is set to true but set invalid streamingIp.</test_objective>
...
9. On success, Mediaframework agent will call HNSink setHNSinkProperties(), and set invalid streamingIp.
...
18.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_HNSink_13</test_script>
    <skipped>No</skipped>
