...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_HNSink_08</test_case_id>
    <test_objective>RMF_QAMSrc – To Stream out the live content through HNSink on to the network when factory method flag is set to false but set random socketId to hnsink properties..</test_objective>
...
10. On success, Mediaframework agent will call HNSink setHNSinkProperties() and set random number as socketId..
...
20.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_HNSink_08</test_script>
    <skipped>No</skipped>
