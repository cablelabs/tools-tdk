...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_HNSink_07</test_case_id>
    <test_objective>RMF_QAMSrc – To Stream out the live content through HNSink on to the network when factory method flag is set to true but set random socketId to hnsink properties.</test_objective>
...
9. On success, Mediaframework agent will call HNSink setHNSinkProperties(), and set random number as socketId.
