...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>902</id>
  <version>1</version>
  <name>RMF_HNSrc_Open_vodurl_08</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework HNSrc element to set the vod url in to open method of RMF.
Test Case ID: CT_RMF_HNSource_08.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSource_08</test_case_id>
    <test_objective>RMF_HNSrc – Passing vod url in to HNSource open method</test_objective>
...
3.mediaframework agent will open the  Hnsrc element with vod url string for url parameter.
...
5..For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_Open_vodurl_08</test_script>
    <skipped>No</skipped>
