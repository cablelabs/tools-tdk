...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1140</id>
  <version>1</version>
  <name>RMF_QAMSrc_07</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RMFQAMSrc – To get RMFQAMSrc instance from getQAMSourceInstance when valid dvrlocator url is passed to it.
Test Case ID: CT_RMF_QAMSrc_07</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_07</test_case_id>
    <test_objective>RMFQAMSrc – To get RMFQAMSrc instance from getQAMSourceInstance when valid dvrlocator url is passed to it.</test_objective>
...
5.On success, Mediaframework agent will create the instance of QAMSrc by calling factory method RMFQAMSrc getQAMSourceInstance() by passing valid dvrlocator value to its parameter and initialize the QAMSrc element.
...
9.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_07</test_script>
    <skipped>No</skipped>
