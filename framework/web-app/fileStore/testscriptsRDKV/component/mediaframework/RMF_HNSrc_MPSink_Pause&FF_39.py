...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>These Script tests the RDK Mediaframework to check state by pausing &amp; FF the pipeline . Test Case ID: CT_RMF_HNSrc_MPSink_39.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_39</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Do Pause &amp; FF the dvr content   on the HNSrc -MPSink pipeline</test_objective>
...
8.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_Pause&amp;FF_39</test_script>
    <skipped>No</skipped>
