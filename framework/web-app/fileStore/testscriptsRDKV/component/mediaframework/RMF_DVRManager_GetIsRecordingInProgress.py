...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>574</id>
  <version>1</version>
  <name>RMF_DVRManager_GetIsRecordingInProgress</name>
  <primitive_test_id>436</primitive_test_id>
  <primitive_test_name>RMF_DVRManager_GetIsRecordingInProgress</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This tests the recording in progress functionality of DVR Manager class.	
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_05</test_case_id>
    <test_objective>RMF_DVRMgr –To Check whether recording is in progress</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>valid recordingId</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance() isRecordingInProgress()</api_or_interface_used>
    <input_parameters>isRecordingInProgress: long long recordingId</input_parameters>
    <automation_approch>1.TM loads RMFStub_agent via the test agent.
2.TM will invoke “TestMgr_ isRecordingInProgress” with recordingId as a parameter in RMFStub_agent.
3.RMFStub_agent will call getinstance of Dvr Manager 
4.Call the methods  isRecordingInProgress() 
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status. Checkpoint 2.Check the return value of the recordingInProgress status and compare against the actual value.</except_output>
    <priority>High</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_DVRManager_GetIsRecordingInProgress</test_script>
    <skipped>No</skipped>
