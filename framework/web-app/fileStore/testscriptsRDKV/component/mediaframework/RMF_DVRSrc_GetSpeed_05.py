...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_05</test_case_id>
    <test_objective>RMF_DVRSrc  – To get the default speed by getSpeed API of DVRSource element.</test_objective>
...
3. Mediaframework agent will call getSpeed API of DVRSrc element.
4. Then compare the value returned by the API with default speed value for success.
...
Checkpoint 2.Compare the return speed value of getSpeed API with default speed for success status.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_DVRSrc_GetSpeed_05</test_script>
    <skipped>No</skipped>
