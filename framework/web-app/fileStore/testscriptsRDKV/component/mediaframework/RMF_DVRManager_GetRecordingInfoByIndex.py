...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>576</id>
  <version>1</version>
  <name>RMF_DVRManager_GetRecordingInfoByIndex</name>
  <primitive_test_id>434</primitive_test_id>
  <primitive_test_name>RMF_DVRManager_GetRecordingInfoByIndex</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This tests the get recording info by index functionality of DVR Manager class.	
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_03</test_case_id>
    <test_objective>RMF_DVRMgr – To get the recording info by using the index</test_objective>
...
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_DVRManager_GetRecordingInfoByIndex</test_script>
    <skipped>No</skipped>
