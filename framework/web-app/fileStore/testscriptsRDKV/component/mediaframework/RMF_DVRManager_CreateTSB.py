...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>569</id>
  <version>1</version>
  <name>RMF_DVRManager_CreateTSB</name>
  <primitive_test_id>442</primitive_test_id>
  <primitive_test_name>RMF_DVRManager_CreateTSB</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This tests the create TSB functionality of DVR manager class.
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRMgr_10</test_case_id>
    <test_objective>RMF_DVRMgr –  To create TSB</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>DVRManager::getInstance()
CreateTSB</api_or_interface_used>
...
2.TM will invoke “TestMgr_createTSB ” with duration  as a parameter in RMFStub_agent.
3.RMFStub_agent will call getinstance of Dvr Manager 
4.Call the methods  createTSB() and upon success it will return valid tsbId
5.On success of API execution RMFStub_agent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1.Check the return value of API for success status. Checkpoint 2.Check the return value of the tsbId.</except_output>
    <priority>High</priority>
    <test_stub_interface>libmediaframeworkstub.so</test_stub_interface>
    <test_script>RMF_DVRManager_CreateTSB</test_script>
    <skipped>No</skipped>
