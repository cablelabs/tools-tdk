...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>872</id>
  <version>1</version>
  <name>RMF_HNSrc_MPSink_Clearbuffering&amp;CheckMediaTime_18</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework to clear the tsb buffer and check mediatime . Test Case ID: CT_RMF_HNSrc_MPSink_18.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_18</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –Rewind till the start of the tsb and check whether media time going beyond tsb on the HNSrc -MPSink pipeline</test_objective>
...
6.Mediaframework agent will get media time.
7.Mediaframework agent will set speed with negative value and get the media time value from the pipeline.
8.Should notgo beyond the start of tsb value through out rewind.
...
10.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_Clearbuffering&amp;CheckMediaTime_18</test_script>
    <skipped>No</skipped>
