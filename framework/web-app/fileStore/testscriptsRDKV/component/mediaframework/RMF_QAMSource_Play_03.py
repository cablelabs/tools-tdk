...
Test Case ID: CT_RMF_QAMSrc_MPSink_03.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_MPSink_03</test_case_id>
    <test_objective>RMF_QAMSrc – To Play the live content when factory method flag is set to false.</test_objective>
...
8.On success, Mediaframework agent will call close() of  QAMSrc element.
9.On success, Mediaframework agent will call term() and de-initialize the QAMSrc element.
...
12.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSource_Play_03</test_script>
    <skipped>No</skipped>
