...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>857</id>
  <version>1</version>
  <name>RMF_DVRSrc_Open_16</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This script tests the RDK Mediaframework DVRSrc element to  call Open API by passing valid url but invalid segmentName as input to its url parameter and Close a DVRsource element.
...
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_DVRSrc_16</test_case_id>
    <test_objective>RMF_DVRSrc  – To call Open API by passing valid url but invalid segmentName as input to its url parameter and Close a DVRsource element.</test_objective>
...
open():char*-dvr locator(validurl with invalid segmentname ),char*- mimetype(NULL)
close():None 
...
3. Mediaframework agent will open the DVRSrc element with the valid url being framed with segment name (Ex: dvr://local/segment name i.e, dvr://local/1392099596347).
...
Checkpoint 2. Check the return value of open API  “RMF_RESULT_INVALID_ARGUMENT” for success.</except_output>
    ...
    <test_script>RMF_DVRSrc_Open_16</test_script>
    <skipped>No</skipped>
