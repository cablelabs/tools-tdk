...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>RMFQAMSrc – To get and free low level element of qamsrc obtained using getQAMSrcElement when factory method flag is set to false.
Test caseId: CT_RMF_QAMSrc_06.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_06</test_case_id>
    <test_objective>RMFQAMSrc – To get and free low level element of qamsrc obtained using getQAMSrcElement when factory method flag is set to false.</test_objective>
...
RMFResult open()
RMFQAMSrc:: getLowLevelElement()   RMFQAMSrc::freeLowLevelElement()   
RMFResult close()
RMFResult term()  RMFResult RMFQAMSrc::uninit_platform()              rmf_Error uninit()</api_or_interface_used>
...
RMFQAMSrc::getLowLevelElement(): None             RMFQAMSrc::freeLowLevelElement():void* element
...
7.On success, Mediaframework agent will call getLowLevelElement() of  QAMSrc element.
8.On success, Mediaframework agent will call freeLowLevelElement() of  QAMSrc element.
...
13.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_06</test_script>
    <skipped>No</skipped>
