...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>426</id>
  <version>1</version>
  <name>RMF_MPSink_GetMediaTime_05</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework MPSink element to get mediatime
Test Case ID: CT_RMF_MPSink_05.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_MPSink_05</test_case_id>
    <test_objective>RMF_MPSink – To get media time without pipeline</test_objective>
...
getMediaTime: double&amp; -t
term: None</input_parameters>
    <automation_approch>1.TM loads RMFStub_agent via the test agent.
2.TM will invoke “TestMgr_MPSink_getMediaTime” in RMFStub_agent.
3.RMFStub_agent will call init() API of the component and get the result.
4.On the Success of init() API,RMFStub_agent will call getMediaTime() API of the component and get the result.
5.On success of getMediaTime() RMFStub_agent will call term API of the component and get the result.
6.On success of setVideoRectangle RMFStub_agent will call term() API of the component and get the result.
7.RMFStub_Agent will send SUCCESS or FAILURE to TM.</automation_approch>
    ...
    <test_script>RMF_MPSink_GetMediaTime_05</test_script>
    <skipped>No</skipped>
