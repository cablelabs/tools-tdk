...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1136</id>
  <version>1</version>
  <name>RMF_QAMSrc_03</name>
  <primitive_test_id>494</primitive_test_id>
  <primitive_test_name>RMF_Element_Create_Instance</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RMFQAMSrc – To call open() api by passing invalid  url as input to its parameter and close RMFQAMSrc instance when factory method flag is set to false.
Test caseId: CT_RMF_QAMSrc_03</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_QAMSrc_03</test_case_id>
    <test_objective>RMFQAMSrc – To call open() api by passing invalid  url as input to its parameter and close RMFQAMSrc instance when factory method flag is set to false.</test_objective>
...
6.On success, Mediaframework agent will call open() of  QAMSrc element by passing invalid url value as input to its parameter.
...
11.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to TM via the test agent by comparing the return value of APIs.</automation_approch>
    ...
    <test_script>RMF_QAMSrc_03</test_script>
    <skipped>No</skipped>
