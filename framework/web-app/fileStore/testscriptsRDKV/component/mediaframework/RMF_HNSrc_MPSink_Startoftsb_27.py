...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>948</id>
  <version>1</version>
  <name>RMF_HNSrc_MPSink_Startoftsb_27</name>
  <primitive_test_id>495</primitive_test_id>
  <primitive_test_name>RMF_Element_Init</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>These Script tests the RDK Mediaframework to check for start of tsb  in HNSrc MPSink pipeline. Test Case ID: CT_RMF_HNSrc_MPSink_27.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_RMF_HNSRC_MPSink_27</test_case_id>
    <test_objective>RMF_HNSRC_MPSink –After 1 min of tsb play,Replay the content from the beginning on the HNSrc -MPSink pipeline</test_objective>
...
6.Mediaframework agent will set media time as 0.0 and get the mediatime of the pipeline.
...
8.For each API called in the script, mediaframework agent  will send SUCCESS or FAILURE status to Test Agent by comparing the return vale of APIs.</automation_approch>
    ...
    <test_script>RMF_HNSrc_MPSink_Startoftsb_27</test_script>
    <skipped>No</skipped>
...
mediatime_parameter_value=[0,"HNSrc"]
