...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1463</id>
  <version>1</version>
  <name>GstPluginRdk_Aesencrypt_EncryptionEnable_Invalid</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To set the aesencrypt plugin property, "encryption-enable" with 2 (non-boolean value) and should fail to set the value. 
Test CaseID:CT_GST_PLUGINS_RDK_20.
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_20</test_case_id>
    <test_objective>To set the aesencrypt plugin property, "encryption-enable" with 2 (non-boolean value) and should fail to set the value.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Aesencrypt_EncryptionEnable_Invalid</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Aesencrypt_EncryptionEnable_Invalid');
...
#Set the encryption-enable_invalid
#1 = true, 0 = false
value = 2;
