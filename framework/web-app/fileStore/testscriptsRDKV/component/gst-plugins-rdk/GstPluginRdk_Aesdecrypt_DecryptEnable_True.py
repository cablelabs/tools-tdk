...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1450</id>
  <version>1</version>
  <name>GstPluginRdk_Aesdecrypt_DecryptEnable_True</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To set the aesdecrypt plugin property "decryption-enable" to TRUE and verify the value by doing get.
Test CaseID: CT_GST_PLUGINS_RDK_01
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_01</test_case_id>
    <test_objective>To set the aesdecrypt plugin property, "decryption-enable" with true to enable decryption of mpegts data and forwards it.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Aesdecrypt_DecryptEnable_True</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Aesdecrypt_DecryptEnable_True');
