...
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_19</test_case_id>
    <test_objective>To set the aesencrypt plugin property, "encryption-enable" with false to disable encryption of mpegts packets.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Aesencrypt_EncryptionEnable_False</test_script>
    <skipped>No</skipped>
