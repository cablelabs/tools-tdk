...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1475</id>
  <version>1</version>
  <name>GstPluginRdk_Dvrsrc_StartTime_Get_Prop_Default</name>
  <primitive_test_id>624</primitive_test_id>
  <primitive_test_name>Gst_Dvrsrc_StartTime_Get_Prop</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective:To get the default value of dvrsrc plugin  “start-time” property. Default start time should be 0.0.
Test CaseID: CT_GST_PLUGINS_RDK_13.
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_13</test_case_id>
    <test_objective>To get the default value of dvrsrc plugin  “start-time” property. Default start time should be 0.0.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Dvrsrc_StartTime_Get_Prop_Default</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Dvrsrc_StartTime_Get_Prop_Default');
...
tdkTestObj = obj.createTestStep('Gst_Dvrsrc_StartTime_Get_Prop');
