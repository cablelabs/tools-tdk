...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1466</id>
  <version>1</version>
  <name>GstPluginRdk_Dvrsrc_RecordId_Set_Prop</name>
  <primitive_test_id>615</primitive_test_id>
  <primitive_test_name>Gst_Dvrsrc_RecordId_Set_Prop</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective:To set the dvrsrc plugin property, “recording-id” with id of recording in the form of NULL terminated string.
Test CaseID:CT_GST_PLUGINS_RDK_04.
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_04</test_case_id>
    <test_objective>To set the dvrsrc plugin property, “recording-id” with id of recording in the form of NULL terminated string.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Dvrsrc_RecordId_Set_Prop</test_script>
    <skipped>Yes</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Dvrsrc_RecordId_Set_Prop');
...
tdkTestObj = obj.createTestStep('Gst_Dvrsrc_RecordId_Set_Prop');
