...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1477</id>
  <version>1</version>
  <name>GstPluginRdk_Dvrsrc_PlayStartPosition_Set_Prop</name>
  ...
  <status>FREE</status>
  <synopsis>Objective:To set the dvrsrc plugin property, “play-start-position” with mediatime in seconds at which playback should start.
Test CaseID:CT_GST_PLUGINS_RDK_15.
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_15</test_case_id>
    <test_objective>To set the dvrsrc plugin property, “play-start-position” with mediatime in seconds at which playback should start.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Dvrsrc_PlayStartPosition_Set_Prop</test_script>
    <skipped>Yes</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Dvrsrc_PlayStartPosition_Set_Prop');
...
#Set the play Start Position Set Prop play start media time
value = 1.0;
