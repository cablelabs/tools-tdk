...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_02</test_case_id>
    <test_objective>To set the aesdecrypt plugin property, "decryption-enable" with false to disable decryption of mpegts data and forwards it.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Aesdecrypt_DecryptEnable_False</test_script>
    <skipped>No</skipped>
