...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1464</id>
  <version>1</version>
  <name>GstPluginRdk_Aesencrypt_EncryptionEnable_Negative</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To set the aesencrypt plugin property, "encryption-enable" with negative value and should fail to set the value. 
Test CaseID:CT_GST_PLUGINS_RDK_27.
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_27</test_case_id>
    <test_objective>To set the aesencrypt plugin property, "encryption-enable" with negative value and should fail to set the value.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Aesencrypt_EncryptionEnable_Negative</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Aesencrypt_EncryptionEnable_Negative');
...
#Set the encryption-enable_negative
#1 = true, 0 = false
value = -1;
