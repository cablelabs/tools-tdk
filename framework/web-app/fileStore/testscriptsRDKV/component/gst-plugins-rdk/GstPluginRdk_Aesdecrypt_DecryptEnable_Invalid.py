...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1452</id>
  <version>1</version>
  <name>GstPluginRdk_Aesdecrypt_DecryptEnable_Invalid</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To set the aesdecrypt plugin property "decryption-enable" to 2 (not boolean value) and should fail to set the value. 
Test CaseID: CT_GST_PLUGINS_RDK_03
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_03</test_case_id>
    <test_objective>To set the aesdecrypt plugin property, "decryption-enable" with 2 (non-boolean value) and should fail to set the value.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Aesdecrypt_DecryptEnable_Invalid</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Aesdecrypt_DecryptEnable_Invalid');
...
#Set the  DecryptEnable_Invalid
#1 = true, 0 = false
#Invalid value other than boolean
value = 5;
