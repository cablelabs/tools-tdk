...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1482</id>
  <version>1</version>
  <name>GstPluginRdk_Dvrsink_Ccivalue_Get_Prop_Default</name>
  <primitive_test_id>630</primitive_test_id>
  <primitive_test_name>Gst_Dvrsink_Ccivalue_Get_Prop</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective: To get the default value of dvrsink plugin  “ccivalue” property. Default ccivalue should be 0.
Test CaseID:CT_GST_PLUGINS_RDK_23</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_23</test_case_id>
    <test_objective>To get the default value of dvrsink plugin  “ccivalue” property. Default ccivalue should be 0.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Dvrsink_Ccivalue_Get_Prop_Default</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Dvrsink_Ccivalue_Get_Prop_Default');
...
tdkTestObj = obj.createTestStep('Gst_Dvrsink_Ccivalue_Get_Prop');
