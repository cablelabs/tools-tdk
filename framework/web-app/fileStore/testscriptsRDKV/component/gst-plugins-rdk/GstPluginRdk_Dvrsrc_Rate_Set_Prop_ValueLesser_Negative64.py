...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1473</id>
  <version>1</version>
  <name>GstPluginRdk_Dvrsrc_Rate_Set_Prop_ValueLesser_Negative64</name>
  <primitive_test_id>622</primitive_test_id>
  <primitive_test_name>Gst_Dvrsrc_Rate_Set_Prop</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Objective:To set the dvrsrc plugin property, “rate” with value lesser than -64.0.
Test CaseID: CT_GST_PLUGINS_RDK_12.
Test Type: Negative.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_GST_PLUGINS_RDK_12</test_case_id>
    <test_objective>To set the dvrsrc plugin property, “rate” with value lesser than -64.0.</test_objective>
...
5. Then, TM Unloads gstpluginsrdkTest agent.</automation_approch>
    ...
    <test_script>GstPluginRdk_Dvrsrc_Rate_Set_Prop_ValueLesser_Negative64</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'GstPluginRdk_Dvrsrc_Rate_Set_Prop_ValueLesser_Negative64');
...
tdkTestObj = obj.createTestStep('Gst_Dvrsrc_Rate_Set_Prop');

expectedResult = "FAILURE"

#Set the Dvrsrc Rate Set Prop Value lesser than -64.0
value = -70;
