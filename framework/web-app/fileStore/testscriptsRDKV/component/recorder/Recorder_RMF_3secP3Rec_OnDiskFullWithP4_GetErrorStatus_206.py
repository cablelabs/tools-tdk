...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_3secP3Rec_OnDiskFullWithP4_GetErrorStatus_206</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_206</test_case_id>
    <test_objective>If all recordings are P4, notification should include Error=SPACE_FULL for scheduling a new 3 sec P3 recording with status as Failed</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot P3 recording of less than 5 seconds duration and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_3secP3Rec_OnDiskFullWithP4_GetErrorStatus_206</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_3secP3Rec_OnDiskFullWithP4_GetErrorStatus_206');
#Get the result of connection with test component and STB
