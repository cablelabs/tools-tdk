...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_StatusOf_Erased_Recording_After_Reboot_Inline_268</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_268 - To check the status of a recording which is moved to p0 priority after reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_268</test_case_id>
    <test_objective>To check the status of a recording which is moved to p0 priority after reboot using inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a   recording with p4 priority  using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_StatusOf_Erased_Recording_After_Reboot_Inline_268</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_StatusOf_Erased_Recording_After_Reboot_Inline_268');
