...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Update_Deletion_Priority_Cancel_Rec_Legacy_448</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_448</test_case_id>
    <test_objective>Recorder should persist the recording field values after cancelling a legacy recording which was updated to priority P1.</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Update_Deletion_Priority_Cancel_Rec_Legacy_448</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Update_Deletion_Priority_Cancel_Rec_Legacy_448');
