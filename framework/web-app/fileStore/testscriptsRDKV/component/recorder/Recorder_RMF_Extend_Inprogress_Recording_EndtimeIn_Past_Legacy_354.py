...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>Recorder_RMF_Extend_Inprogress_Recording_EndtimeIn_Past_Legacy_354</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_354</test_case_id>
    <test_objective>To extend an inprogress recording with end time in past using legacy</test_objective>
...
3.Schedule a future recording of 5 minutes duration with start time  2 minutes using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Extend_Inprogress_Recording_EndtimeIn_Past_Legacy_354</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Extend_Inprogress_Recording_EndtimeIn_Past_Legacy');
