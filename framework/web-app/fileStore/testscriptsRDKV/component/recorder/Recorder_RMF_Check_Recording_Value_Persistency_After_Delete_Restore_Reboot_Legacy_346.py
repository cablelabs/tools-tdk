...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Restore_Reboot_Legacy_346</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check recording value persistency after moving to priority P0 followed by a priority restore and reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_346</test_case_id>
    <test_objective>To check recording value persistency after moving to priority P0 followed by a priority restore and reboot using legacy</test_objective>
...
3.Schedule a hot P4 recording of 1 minute duration  using legacy
4.Wait for the recording to complete
5. Update the recording priority to P0 and restore to P4
6. Reboot the box Using getRecordings message retrieve the recording details and check the recording values are like expected
...
Checkpoint 2 Recording should not have any undesirable values</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Restore_Reboot_Legacy_346</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Restore_Reboot_Legacy_346');
