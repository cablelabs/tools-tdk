...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Check_P0Rec_Status_OnDiskFull_Legacy_275</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_275</test_case_id>
    <test_objective>Delete P0 Recordings Only When Space is Needed using legacy</test_objective>
...
2.TestMgr_Recorder_PresenceOfRecordingMetaData</test_stub_interface>
    <test_script>Recorder_RMF_Check_P0Rec_Status_OnDiskFull_Legacy_275</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
trmObj.configureTestCase(ip,port,'Recorder_RMF_Check_P0Rec_Status_OnDiskFull_Legacy_275');
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_P0Rec_Status_OnDiskFull_Legacy_275');
#Get the result of connection with test component and STB
