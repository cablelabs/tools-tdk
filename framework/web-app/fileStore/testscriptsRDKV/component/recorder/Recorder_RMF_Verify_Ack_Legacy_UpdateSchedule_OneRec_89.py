...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Verify_Ack_Legacy_UpdateSchedule_OneRec_89</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_89 - Recorder should respond to updateSchedule messages received from RWS by sending an acknowledgement message to RWS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_89</test_case_id>
    <test_objective>Recorder should respond to updateSchedule messages received from RWS by sending an acknowledgement messageÂ to RWS.</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording and send to TDK Recorder Simulator server which uses legacy mechanism to send to Recorder.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_Ack_Legacy_UpdateSchedule_OneRec_89</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_Ack_Legacy_UpdateSchedule_OneRec_89');
