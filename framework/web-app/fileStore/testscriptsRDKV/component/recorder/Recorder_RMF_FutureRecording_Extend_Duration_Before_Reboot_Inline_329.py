...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_FutureRecording_Extend_Duration_Before_Reboot_Inline_329</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Extend a future recording  and after reboot check the recording end time is the extended value</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_329</test_case_id>
    <test_objective>To extend the duration of a future recording before reboot using inline</test_objective>
...
4.Before recording starts extend the duration of recording by 8 minutes using updateSchedule message 
5. Reboot the box and Wait for the recording to complete
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FutureRecording_Extend_Duration_Before_Reboot_Inline_329</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_FutureRecording_Extend_Duration_Before_Reboot_Inline_329');
			...
			print "Retrieve Status Details: %s"%actResponse;
			    ...
			    print "Recording List: %s" %actResponse;
                            ...
                            if 'NOTFOUND' not in recordingData:
                                ...
                                actDurationValue = actDurationValue[0]
				...
				if "INCOMPLETE" in statusValue.upper():
                                	if (int(newDuration) == int(expDurationValue) and actDurationValue > int(duration)):
                                    		tdkTestObj.setResultStatus("SUCCESS");
                                    		print "Using Update Schedule message duration updated for future recording before reboot";
					else:
						tdkTestObj.setResultStatus("FAILURE");
						print "Using Update Schedule message duration NOT updated for future recording before reboot";
                                else:
                                    	tdkTestObj.setResultStatus("FAILURE");
