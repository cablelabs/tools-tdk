...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>Recorder_RMF_Inprogress_Recording_Extend_Duration_Before_Reboot_Inline_327</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Extend an inprogress recording and after reboot check the recording end time is the extended value</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_327</test_case_id>
    <test_objective>To extend the duration of an inprogress recording before reboot using inline</test_objective>
...
4.Extend the duration of  recording by 8 minutes using legacy updateSchedule message 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Recording_Extend_Duration_Before_Reboot_Inline_327</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Recording_Extend_Duration_Before_Reboot_Inline_327');
		...
		print "Retrieve Status Details: %s"%actResponse;
			...
			print "Retrieve Status Details: %s"%actResponse;
                        if 'acknowledgement' in actResponse:
                            tdkTestObj.setResultStatus("SUCCESS");
                            print "Successfully retrieved acknowledgement from recorder";
			    print "Wait for recording to complete partially"
			    sleep(10)
                            #Reboot the box
                            recObj.initiateReboot();
				...
				if "INCOMPLETE" in statusValue.upper():
                                	if (int(newDuration) == int(expDurationValue) and actDurationValue > int(duration)):
                                    		tdkTestObj.setResultStatus("SUCCESS");
                                    		print "Using Update Schedule message duration updated for Inprogress recording before reboot";
					else:
						tdkTestObj.setResultStatus("FAILURE");
						print "Using Update Schedule message duration NOT updated for Inprogress recording before reboot";
                                else:
                                    	tdkTestObj.setResultStatus("FAILURE");
