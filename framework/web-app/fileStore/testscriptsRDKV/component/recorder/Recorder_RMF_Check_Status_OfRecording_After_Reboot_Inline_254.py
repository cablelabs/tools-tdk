...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Check_Status_OfRecording_After_Reboot_Inline_254</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_254 - Verify the status of a completed recording after rebooting the box</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_254</test_case_id>
    <test_objective>Schedule a recording using inline and verify it is getting completed successfully and reboot the box and verify the recording status as complete</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to Schedule a recording
...
7.Reboot the box and repeat steps 3 to 6</automation_approch>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Status_OfRecording_After_Reboot_Inline_254</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Status_OfRecording_After_Reboot_Inline_254');
