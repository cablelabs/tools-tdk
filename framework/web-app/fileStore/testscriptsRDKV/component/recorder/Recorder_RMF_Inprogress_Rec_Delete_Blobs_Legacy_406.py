...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inprogress_Rec_Delete_Blobs_Legacy_406</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_406</test_case_id>
    <test_objective>Recording should continue without any issues after corrupting it's blobs using legacy</test_objective>
...
5. Delete the blobs of the recording (Do NOT delete backup file)
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Rec_Delete_Blobs_Legacy_406</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Rec_Delete_Blobs_Legacy_406');
