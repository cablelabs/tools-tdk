			...
			print "Retrieve Status Details: %s"%actResponse;
				...
				if "COMPLETE" in statusValue.upper():
                                	if (int(newDuration) == int(expDurationValue) and difference_duration < 10000):
                                    		tdkTestObj.setResultStatus("SUCCESS");
                                    		print "Using Update Schedule message duration updated for future recording as expected";
					else:
						tdkTestObj.setResultStatus("FAILURE");
						print "Using Update Schedule message duration NOT updated for future recording";
                                else:
                                    	tdkTestObj.setResultStatus("FAILURE");
