...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_207</test_case_id>
    <test_objective>Check that recording interrupted by set top reboot and becomes corrupted and lost, 
recorder resumes recording what’s left and report as POWER_INTERRUPTION. It should not be reported as ORPHANED.</test_objective>
...
10.Check the status of the recording, it should be INCOMPLETE and error should be set to STARTED_LATE.
...
2.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Rec_NotOrphaned_PowerInterrupt_Legacy_207</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
