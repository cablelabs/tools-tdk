...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_TRM_Cancel_CurrentRec_Same_OcapId_52</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_52</test_case_id>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule two current recordings for the same ocap ID as inline message and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_TRM_Cancel_CurrentRec_Same_OcapId_52</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_TRM_Cancel_CurrentRec_Same_OcapId_52');
