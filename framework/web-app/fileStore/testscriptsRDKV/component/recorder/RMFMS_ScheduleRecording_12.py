...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>986</id>
  <version>2</version>
  <name>RMFMS_ScheduleRecording_12</name>
  <primitive_test_id>540</primitive_test_id>
  <primitive_test_name>Recorder_ScheduleRecording</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test is to check scheduling current recording.
Test Case Id: CT_Recorder_01</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_1</test_case_id>
    <test_objective>Recorder-To check scheduling current recording.</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>RMFMS_ScheduleRecording_12</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
