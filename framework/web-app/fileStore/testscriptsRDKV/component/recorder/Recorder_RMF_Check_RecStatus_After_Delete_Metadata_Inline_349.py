...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_RecStatus_After_Delete_Metadata_Inline_349</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_349</test_case_id>
    <test_objective>Recording details should be there after deleting metadata unless there is a reboot happened in the box using inline</test_objective>
...
3.Schedule a hot recording of 2 minute duration  using inline
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_RecStatus_After_Delete_Metadata_Inline_349</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_RecStatus_After_Delete_Metadata_Inline_349');
