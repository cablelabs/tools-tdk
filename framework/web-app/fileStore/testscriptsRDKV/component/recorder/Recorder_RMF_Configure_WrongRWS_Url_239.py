...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_239</test_case_id>
    <test_objective>To check whether recorder sends error or not for  the loss of connection with RWS Server</test_objective>
...
3.Configure alternate URL for the RWS server
4. Wait for 1 minute for the error code RDK-10028 to come after multiple retries
5.. Verify that error code is available in ocapri log
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_Configure_WrongRWS_Url_239</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
