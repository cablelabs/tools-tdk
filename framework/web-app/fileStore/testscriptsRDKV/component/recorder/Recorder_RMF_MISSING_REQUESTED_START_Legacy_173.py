...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_MISSING_REQUESTED_START_Legacy_173</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_173</test_case_id>
    <test_objective>Recorder must send Error=MISSING_REQUESTED_START when requestedStart is not sent in JSON request</test_objective>
...
3.Frame the legacy json message without requestedStart in it through RecorderAgent/Python lib interface to schedule the 
...
Checkpoint 2 : Get the response from recorder in full sync and verify that status has been set to failed and error to MISSING_REQUESTED_START.</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_MISSING_REQUESTED_START_Legacy_173</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_MISSING_REQUESTED_START_Legacy_173');
