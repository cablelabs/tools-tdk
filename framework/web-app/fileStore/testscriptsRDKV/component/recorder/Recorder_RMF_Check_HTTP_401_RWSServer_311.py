...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_311</test_case_id>
    <test_objective>RWS server should send HTTP 401 when the server is enabled with HTTP 401 error and also after retry recorder should send error code RDK-10028</test_objective>
...
2. Configure RWS server with error 401
...
6.Clear the RWS server error 401
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_401_RWSServer_311</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
