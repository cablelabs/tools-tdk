...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_335</test_case_id>
    <test_objective>To update duration of a future recording upon receiving updateRecordings message using inline</test_objective>
...
3.Schedule a future recording of 1 minute duration with start time 1 minute using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_UpdateDuration_FutureRecording_Inline_335</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
