...
<xml>
  ...
  <name>Recorder_RMF_Inprogress_Recording_Extend_Invalid_Ocap_Inline_433</name>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_433</test_case_id>
    <test_objective>Recording using inline should not get interrupted when it is extended with invalid ocap id</test_objective>
...
2.Schedule a hot recording of two minute duration using  inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Recording_Extend_Invalid_Ocap_Inline_433</test_script>
    <skipped>No</skipped>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Recording_Extend_Invalid_Ocap_Inline_433');
