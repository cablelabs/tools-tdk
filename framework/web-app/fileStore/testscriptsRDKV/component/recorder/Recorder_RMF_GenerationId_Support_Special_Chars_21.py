...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_21</test_case_id>
    <test_objective>Recorder- To verify  Generation ID containing special characters is supported</test_objective>
...
3.RecorderAgent/Python lib interface will frame the json message to Simulate a longpoll notification with an inline "noUpdate" payload containing 
  "generationId": "Aa&amp;amp;&amp;quot;'&gt; &lt;-`~!@#$%^&amp;*(){}[]\|;:,.?/Zz"  and send to TDK Recorder Simulator server which is present in TM.
...
6.STB (Recorder) makes a GET request to RWS bearing HTTP header X-Parker-Generation-ID: "Aa&amp;amp;&amp;quot;'&gt; &lt;-`~!@#$%^&amp;*(){}[]\|;:,.?/Zz" (CP).
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_GenerationId_Support_Special_Chars_21</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
