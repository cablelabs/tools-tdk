...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_FutureRecording_Extend_Duration_After_Reboot_Legacy_332</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_332</test_case_id>
    <test_objective>To extend the duration of a future recording after reboot using legacy</test_objective>
...
3.Schedule a a future recording of 11 minutes duration with start time 1 minute using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FutureRecording_Extend_Duration_After_Reboot_Legacy_332</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_FutureRecording_Extend_Duration_After_Reboot_Legacy_332');
