...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_FullSchedule_Cancel_InComplete_Rec_Legacy_456</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_456</test_case_id>
    <test_objective>Recorder should not change the status when cancelling a legacy INCOMPLETE recording with fullSchedule as true</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FullSchedule_Cancel_InComplete_Rec_Legacy_456</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_FullSchedule_Cancel_InComplete_Rec_Legacy_456');
