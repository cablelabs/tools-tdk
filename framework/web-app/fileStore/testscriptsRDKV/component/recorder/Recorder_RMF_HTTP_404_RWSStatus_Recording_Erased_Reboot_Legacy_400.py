...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HTTP_404_RWSStatus_Recording_Erased_Reboot_Legacy_400</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_400</test_case_id>
    <test_objective>After reboot check whether the Erased recording details using legacy are getting synced with RWS  or not when the server is up after reconnecting</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Recording_Erased_Reboot_Legacy_400</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Recording_Erased_Reboot_Legacy_400');
