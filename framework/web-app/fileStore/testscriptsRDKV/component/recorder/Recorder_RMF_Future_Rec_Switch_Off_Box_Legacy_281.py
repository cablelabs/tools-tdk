...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <test_objective>Recorder should sent erased status for a recording where the  box is in off state for the whole duration of that recording using legacy</test_objective>
