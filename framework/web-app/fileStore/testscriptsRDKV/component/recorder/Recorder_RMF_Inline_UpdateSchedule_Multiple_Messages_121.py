...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_UpdateSchedule_Multiple_Messages_121</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_121 - Recorder should handle updateSchedule with multiple messages via inline</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_121</test_case_id>
    <test_objective>Recorder should handle updateSchedule with multiple messages via inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame multiple updateSchedule json message to schedule the current recording and send to TDK Recorder Simulator server which uses inline mechanism to send to Recorder.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_UpdateSchedule_Multiple_Messages_121</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_UpdateSchedule_Multiple_Messages_121');
		...
		if 'acknowledgement' not in actResponse:
		    ...
		    tdkTestObj1 = recObj.createTestStep('Recorder_SendRequest');
                    ...
                    if 'NOTFOUND' not in recordingData or 'NOTFOUND' not in secondRecordingData or 'NOTFOUND' not in thirdRecordingData:
                        ...
                        if "COMPLETE" in value.upper() and "COMPLETE" in secondRecValue.upper() and "COMPLETE" in thirdRecValue.upper():
