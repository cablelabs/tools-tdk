...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>988</id>
  <version>3</version>
  <name>RMFMS_Schedule_Big_Recording_14</name>
  <primitive_test_id>540</primitive_test_id>
  <primitive_test_name>Recorder_ScheduleRecording</primitive_test_name>
  <primitive_test_version>0</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test is to check scheduling current recording for many hours.
Test Case Id: CT_Recorder_03</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_3</test_case_id>
    <test_objective>Recorder-To check scheduling a big recording.</test_objective>
...
6.RecorderAgent gets the duration info present in ocapri logs to verify big recording scheduled.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>RMFMS_Schedule_Big_Recording_14</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
