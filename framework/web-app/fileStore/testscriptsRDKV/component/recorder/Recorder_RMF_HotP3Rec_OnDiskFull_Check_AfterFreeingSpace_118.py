...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HotP3Rec_OnDiskFull_Check_AfterFreeingSpace_118</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that additional segment is created for new hot P3 recording after manually deleting old P4 recording before scheduled end time</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_118</test_case_id>
    <test_objective>Verify that additional segment is created for new hot P3 recording after manually deleting old P4 recording before scheduled end time</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot P3 recording for 1 min and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HotP3Rec_OnDiskFull_Check_AfterFreeingSpace_118</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HotP3Rec_OnDiskFull_Check_AfterFreeingSpace_118');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	loadmoduledetails = recObj.getLoadModuleDetails();
        ...
        if 'getRecordings' in serverResponse:
                ...
                print "Wait 60 seconds to get response from the recorder"
                sleep(60)
                ...
                if ("NOSTATUS" != status):
                        ...
                        if "0" != recIdExist:
                                ...
                                #Frame json message
                                jsonMsgNew = "{\"updateSchedule\":{\"requestId\":\""+requestID+"\",\"generationId\":\"0\",\"fullSchedule\":false,\"dvrProtocolVersion\":\"7\",\"schedule\":[{\"recordingId\":\""+recordingID+"\",\"locator\":[\"ocap://"+ocapId+"\"],\"epoch\":"+now+",\"start\":"+startTime+",\"duration\":"+duration+",\"properties\":{\"requestedStart\":0,\"title\":\"Recording_"+recordingID+"\"},\"bitRate\":\"HIGH_BIT_RATE\",\"deletePriority\":\"P3\"}]}}";
