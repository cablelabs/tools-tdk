...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_3secP4Rec_OnDiskFullWithP4_GetErrorStatus_204</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>If all recordings are P4, notification should include Error=SPACE_FULL for scheduling a new 3 sec P4 recording with status as Failed</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_204</test_case_id>
    <test_objective>If all recordings are P4, notification should include Error=SPACE_FULL for scheduling a new 3 sec P4 recording with status as Failed</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot P4 recording of less than 5 seconds duration and send to TDK Recorder Simulator server which is present in TM.
4. Status of the Json response from Recorder to TDK Recorder Simulator server getting extracted by TM (before 10 seconds)
5. Expected status=Failed, error=SPACE_FULL
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_3secP4Rec_OnDiskFullWithP4_GetErrorStatus_204</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
trmObj.configureTestCase(ip,port,'Recorder_RMF_3secP4Rec_OnDiskFullWithP4_GetErrorStatus_204');
...
recObj.configureTestCase(ip,port,'Recorder_RMF_3secP4Rec_OnDiskFullWithP4_GetErrorStatus_204');
#Get the result of connection with test component and STB
