...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_CancelRecording_Future_RecId_36</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_36 - Recorder-Not to send error as USER_STOP if a future recording is cancelled via inline</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_36</test_case_id>
    <test_objective>Recorder-Not to send error as USER_STOP if a future recording is cancelled via inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the future recording with generation id = 0 and send to TDK Recorder Simulator server which is present in TM.
4. Schedule another recording to cancel the recording which in progress.
5. STB will be rebooted after a sleep of recording duration vial inline mechanism.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>/Recorder_RMF_Inline_CancelRecording_Future_RecId_36</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_CancelRecording_Future_RecId_36');
