...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Trm_Cancel_MaxTuners_Same_OcapId_192</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_192 - Recorder to send TRM_CANCELLED error if recording is scheduled for the max number of tuners available with different ocap id and then again scheduling one more recording with same ocap id used already</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_192</test_case_id>
    <test_objective>Recorder to send TRM_CANCELLED error if recording is scheduled for the max number of tuners available with different ocap id and then again scheduling one more recording with same ocap id used already</test_objective>
...
4.Again schedule one more recording with same ocap id which is already in use
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Trm_Cancel_MaxTuners_Same_OcapId_192</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Trm_Cancel_MaxTuners_Same_OcapId_192');
...
trmObj.configureTestCase(ip,port,'Recorder_RMF_Trm_Cancel_MaxTuners_Same_OcapId_192');
#Get the result of connection with test component and STB
