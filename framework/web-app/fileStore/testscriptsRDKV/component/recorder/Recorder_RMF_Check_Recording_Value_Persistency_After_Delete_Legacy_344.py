...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Legacy_344</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check recordings value persistency after moving to P0 priority</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_344</test_case_id>
    <test_objective>To check recordings value persistency after moving to P0 priority using legacy</test_objective>
...
5. Update the recording priority to P0
6. Using getRecordings message retrieve the recording details and check the recording values are like expected
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Legacy_344</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Legacy_344');
                    ...
                    if expResponse in actResponse:
                        ...
                        if 'acknowledgement' not in actResponse:
                            ...
                            if 'NOTFOUND' not in recordingData:
                                ...
                                reqRecording = {"recordingId":recordingID,"duration":60000,"deletePriority":"P0"}
