...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Cancel2HrsFutureP4Rec_OnDiskFull_CheckDeletedDur_218</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Schedule a new future P4 recording for 2 hrs and cancel after 5 mins of recordings. Check that an existing P3 recording of duration not more than 10 min duration is deleted and not big P3 recording</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_218</test_case_id>
    <test_objective>Schedule a new future P4 recording for 2 hrs and cancel after 5 mins of recordings. Check that an existing P3 recording of duration not more than 10 min duration is deleted and not big P3 recording</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a future P4 recording of 2hrs duration using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Cancel2HrsFutureP4Rec_OnDiskFull_CheckDeletedDur_218</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
trmObj.configureTestCase(ip,port,'Recorder_RMF_Cancel2HrsFutureP4Rec_OnDiskFull_CheckDeletedDur_218');
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Cancel2HrsFutureP4Rec_OnDiskFull_CheckDeletedDur_218');
#Get the result of connection with test component and STB
