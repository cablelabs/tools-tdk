...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Extend_Recording_With_RequestedStart_Inline_375</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_375</test_case_id>
    <test_objective>To extend a recording which has value in requestedStart using inline</test_objective>
...
3.Schedule a hot recording with RequestedStart and start time values using inline
4. Extend the recording when it is in progress
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Extend_Recording_With_RequestedStart_Inline_375</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Extend_Recording_With_RequestedStart_Inline_375');
