...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Change_SourceID_In_Update_Schedule_Legacy_247</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_247 - Recorder- Source ID change for a recording in the schedule update should reflect in the box.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_247</test_case_id>
    <test_objective>To check whether Source ID change for a recording in the schedule update is getting reflected or not using legacy</test_objective>
...
3.Send a future schedule for two recordings with same start time and with same source id.
4.Immediately after that using update schedule msg with fullschedule as false send a different but valid source id change for one of the recordings. 
5.Both recordings should record successfully.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Change_SourceID_In_Update_Schedule_Legacy_247</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Change_SourceID_In_Update_Schedule_Legacy_247');
