...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Legacy_368</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should send the full sync details for a reboot if the last full sync was suppressed with server connection issue</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_368</test_case_id>
    <test_objective>Recorder should send the full sync details for the next reboot if the last full sync was suppressed with server connection issue using legacy</test_objective>
...
3.Schedule a hot recording using legacy and wait for the recording to complete
...
6. Schedule a hot recording using legacy with bad ocap and wait for the connection fall back in RWS status server then check RDK-10028 error code. 
...
9.Reboot the box and check whether reocrder is sending full sync details or not
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Legacy_368</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Legacy_368');
...
obj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Legacy_368');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	loadmoduledetails = recObj.getLoadModuleDetails();
        ...
        #Wait for getting the error code
