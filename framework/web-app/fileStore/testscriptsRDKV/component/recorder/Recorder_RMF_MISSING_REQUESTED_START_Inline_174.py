...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_174</test_case_id>
...
3.Frame the inline json message without requestedStart in it through RecorderAgent/Python lib interface to schedule the 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_MISSING_REQUESTED_START_Inline_174</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
