...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Rescheduling_Cancelled_RecordingId_150</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_150 - Recorder must support canceling of a recording a rescheduling it with the same Recording ID - Reuse the cancelled recording Id</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_150</test_case_id>
    <test_objective>Recorder must support canceling of a recording a rescheduling it with the same Recording ID - Reuse the cancelled recording Id</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Rescheduling_Cancelled_RecordingId_150</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Rescheduling_Cancelled_RecordingId_150');
