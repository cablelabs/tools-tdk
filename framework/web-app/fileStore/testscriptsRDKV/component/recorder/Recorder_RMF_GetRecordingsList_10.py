...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_10</test_case_id>
    <test_objective>Recorder - To send initializing=true if and only if the recordingStatus contains ALL past, present, and future recordings on the box</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule recording with generation id = 0 and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_GetRecordingsList_10</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
