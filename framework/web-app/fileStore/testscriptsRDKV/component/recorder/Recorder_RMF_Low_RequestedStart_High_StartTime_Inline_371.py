...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Low_RequestedStart_High_StartTime_Inline_371</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_371</test_case_id>
    <test_objective>To check a recording which has RequestedStart  value less than start time using inline</test_objective>
...
3.Schedule a hot recording with RequestedStart has value less than start time using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Low_RequestedStart_High_StartTime_Inline_371</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Low_RequestedStart_High_StartTime_Inline_371');
