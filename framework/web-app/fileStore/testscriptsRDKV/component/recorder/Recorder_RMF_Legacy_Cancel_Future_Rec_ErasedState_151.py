...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Legacy_Cancel_Future_Rec_ErasedState_151</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_DVR_PROTOCOL_151 - Recorder should not send Erased state while canceling a future recording using Legacy mechanism</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_151</test_case_id>
    <test_objective>Recorder should not send Erased state while canceling a future recording uding Legacy mechanism</test_objective>
...
4. Schedule another recording to cancel the recording which in progress using legacy mechanism.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Legacy_Cancel_Future_Rec_ErasedState_151</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Legacy_Cancel_Future_Rec_ErasedState_151');
	...
	longDuration = "300000";
		...
		print "Retrieve Status Details: %s"%actResponse;
			...
			print "Retrieve Status Details: %s"%actResponse;
			    ...
			    recordingData = recorderlib.getRecordingFromRecId(actResponse,recordingID)
	                    print "Details for recording ID ", recordingID, " :", recordingData
                            if 'NOTFOUND' in recordingData:
                              	    tdkTestObj.setResultStatus("SUCCESS");
                                    print "Future canceled recording not found";
			    else:
                                    tdkTestObj.setResultStatus("FAILURE");
                                    print "Entry found for future canceled recording";	
                        else:
                            tdkTestObj.setResultStatus("FAILURE");
