...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HotRec_Legacy_Del_CompletedRec_178</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should include in full sync hot legacy recording that are deleted by user but not previously notified to RWS with Status=Erased</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_178</test_case_id>
    <test_objective>After deleting a completed hot legacy recording, check that recorder has sent status=Erased in a full sync</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HotRec_Legacy_Del_CompletedRec_178</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_HotRec_Legacy_Del_CompletedRec_178');
