...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>11</version>
  <name>Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Legacy_287</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_287</test_case_id>
    <test_objective>Recorder should cancel all the four recordings when an update schedule message is received with Full Schedule as true using legacy</test_objective>
...
3.Schedule 1 hot recording and 3 future recording using legacy
4.Schedule another hot recording with full schedule value as true
5. Check whether all the first 4 recordings are cancelled with error USER_STOP
...
Checkpoint 2 Check whether all the first 4 recordings are cancelled with error USER_STOP</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Legacy_287</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Legacy_287');
