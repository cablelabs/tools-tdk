...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_374</test_case_id>
    <test_objective>To extend a recording which has value in requestedStart using legacy</test_objective>
...
3.Schedule a hot recording with RequestedStart and start time values using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Extend_Recording_With_RequestedStart_Legacy_374</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
