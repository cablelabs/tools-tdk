...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_62</test_case_id>
    <test_objective>Check that after RWS Get server outage recorder attempts no more than 1 concurrent connection with randomized  exponentially-longer retry intervals each time, to avoid overwhelming the server after a systemwide outage.</test_objective>
...
3.RecorderAgent / Python lib interface will down the RWS GET server URL 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_RWSServerOutage_CheckConnectionRetrial_62</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
