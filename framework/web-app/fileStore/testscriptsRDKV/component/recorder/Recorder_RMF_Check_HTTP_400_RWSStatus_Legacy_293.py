...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>Recorder_RMF_Check_HTTP_400_RWSStatus_Legacy_293</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RWS status server should send HTTP 400 when the server is enabled with HTTP 400 error and also after retry recorder should send error code RDK-10028 using legacy</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_293</test_case_id>
    <test_objective>RWS status server should send HTTP 400 when the server is enabled with HTTP 400 error and also after retry recorder should send error code RDK-10028 using legacy</test_objective>
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_400_RWSStatus_Legacy_293</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_400_RWSStatus_Legacy_293');
