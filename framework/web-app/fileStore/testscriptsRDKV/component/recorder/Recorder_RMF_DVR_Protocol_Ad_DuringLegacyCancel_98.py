...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_DVR_Protocol_Ad_DuringLegacyCancel_98</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder- This test is to test the DVR Protocol Version being advertised during Cancel Recording through Legacy Mechanism		-CT_DVR_Protocol_98</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_98</test_case_id>
    <test_objective>This test is to test the DVR Protocol Version being advertised during Cancel Recording through Legacy Mechanism</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording with  and send to TDK Recorder Simulator server which is present in TM.
4. Cancel the recording which in progress using legacy mechanism,.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>/Recorder_RMF_DVR_Protocol_Ad_DuringLegacyCancel_98</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_DVR_Protocol_Ad_DuringLegacyCancel_98');
