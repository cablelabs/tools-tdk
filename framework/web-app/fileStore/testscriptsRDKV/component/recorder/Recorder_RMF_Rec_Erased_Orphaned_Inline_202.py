...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_202</test_case_id>
...
7.Check the status of previously scheduled recording, it should be complete.                                                                                            7. Delete the metadata (xml and files in  recdbser)  of previously completed recording. (Delete .bak files also)                                      8.Status of the Json response from Recorder to TDK Recorder Simulator server getting extracted by TM.
8.Delete the metadata of previously completed recording.     
9.RecorderAgent / Python lib interface will frame the json message to schedule the one more current recording of 2 minutes 
  and send to TDK Recorder Simulator server which is present in TM.
10.Wait for the recording to complete.
11.Reboot STB.
12.noUpdate schedule message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
13.Check the status of first recording, it should be ERASED and error should be set to ORPHANED.                             
14.Status of the Json response from Recorder to TDK Recorder Simulator server getting extracted by TM.
15.Depends on the result of above step RecorderAgent sends SUCCESS or FAILURE to TM.</automation_approch>
...
2.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Rec_Erased_Orphaned_Inline_202</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
