...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Verify_Ack_Inline_UpdateRecording_OneRec_95</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_95 - Recorder should respond to updateRecordings messages, whether received from longpoll by sending an acknowledgement message to RWS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_95</test_case_id>
    <test_objective>Recorder should respond to updateRecordings messages, whether received from longpoll by sending an acknowledgement messageÂ to RWS.</test_objective>
...
3.RecorderAgent / Python lib interface will frame the updateRecordings json message and send to TDK Recorder Simulator server which uses inline mechanism to send to Recorder.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_Ack_Inline_UpdateRecording_OneRec_95</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_Ack_Inline_UpdateRecording_OneRec_95');
