...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_111</test_case_id>
    <test_objective>Check that recorder sending status = Failed message if a inline future recording is scheduled with duration of 3seconds</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_SchedRec_Inline_FailedStatus_111</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
