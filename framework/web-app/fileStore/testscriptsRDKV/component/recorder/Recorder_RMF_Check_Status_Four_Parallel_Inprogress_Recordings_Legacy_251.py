...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Check_Status_Four_Parallel_Inprogress_Recordings_Legacy_251</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_251 - Schedule four recordings then reboot during recording and check the status of recordings</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_251</test_case_id>
    <test_objective>Schedule 4 recordings using legacy at same time and then reboot during when recording progressing and verify all the four recordings are started and is getting over with status incomplete</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Status_Four_Parallel_Inprogress_Recordings_Legacy_251</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Status_Four_Parallel_Inprogress_Recordings_Legacy_251');
