...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_45</test_case_id>
    <test_objective>Recorder- To preserve all current and future schedules when updateSchedule is received with fullSchedule=false. Cancelling of a recording should not preserve current scheduling</test_objective>
...
4.Another current recording will be scheduled with generation id = 0 and fullSchedule = false via legacy and cancelling a Recording
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Full_Schedule_False_CancelRecording_45</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
