...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Multiple_Hot_Rec_Same_OcapId_Inline_379</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Multiple hot recording with same OCAP</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_379</test_case_id>
    <test_objective>To do multiple hot recording with same ocap using inline</test_objective>
...
3. Schedule two hot recordings of 2 minute duration on same channel using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Multiple_Hot_Rec_Same_OcapId_Inline_379</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Multiple_Hot_Rec_Same_OcapId_Inline_379');
