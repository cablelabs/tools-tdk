...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Check_HTTP_404_RWSStatus_Legacy_300</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_300</test_case_id>
    <test_objective>RWS status server should send HTTP 404 when the server is enabled with HTTP 404 error and also after retry recorder should send error code RDK-10028 using legacy</test_objective>
...
2. Configure RWS status server with error 404
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_404_RWSStatus_Legacy_300</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_404_RWSStatus_Legacy_300');
