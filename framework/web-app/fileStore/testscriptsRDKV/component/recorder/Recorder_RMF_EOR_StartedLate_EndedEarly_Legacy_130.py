...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_130</test_case_id>
    <test_objective>check that Recorder sends an end-of-recording status if it ever sent any start-of-recording status for recording started late and ended early.</test_objective>
...
5.Once the STB and recorder is up wait for the recording to completes partially.
6.Reboot the STB so that recording is partial and ends early.
7.noUpdate schedule message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
8.Retrieve the status from Recorder to TDK Recorder Simulator server, it will be extracted by the TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_EOR_StartedLate_EndedEarly_Legacy_130</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
