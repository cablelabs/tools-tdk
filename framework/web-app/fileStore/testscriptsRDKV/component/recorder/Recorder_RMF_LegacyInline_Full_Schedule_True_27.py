...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_27</test_case_id>
    <test_objective>Recorder-To replace all current and future schedules when updateSchedule is received with fullSchedule=true. Perform first updateSchedule as legacy and second as inline</test_objective>
...
4.Another current recording  will be scheduled with generation id = 0 and fullSchedule= true as inline mechanism
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_LegacyInline_Full_Schedule_True_27</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
