...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Verify_RepeatStatus_FullSchedule_True_147</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_147 - Recorder should not send repeats of the same status - verifying by checking the full schedule true status</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_147</test_case_id>
    <test_objective>Recorder should not send repeats of the same status - verifying by checking the full schedule true status</test_objective>
...
5. Check for the response sent by the recorder
6. The response should not be sent again.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_RepeatStatus_FullSchedule_True_147</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_RepeatStatus_FullSchedule_True_147');
