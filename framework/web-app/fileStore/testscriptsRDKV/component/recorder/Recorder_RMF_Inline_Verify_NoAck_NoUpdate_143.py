...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_143</test_case_id>
    <test_objective>Recorder should do nothing upon receiving NoUpdate message with dvrProtocolVersion field        via inline</test_objective>
...
3.RecorderAgent/Python lib interface will frame the json message to Simulate a longpoll notification with an 
  inline "noUpdate" with dvrProtocolVersion=7 and send to TDK Recorder Simulator server which 
  is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_Verify_NoAck_NoUpdate_143</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
