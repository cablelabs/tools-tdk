...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_184</test_case_id>
    <test_objective>After deleting a on-going future legacy recording, check that recorder has sent status=Erased in a full sync</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_SchedRec_Legacy_Del_InProgressRec_184</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
