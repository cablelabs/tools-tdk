...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Inprogress_Recording_Extend_Duration_After_Reboot_Legacy_330</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_330</test_case_id>
    <test_objective>To extend the duration of an inprogress recording after reboot using legacy</test_objective>
...
3.Schedule a recording of 11 minutes duration using legacy
4.Reboot the box
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Recording_Extend_Duration_After_Reboot_Legacy_330</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Recording_Extend_Duration_After_Reboot_Legacy_330');
