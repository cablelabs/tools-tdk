...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Multiple_Hot_Rec_Same_OcapId_Legacy_378</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_378</test_case_id>
    <test_objective>To do multiple hot recording with same ocap using legacy</test_objective>
...
3. Schedule two hot recordings of 2 minute duration on same channel using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Multiple_Hot_Rec_Same_OcapId_Legacy_378</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Multiple_Hot_Rec_Same_OcapId_Legacy_378');
