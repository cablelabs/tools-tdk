...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_RecStatus_Delete_Lastid_Corrupt_Metadata_Inline_445</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check whether recording details are persisting when lastid.dat file and meta data (not backup )are missing</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_445</test_case_id>
    <test_objective>Recorder should persist the inline recording details when lastid.dat file and meta data (not backup )are corrupted</test_objective>
...
2.Schedule a hot inline recording of 10 minutes duration.
3.Wait for the recording to complete partially.
4.Delete the lastid.dat file and meta data of the ongoing recording.(dont delete .bak files)
5.Reboot STB.
7.Wait for the recording to complete.
8.Check the status of the recording, it should be INCOMPLETE and error should be set to POWER_INTERRUPTION
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_RecStatus_Delete_Lastid_Corrupt_Metadata_Inline_445</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_RecStatus_Delete_Lastid_Corrupt_Metadata_Inline_445');
