...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_123</test_case_id>
    <test_objective>Recorder to cancel multiple recordings via inline longpoll</test_objective>
...
3.RecorderAgent / Python lib interface will frame multiple Cancel Recording json message send to TDK Recorder Simulator server which uses inline mechanism to send to Recorder.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_CancelRecording_Multiple_Messages_123</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
