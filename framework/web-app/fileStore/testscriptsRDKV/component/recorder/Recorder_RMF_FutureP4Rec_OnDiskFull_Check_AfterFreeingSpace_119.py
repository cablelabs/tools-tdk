...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_119</test_case_id>
    <test_objective>Verify that additional segment is created for new future P4 recording after manually deleting old P4 recording before scheduled end time</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a future P4 recording for 1 min and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FutureP4Rec_OnDiskFull_Check_AfterFreeingSpace_119</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
                                                        ...
                                                        if 'updateRecordings' in actResponse:
                                                                ...
                                                                if 'ack' in actResponse:
                                                                        ...
                                                                        if 'getRecordings' in serverResponse:
                                                                               print "getRecordings message post success";
                                                                               #wait to get list
									       print "wait 60 scons to ge response from the recorder"
                                                                               sleep(60)
                                                                               recResponse = recorderlib.callServerHandler('retrieveStatus',ip);
