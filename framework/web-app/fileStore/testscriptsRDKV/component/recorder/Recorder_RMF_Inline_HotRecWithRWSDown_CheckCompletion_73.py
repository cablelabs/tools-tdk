...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_73</test_case_id>
    <test_objective>Test that an inline hot recording scheduled while only RWS is down starts immediately and is eventually playable (even though the ACK for the schedule update was not sent to RWS)</test_objective>
...
5.RecorderAgent / Python lib interface will bring up/activate the RWS Post server URL 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_HotRecWithRWSDown_CheckCompletion_73</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
