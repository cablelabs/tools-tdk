...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_Trm_Cancel_MaxTuners_Diff_OcapId_191</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_191 - Recorder to send TRM_CANCELLED error if recording is scheduled for the max number of tuners available with different ocap id and then again scheduling one more recording with different ocap id via inline</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_191</test_case_id>
    <test_objective>Recorder to send TRM_CANCELLED error if recording is scheduled for the max number of tuners available with different ocap id and then again scheduling one more recording with different ocap id via inline</test_objective>
...
3.Get max number of tuners and schedule recording for all tuners with different ocap id via inline long poll notification
4.Again schedule one more recording with different ocap id via inline long poll notification
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_Trm_Cancel_MaxTuners_Diff_OcapId_191</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_Trm_Cancel_MaxTuners_Diff_OcapId_191');
...
trmObj.configureTestCase(ip,port,'Recorder_RMF_Inline_Trm_Cancel_MaxTuners_Diff_OcapId_191');
#Get the result of connection with test component and STB
