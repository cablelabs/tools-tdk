...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Extend_Durationof_InComplete_Recording_Inline_343</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_343</test_case_id>
    <test_objective>Recorder should not extend the duration of an Incomplete recording due to power interrupt using inline</test_objective>
...
3.Schedule a hot recording of 11minutes duration using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Extend_Durationof_InComplete_Recording_Inline_343</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Extend_Durationof_InComplete_Recording_Inline_343');
