...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Check_Status_Five_Parallel_Recordings_Legacy_249</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_249 -Schedule 5 recordings during same time and verify all the 5 recordings are recorded properly</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_249</test_case_id>
    <test_objective>Schedule 5 recordings using legacy at same time and verify all the 5 recordings are recorded properly.</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to Schedule 5 recordings
4.Five recordings should record successfully.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Status_Five_Parallel_Recordings_Legacy_249</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Status_Five_Parallel_Recordings_Legacy_249');
...
trmObj.configureTestCase(ip,port,'Recorder_RMF_Check_Status_Five_Parallel_Recordings_Legacy_249');
#Get the result of connection with test component and STB
