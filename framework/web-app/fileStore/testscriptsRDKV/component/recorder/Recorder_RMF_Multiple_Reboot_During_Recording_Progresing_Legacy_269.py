...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Multiple_Reboot_During_Recording_Progresing_Legacy_269</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_269 - To check the status of recording which is interrupted multiple times using reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_269</test_case_id>
    <test_objective>To check the status of recording which is interrupted multiple times using reboot using legacy</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a   recording with long duration  using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
4.reboot the box when recording is progressing 
5.wait for recording to resume and reboot again
6. wait for the recording to resume and getrecordings message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Multiple_Reboot_During_Recording_Progresing_Legacy_269</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Multiple_Reboot_During_Recording_Progresing_Legacy_269');
