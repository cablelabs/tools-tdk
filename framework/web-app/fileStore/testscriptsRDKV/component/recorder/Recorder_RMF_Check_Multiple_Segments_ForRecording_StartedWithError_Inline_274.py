...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_Multiple_Segments_ForRecording_StartedWithError_Inline_274</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_274 - Test for segmented recordings by rebooting the box when a recording is in StartedWithError</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_274</test_case_id>
    <test_objective>To test for segmented recordings by rebooting the box when that recording is in StartedWithError using inline</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording of long min duration with  using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
7. Status of the Json response from Recorder to TDK Recorder Simulator server getting extracted by TM.recording status should be StartedInComplete
8.Reboot the box again and getrecordings message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings
9.Check whether the content field of corresponding recording have multiple segements
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Multiple_Segments_ForRecording_StartedWithError_Inline_274</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Multiple_Segments_ForRecording_StartedWithError_Inline_274');
