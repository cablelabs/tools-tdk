...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_139</test_case_id>
    <test_objective>Recorder should send timestamp=&amp;lt;the time inÂ millis that something last changed&amp;gt; in recording status during power interruption</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recordings using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_TimeStamp_PowerInterrupt_139</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
