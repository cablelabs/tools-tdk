...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inprogress_Rec_Delete_XML_Reboot_Legacy_416</name>
  <primitive_test_id/>
...
5. Delete the XML's of the recording (Do NOT delete backup file) and reboot the box
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Rec_Delete_XML_Reboot_Legacy_416</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Rec_Delete_XML_Reboot_Legacy_416');
