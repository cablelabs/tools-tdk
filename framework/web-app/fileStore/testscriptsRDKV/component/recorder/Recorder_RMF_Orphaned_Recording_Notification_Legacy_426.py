...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Orphaned_Recording_Notification_Legacy_426</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_426</test_case_id>
    <test_objective>Once the full sync has been successfully sent Recorder can stop tracking the orphaned recordings using legacy</test_objective>
...
2.Schedule a hot recording of 1 minute duration using  legacy
...
2.TestMgr_Recorder_DeleteRecordingMetaData</test_stub_interface>
    <test_script>Recorder_RMF_Orphaned_Recording_Notification_Legacy_426</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Orphaned_Recording_Notification_Legacy_426');
