...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>Recorder_RMF_Delete_P0_Recording_Legacy_236</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_236</test_case_id>
    <test_objective>To check the presence of recording metadata after deleting that particular recording.(legacy)</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a recording and update deletePriority field of that recording Id with generation id = 0 using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
2.TestMgr_Recorder_PresenceOfRecordingMetaData</test_stub_interface>
    <test_script>Recorder_RMF_Delete_P0_Recording_Legacy_236</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
