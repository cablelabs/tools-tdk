...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Corrupt_RecMetadata_Inprogress_Recording_Legacy_350</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_350</test_case_id>
    <test_objective>Recording should continue without any issues after corrupting meta data using legacy</test_objective>
...
3.Schedule a hot recording of 3 minute duration  using legacy
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Corrupt_RecMetadata_Inprogress_Recording_Legacy_350</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Corrupt_RecMetadata_Inprogress_Recording_Legacy_350');
