...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_UpdateDuration_FutureRecording_Legacy_334</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_334</test_case_id>
    <test_objective>To update duration of a future recording upon receiving updateRecordings message using legacy</test_objective>
...
3.Schedule a future recording of 1 minute duration with start time 1 minute using legacy
4. Before recording starts update the recording duration to 2 minutes using updateRecordings mesage
5.Check whether the expected duration of  recording is NOT extended and also check the actual duration of recording is NOT changed.
...
Checkpoint 2 Get the list of recordings to check whether fields are NOT updated for the specified recording Id.</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_UpdateDuration_FutureRecording_Legacy_334</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_UpdateDuration_FutureRecording_Legacy_334');
