...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>Recorder_RMF_Schedule_With_Unsupported_Protocol_Version_Legacy_243</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recorder_DVR_Protocol_243 - Recorder-  Schedule a recording with an unsupported dvr protocol version and check whether recording completes successfully</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_243</test_case_id>
    <test_objective>Schedule a recording using legacy with an unsupported dvr p
rotocol version and check whether recording completes successfully</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording with an unsupported dvr protocol version and send to TDK Recorder Simulator server which is present in TM.
4. STB will be rebooted after a sleep of recording duration.
5. get recordings message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Schedule_With_Unsupported_Protocol_Version_Legacy_243</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Schedule_With_Unsupported_Protocol_Version_Legacy_243');
