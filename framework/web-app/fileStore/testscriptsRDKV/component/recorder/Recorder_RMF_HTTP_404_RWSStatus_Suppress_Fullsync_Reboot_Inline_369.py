...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Inline_369</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_369</test_case_id>
    <test_objective>Recorder should send the full sync details for the next reboot if the last full sync was suppressed with server connection issue using inline</test_objective>
...
6. Schedule a hot recording using inline with bad ocap and wait for the connection fall back in RWS status server then check RDK-10028 error code. 
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Inline_369</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Inline_369');
...
obj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_Reboot_Inline_369');
