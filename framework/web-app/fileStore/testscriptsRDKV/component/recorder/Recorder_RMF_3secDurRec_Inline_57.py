...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_3secDurRec_Inline_57</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_57</test_case_id>
    <test_objective>Recorder-Create a recording of 3 seconds duration and get the details of recording using GET RWS (inline). Status of this recording should be marked as Failed</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current a current recording with duration = 3seconds using inline mechanism
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_3secDurRec_Inline_57</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_3secDurRec_Inline_57');
