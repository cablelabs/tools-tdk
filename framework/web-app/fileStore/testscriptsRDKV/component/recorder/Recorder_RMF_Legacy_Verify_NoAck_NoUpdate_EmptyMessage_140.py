...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Legacy_Verify_NoAck_NoUpdate_EmptyMessage_140</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_140 - Recorder should do nothing upon receiving NoUpdate with empty message</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_140</test_case_id>
    <test_objective>Recorder should do nothing upon receiving NoUpdate with empty message</test_objective>
...
3.RecorderAgent/Python lib interface will frame the json message to Simulate a longpoll notification with an 
  legacy "noUpdate" with no data and send to TDK Recorder Simulator server which 
  is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Legacy_Verify_NoAck_NoUpdate_EmptyMessage_140</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Legacy_Verify_NoAck_NoUpdate_EmptyMessage_140');
