...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Hot_Future_Rec_Same_OcapId_Inline_383</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_383</test_case_id>
    <test_objective>To do Hot and Future recording with same OCAP id using inline</test_objective>
...
3. Schedule a hot recording of 3 minte duration and a future recording of 1 minute duration with start time 1 minute on same channel using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Hot_Future_Rec_Same_OcapId_Inline_383</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Hot_Future_Rec_Same_OcapId_Inline_383');
