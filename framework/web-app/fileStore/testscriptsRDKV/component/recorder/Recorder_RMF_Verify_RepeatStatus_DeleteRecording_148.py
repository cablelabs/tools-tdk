...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_148</test_case_id>
    <test_objective>Recorder should not send repeats of the same status - verifying by deleting the completed recording and checking the status</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_RepeatStatus_DeleteRecording_148</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
