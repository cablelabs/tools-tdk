...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_SchedRec_Legacy_Pending_Received_168</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should send Pending status in a full sync when a future legacy recording is scheduled</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_168</test_case_id>
    <test_objective>Check that recorder should send Pending status in a full sync when a future legacy recording is scheduled</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_SchedRec_Legacy_Pending_Received_168</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_SchedRec_Legacy_Pending_Received_168');
	...
	loadmoduledetails = obj.getLoadModuleDetails();
        ...
        if "updateSchedule" in serverResponse:
                ...
                if "acknowledgement" in recResponse:
                        ...
                        # After reboot schedule future legacy recording in order to get pending status
                        startTime2 = "60000";
