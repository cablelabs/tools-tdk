...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Future_Rec_Fullsync_Pending_Legacy_422</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Fullsync response should sent the pending status for recordings which are yet to start</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_422</test_case_id>
    <test_objective>Recorder should sent full sync response when there are recordings which are in pending state using legacy</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>1. rmfStreamer executable should be running.
2. Device time should be in current time of UTC.
3. Two files should be created in the name of Ã¢Â&#128;Â&#156;stt_receivedÃ¢Â&#128;Â&#157; and Ã¢Â&#128;Â&#156;stage4Ã¢Â&#128;Â&#157; in Ã¢Â&#128;Â&#156;/tmpÃ¢Â&#128;Â&#157; path of device.
4. In rmfconfig.ini file the parameters Ã¢Â&#128;Â&#156;FEATURE.LONGPOLL.URLÃ¢Â&#128;Â&#157;,"FEATURE.RWS.GET.URL" and "FEATURE.RWS.POST.URL" should be pointing to DVRSimulator</pre_requisite>
    <api_or_interface_used>Json Interface</api_or_interface_used>
    <input_parameters>Json Interface- source id, duration recording_id, start_time.</input_parameters>
    <automation_approch>1.TM loads RecorderAgent via the test agent.
2.Schedule a hot recording and wait for full sync to happen then schedule a  future recording of 10 minute duration with 1 minute start time using  legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Future_Rec_Fullsync_Pending_Legacy_422</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Rec_Fullsync_Pending_Legacy_422');
		    ...
		    tdkTestObj1 = recObj.createTestStep('Recorder_SendRequest');
                    ...
                    if 'NOTFOUND' not in recordingData:
                        ...
                        if "PENDING" in value.upper():
                            ...
                            print "Scheduled recording has status PENDING";
                        else:
                            tdkTestObj1.setResultStatus("FAILURE");
                            print "Scheduled recording not have PENDING status";
                    else:
                        tdkTestObj1.setResultStatus("FAILURE");
