...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Rec_Erased_Delete_Blobs_Legacy_384</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_384</test_case_id>
    <test_objective>Recordings with missing blobs should report as Status=Erased, Error=ORPHANED in the next full sync using legacy</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording of 2 minutes using legacy
...
7.RecorderAgent / Python lib interface will frame the json message to schedule the one more current recording of 2 minutes using legacy
  and send to TDK Recorder Simulator server which is present in TM.
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Rec_Erased_Delete_Blobs_Legacy_384</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Rec_Erased_Delete_Blobs_Legacy_384');
