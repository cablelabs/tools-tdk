...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Update_InprogressRec_Deletion_Prioirty_Inline_361</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Update the deletion priority of an in progress recording</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_361</test_case_id>
    <test_objective>To update the deletion priority of an in progress recording using inline</test_objective>
...
3.Schedule a hot P4 recording of 2 minute duration  using inline
4. Update the delete priority to P0 when the recording is in progress
5. Wait for the recording to complete and Using getRecordings message retrieve the recording details and check the recording details are there.
...
Checkpoint 2 Check the priority is updated to P0</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Update_InprogressRec_Deletion_Prioirty_Inline_361</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Update_InprogressRec_Deletion_Prioirty_Inline_361');
 	...
 	print "No Update Schedule Details: %s"%actResponse;
		...
		if 'acknowledgement' not in actResponse:
			...
			if 'acknowledgement' not in actResponse:
                            ...
                            tdkTestObj.setResultStatus("SUCCESS");
                            print "Successfully retrieved acknowledgement from recorder and wait for the recording to complete";
                            sleep(100);
                            ...
                            if 'NOTFOUND' not in recordingData:
                                ...
                                reqRecording = {"recordingId":recordingID,"duration":120000,"deletePriority":"P0"}
                                ...
                                if ret in "FALSE":
                                    ...
                                    tdkTestObj.setResultStatus("SUCCESS");
                                    print "Updated the recording priority and the recording not have undesirable values";
                            else:
                                 tdkTestObj.setResultStatus("FAILURE");
