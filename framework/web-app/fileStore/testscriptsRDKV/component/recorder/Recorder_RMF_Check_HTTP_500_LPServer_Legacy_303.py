...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_303</test_case_id>
    <test_objective>Long poll server should send HTTP 500 when server is enabled with HTTP 500 error and after clearing the error legacy recording should get complete</test_objective>
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_500_LPServer_Legacy_303</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
