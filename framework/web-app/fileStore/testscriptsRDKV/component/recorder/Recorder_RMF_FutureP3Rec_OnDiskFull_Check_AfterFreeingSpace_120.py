...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_FutureP3Rec_OnDiskFull_Check_AfterFreeingSpace_120</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that additional segment is created for new future P3 recording after manually deleting old P4 recording before scheduled end time</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_120</test_case_id>
    <test_objective>Verify that additional segment is created for new future P3 recording after manually deleting old P4 recording before scheduled end time</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a future P3 recording for 1 min and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FutureP3Rec_OnDiskFull_Check_AfterFreeingSpace_120</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_FutureP3Rec_OnDiskFull_Check_AfterFreeingSpace_120');
