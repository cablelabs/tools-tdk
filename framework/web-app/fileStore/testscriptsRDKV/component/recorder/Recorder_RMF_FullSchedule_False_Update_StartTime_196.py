...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_196</test_case_id>
    <test_objective>Recorder to update the start time of a future recording when a updateschedule is done with fullschedule false</test_objective>
...
4. Again schedule a recording with same recording, fullschedule to false and start time value alone changed
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FullSchedule_False_Update_StartTime_196</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
