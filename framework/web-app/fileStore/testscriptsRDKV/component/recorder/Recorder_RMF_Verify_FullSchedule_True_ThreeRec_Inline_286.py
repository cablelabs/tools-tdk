...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Inline_286</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should cancel all the three recordings when an update schedule message is received with Full Schedule as true</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_286</test_case_id>
    <test_objective>Recorder should cancel all the three recordings when an update schedule message is received with Full Schedule as true using inline</test_objective>
...
3.Schedule 1 hot recording and 2 future recording using inline
4.Schedule another hot recording with full schedule value as true
5. Check whether all the first 3 recordings are cancelled with error USER_STOP
...
Checkpoint 2 Check whether all the first 3 recordings are cancelled with error USER_STOP</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Inline_286</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Inline_286');
