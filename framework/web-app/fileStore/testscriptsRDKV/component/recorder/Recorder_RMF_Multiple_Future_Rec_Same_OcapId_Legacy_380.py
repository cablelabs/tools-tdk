...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Multiple_Future_Rec_Same_OcapId_Legacy_380</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_380</test_case_id>
    <test_objective>To do multiple future recording with same ocap using legacy</test_objective>
...
3. Schedule two future recordings of 2 minute duration with start time 1 minute on same channel using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Multiple_Future_Rec_Same_OcapId_Legacy_380</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Multiple_Future_Rec_Same_OcapId_Legacy_380');
