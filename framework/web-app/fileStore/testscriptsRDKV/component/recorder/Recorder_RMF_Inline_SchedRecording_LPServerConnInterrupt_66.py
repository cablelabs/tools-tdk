...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_SchedRecording_LPServerConnInterrupt_66</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>If Longpoll connection is interrupted (during inline scheduled future recording), Recorder needs to request a full schedule once connection is re-established.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_66</test_case_id>
    <test_objective>Check that longpoll connection interruption during inline scheduled future recording resumes by recorder requesting a full schedule once the connection is re-established</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule future recording using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_SchedRecording_LPServerConnInterrupt_66</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_SchedRecording_LPServerConnInterrupt_66');
