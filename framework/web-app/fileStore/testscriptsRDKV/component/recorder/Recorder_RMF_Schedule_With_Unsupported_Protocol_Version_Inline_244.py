...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Schedule_With_Unsupported_Protocol_Version_Inline_244</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recorder_DVR_Protocol_244 - Recorder-  Schedule a recording with an unsupported dvr protocol version and check whether recording completes successfully</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_244</test_case_id>
    <test_objective>Schedule a recording using inline with an unsupported dvr p
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Schedule_With_Unsupported_Protocol_Version_Inline_244</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Schedule_With_Unsupported_Protocol_Version_Inline_244');
