...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_6secDurRec_Legacy_56</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_56</test_case_id>
    <test_objective>Recorder-Create a recording of 6 seconds duration and get the details of recording using GET RWS (legacy). Status of this recording should be marked as Failed</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current a current recording with duration = 6 seconds using leagacy mechanism
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_6secDurRec_Legacy_56</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_6secDurRec_Legacy_56');
