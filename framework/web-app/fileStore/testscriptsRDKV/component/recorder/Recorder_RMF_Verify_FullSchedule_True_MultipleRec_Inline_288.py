...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_288</test_case_id>
    <test_objective>Recorder should cancel all the four recordings when an update schedule message is received with Full Schedule as true using inline</test_objective>
...
3.Schedule 1 hot recording and 3 future recording using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Inline_288</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
