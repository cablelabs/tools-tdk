...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_FullSchedule_Cancel_InComplete_Rec_Inline_457</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should not change the status when cancelling an INCOMPLETE recording with fullSchedule values as true</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_457</test_case_id>
    <test_objective>Recorder should not change the status when cancelling a inline INCOMPLETE recording with fullSchedule as true</test_objective>
...
2.Schedule a hot inline recording of 7 minute duration.
3.Reboot the box and wait for the recording to complete
4.Sent json message to cancel the recording with fullSchedule as true
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_FullSchedule_Cancel_InComplete_Rec_Inline_457</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_FullSchedule_Cancel_InComplete_Rec_Inline_457');
			...
			sleep(300);
	                ...
	                tdkTestObj = obj.createTestStep('Recorder_SendRequest');
                 	tdkTestObj.executeTestCase(expectedResult);		
                        ...
                        jsonMsgCancelRecording = "{\"updateSchedule\":{\"requestId\":\""+requestID+"\",\"fullSchedule\":true,\"cancelRecordings\":[\""+recordingID+"\"]}}";
