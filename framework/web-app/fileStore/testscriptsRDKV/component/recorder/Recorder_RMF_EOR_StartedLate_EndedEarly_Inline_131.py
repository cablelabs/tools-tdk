...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_EOR_StartedLate_EndedEarly_Inline_131</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_131</test_case_id>
...
3.Frame the inline json message through RecorderAgent/Python lib interface to schedule the future (starting after 90 seconds) recording 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_EOR_StartedLate_EndedEarly_Inline_131</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
