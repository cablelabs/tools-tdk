...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_14</test_case_id>
    <test_objective>Recorder- To accept Generation ID via updateSchedule retrieved from RWS</test_objective>
...
3.RecorderAgent/Python lib interface will frame the json message to Simulate a legacy 
  ...
  is present in TM.
4.When STB (Recorder) makes a GET request to RWS, simulate an RWS "updateSchedule" response bearing 
  HTTP header "X-Parker-Generation-ID: test2a" through RecorderAgent/Python lib interface
5.STB (Recorder) makes a POST request to RWS bearing HTTP header "X-Parker-Generation-ID: test2a" with "acknowledgement" payload.(CP)
...
9.STB (Recorder) makes a GET request to RWS bearing HTTP header "X-Parker-Generation-ID: test2a" (CP)</automation_approch>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_GenerationId_UpdateSchedule_RWS_14</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
