...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_79</test_case_id>
    <test_objective>Check that recorder requests a full schedule when heartbeat dots are not received on Longpoll connection for 90 seconds when inline hot recording is scheduled</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_HotRec_LPSDownFor90Sec_FullSched_79</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
