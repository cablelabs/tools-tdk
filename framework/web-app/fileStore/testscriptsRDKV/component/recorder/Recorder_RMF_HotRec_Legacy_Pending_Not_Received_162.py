...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_162</test_case_id>
    <test_objective>Check that recorder not sending status = Pending when a legacy hot recording is scheduled</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HotRec_Legacy_Pending_Not_Received_162</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
