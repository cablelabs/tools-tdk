...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Legacy_SchedRecWithRWSDown_CheckRecStatus_188</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>If Recorder encounters failure sending any message to RWS, recording status of future legacy recording that have not been sent need to be re-sent once RWS connectivity is re-established</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_188</test_case_id>
    <test_objective>Check that recording status of future legacy recording that have not been sent due to RWS connection failure, need to be re-sent once RWS connectivity is re-established</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a future recording using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Legacy_SchedRecWithRWSDown_CheckRecStatus_188</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Legacy_SchedRecWithRWSDown_CheckRecStatus_188');
