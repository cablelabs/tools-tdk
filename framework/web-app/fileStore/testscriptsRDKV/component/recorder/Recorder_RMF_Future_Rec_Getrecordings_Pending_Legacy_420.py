...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Future_Rec_Getrecordings_Pending_Legacy_420</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Getrecordings response should sent the pending status for recordings which are yet to start</synopsis>
  <groups_id/>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording with 1 minute duration and 3 minute start time using legacy and send to TDK Recorder Simulator server which is present in TM.
5.Using getRecordings message retrieve the recording details and check the recording details are there. 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Future_Rec_Getrecordings_Pending_Legacy_420</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Rec_Getrecordings_Pending_Legacy_420');
