...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_UpdateRecording_Multiple_Messages_122</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_122 - Recorder to handle updateRecording with multiple messages via inline</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_122</test_case_id>
    <test_objective>Recorder to handle updateRecording with multiple messages via inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame multiple updateRecording json message send to TDK Recorder Simulator server which uses inline mechanism to send to Recorder.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_UpdateRecording_Multiple_Messages_122</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_UpdateRecording_Multiple_Messages_122');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	sleep(10);
		...
		if 'acknowledgement' not in actResponse:
                    ...
                    jsonMsgUpdateRecording = "{\"updateRecordings\":{\"requestId\":\""+requestID+"\",\"generationId\":\"0\",\"dvrProtocolVersion\":\"7\",\"recordings\":[{\"recordingId\":\""+recordingID+"\",\"deletePriority\":\"P3\"},{\"recordingId\":\""+str(int(recordingID)+1)+"\",\"deletePriority\":\"P3\"},{\"recordingId\":\""+str(int(recordingID)+2)+"\",\"deletePriority\":\"P3\"}]}}";
			...
			if 'acknowledgement' not in actResponse:
                            ...
                            if 'NOTFOUND' not in recordingData or 'NOTFOUND' not in secondRecordingData or 'NOTFOUND' not in thirdRecordingData:
                                ...
                                if "P3" in value.upper() and "P3" in secondRecValue.upper() and "P3" in thirdRecValue.upper():
