...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Extend_HotRec_FutureRec_Same_OcapId_Legacy_376</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_376</test_case_id>
    <test_objective>To extend a recording and schedule a future recording with same ocap using legacy</test_objective>
...
3. Schedule a hot recording with 2 minute duration and a future recording of 1 minute duration with 2 minute start time  on same channel using legacy
4. After 30 seconds extend the hot recording to 3 minutes using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Extend_HotRec_FutureRec_Same_OcapId_Legacy_376</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Extend_HotRec_FutureRec_Same_OcapId_Legacy_376');
