...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_256</test_case_id>
    <test_objective>To check whether recorder sends error or not for  the loss of connection with RWS  Status Server using inline</test_objective>
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_Configure_WrongRWSStatus_Url_Inline_256</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
