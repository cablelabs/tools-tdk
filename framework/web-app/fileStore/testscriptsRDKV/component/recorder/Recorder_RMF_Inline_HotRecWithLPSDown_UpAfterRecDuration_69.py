...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_69</test_case_id>
    <test_objective>Test that an inline hot recording scheduled while Longpoll is down starts as soon as connection is re-established after duration of recording.</test_objective>
...
5.RecorderAgent / Python lib interface will bring up/activate the Long poll server URL after the duartion of the recording is complete
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_HotRecWithLPSDown_UpAfterRecDuration_69</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
