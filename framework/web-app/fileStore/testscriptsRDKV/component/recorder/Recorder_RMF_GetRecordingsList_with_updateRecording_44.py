...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_44 - Recorder - To send initializing=true if and only if the recordingStatus contains ALL past, present, and future recordings on the box. Get recording list by sending updateRecording after reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_44</test_case_id>
    <test_objective>Recorder - To send initializing=true if and only if the recordingStatus contains ALL past, present, and future recordings on the box. Get recording list by sending updateRecording after reboot</test_objective>
...
5. Update Recording message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_GetRecordingsList_with_updateRecording_44</test_script>
    <skipped>Yes</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_GetRecordingsList_with_updateRecording_44');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	sleep(10);
		...
		if 'acknowledgement' not in actResponse:
		    ...
		    print "Clear Status Details: %s"%response;
		    #Frame json message
		    jsonMsgUpdateRecordings = "{\"updateRecordings\":{\"dvrProtocolVersion\":\"7\"}}";
                    expResponse = "updateRecordings";
		    tdkTestObj1 = recObj.createTestStep('Recorder_SendRequest');
                    tdkTestObj1.executeTestCase(expectedResult);
                    actResponse = recorderlib.callServerHandlerWithMsg('updateMessage',jsonMsgUpdateRecordings,ip);
                    print "No Update Schedule Details: %s"%actResponse;
                    if expResponse in actResponse:
