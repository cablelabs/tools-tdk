...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Future_Recording_Extend_Invalid_Ocap_Legacy_434</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_434</test_case_id>
    <test_objective>Future legacy recording should get failed when it is extended with invalid ocap id</test_objective>
...
2.Schedule a future recording of two minute duration with one minute start time using  legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Future_Recording_Extend_Invalid_Ocap_Legacy_434</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Recording_Extend_Invalid_Ocap_Legacy_434');
