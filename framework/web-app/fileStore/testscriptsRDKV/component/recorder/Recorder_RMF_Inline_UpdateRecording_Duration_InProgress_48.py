...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Inline_UpdateRecording_Duration_InProgress_48</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_48</test_case_id>
    <test_objective>Recorder- To update duration upon receiving updateRecordings message via inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to update duration field for a specified recording Id with generation id = 0 using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_UpdateRecording_Duration_InProgress_48</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_UpdateRecording_Duration_InProgress_48');
