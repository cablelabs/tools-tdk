...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Restore_Reboot_Inline_347</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_347</test_case_id>
    <test_objective>To check recording value persistency after moving to priority P0 followed by a priority restore and reboot using inline</test_objective>
...
3.Schedule a hot P4 recording of 1 minute duration  using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Restore_Reboot_Inline_347</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Recording_Value_Persistency_After_Delete_Restore_Reboot_Inline_347');
