...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_16</test_case_id>
    <test_objective>Recorder- To accept Generation ID via noUpdate retrieved from RWS</test_objective>
...
4.When Recorder makes a GET request to RWS, simulate an RWS "noUpdate" response bearing 
  HTTP header "X-Parker-Generation-ID: test2c" through RecorderAgent/Python lib interface.
5.STB (Recorder) will not send any "acknowledgement" payload.(CP)
...
9.STB (Recorder) makes a GET request to RWS bearing HTTP header "X-Parker-Generation-ID: test2c" (CP)</automation_approch>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_GenerationId_noUpdate_RWS_16</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
