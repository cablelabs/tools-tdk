...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Multiple_Future_Rec_Same_OcapId_Inline_381</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Multiple future recording with same OCAP</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_381</test_case_id>
    <test_objective>To do multiple future recording with same ocap using inline</test_objective>
...
3. Schedule two future recordings of 2 minute duration with start time 1 minute on same channel using inline
4.Wait for the recording to complete and check whether the recording is NOT have any undesirable values
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Multiple_Future_Rec_Same_OcapId_Inline_381</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Multiple_Future_Rec_Same_OcapId_Inline_381');
	...
	sleep(10);
		...
		if 'acknowledgement' not in actResponse:
                    ...
                    print "Received Empty/Error status";
                        ...
                        print "Wait for the recordings to be completed"
                        sleep(190);
                        tdkTestObj.setResultStatus("SUCCESS");
                        tdkTestObj.executeTestCase(expectedResult);
                        ...
                        if 'NOTFOUND' not in recordingData1:
                                print "Successfully retrieved the recording list";
                                reqRecording1 = {"recordingId":recordingID,"duration":120000,"deletePriority":"P3"}
                                ...
                                if "FALSE" not in (ret1 or ret2):
                                        ...
                                        tdkTestObj.setResultStatus("FAILURE");
                                        print "Recordings NOT completed as expected";
                        else:
                                tdkTestObj.setResultStatus("FAILURE");
