...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Rec_Erased_Delete_XML_Inline_387</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_387</test_case_id>
    <test_objective>Recordings with missing XML's should report as Status=Erased, Error=ORPHANED in the next full sync using inline</test_objective>
...
5.Check the status of the scheduled recording, it should be complete.                                                                                            9. 6.Delete the XML's of previously completed recording. (Delete .bak files also)                                  
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Rec_Erased_Delete_XML_Inline_387</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Rec_Erased_Delete_XML_Inline_387');
