...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HTTP_404_RWSStatus_Recording_Erased_Reboot_Inline_401</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checking whether the Erased recording details are getting synced with RWS  or not  after reboot when the server is up after reconnecting</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_401</test_case_id>
    <test_objective>After reboot check whether the Erased recording details using inline are getting synced with RWS  or not  when the server is up after reconnecting</test_objective>
...
3. Schedule a  future recording of 1 minute duration with 2minutes start time using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Recording_Erased_Reboot_Inline_401</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Recording_Erased_Reboot_Inline_401');
