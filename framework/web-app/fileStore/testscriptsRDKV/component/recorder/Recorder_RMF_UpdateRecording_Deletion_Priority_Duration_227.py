...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_227</test_case_id>
    <test_objective>To update deletion priority upon receiving updateRecordings message and checking expected duration value of the recoridng after updation.</test_objective>
...
Checkpoint 2 Get the list of recordings to check whether fields are updated for the specified recording Id and also  expected duration value is matching after and before priority updation</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_UpdateRecording_Deletion_Priority_Duration_227</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
