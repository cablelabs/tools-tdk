...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Future_Rec_Fullsync_Pending_Inline_423</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_423</test_case_id>
    <test_objective>Recorder should sent full sync response when there are recordings which are in pending state using inline</test_objective>
...
2.Schedule a hot recording and wait for full sync to happen then Schedule  a  future recording of 10 minute duration with 1 minute start time using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Future_Rec_Fullsync_Pending_Inline_423</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Rec_Fullsync_Pending_Inline_423');
