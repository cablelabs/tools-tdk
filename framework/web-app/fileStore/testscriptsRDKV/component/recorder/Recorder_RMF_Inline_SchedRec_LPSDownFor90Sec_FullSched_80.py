...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_SchedRec_LPSDownFor90Sec_FullSched_80</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check that recorder requests a full schedule when heartbeat dots are not received on Longpoll connection for 90 seconds when inline recording is scheduled for a future time</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_80</test_case_id>
    <test_objective>Check that recorder requests a full schedule when heartbeat dots are not received on Longpoll connection for 90 seconds when inline recording is scheduled for a future time</test_objective>
...
4. RecorderAgent / Python lib interface will frame the json message to schedule future recording using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
5.RecorderAgent / Python lib interface will bring up/activate the Long poll server URL after 90 secs
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_SchedRec_LPSDownFor90Sec_FullSched_80</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_SchedRec_LPSDownFor90Sec_FullSched_80');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	loadmoduledetails = recObj.getLoadModuleDetails();
        ...
        #Inline Sched Recording updateSchedule
