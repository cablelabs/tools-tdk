...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Corrupt_RecMetadata_Inprogress_Recording_Inline_351</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recording should continue without any issues after corrupting meta data</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_351</test_case_id>
    <test_objective>Recording should continue without any issues after corrupting meta data using inline</test_objective>
...
3.Schedule a hot recording of 3 minute duration  using inline
4.Wait for the recording to complete partailly.
5. Delete the meta data of the recording (Do NOT delete backup file)
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Corrupt_RecMetadata_Inprogress_Recording_Inline_351</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Corrupt_RecMetadata_Inprogress_Recording_Inline_351');
