...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Recording_Failed_Erased_Fullsync_Legacy_436</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_436</test_case_id>
    <test_objective>Recorder should not notify failed legacy recording which are notified to RWS as ERASED in next full sync</test_objective>
...
2.Schedule a hot legacy recording of 1 minute duration with an invalid ocap id
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Recording_Failed_Erased_Fullsync_Legacy_436</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Recording_Failed_Erased_Fullsync_Legacy_436');
