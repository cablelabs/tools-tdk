...
<xml>
  ...
  <name>Recorder_RMF_Resume_Orphaned_Recording_Inline_425</name>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_425</test_case_id>
    <test_objective>Recorder should resume orphaned recordings using inline after reboot provided end time is not expired</test_objective>
...
2.Schedule a  future recording of 11 minute duration  using  inline
...
2.TestMgr_Recorder_DeleteRecordingMetaData</test_stub_interface>
    <test_script>Recorder_RMF_Resume_Orphaned_Recording_Inline_425</test_script>
    <skipped>No</skipped>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Resume_Orphaned_Recording_Inline_425');
