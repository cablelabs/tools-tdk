...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Future_Rec_Getrecordings_Pending_Inline_421</name>
  <primitive_test_id/>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording with 1 minute duration and 3 minute start time using inline and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Future_Rec_Getrecordings_Pending_Inline_421</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Rec_Getrecordings_Pending_Inline_421');
