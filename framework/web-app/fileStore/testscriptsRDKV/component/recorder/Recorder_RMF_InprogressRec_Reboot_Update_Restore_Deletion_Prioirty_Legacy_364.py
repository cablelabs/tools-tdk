...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_364</test_case_id>
    <test_objective>To update and restore the deletion priority of an in progress recording which is incomplete due to POWER_INTERRUPTION using legacy</test_objective>
...
3.Schedule a hot P4 recording of 8 minute duration  using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_InprogressRec_Reboot_Update_Restore_Deletion_Prioirty_Legacy_364</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
