...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_353</test_case_id>
    <test_objective>To check the status of a future recording which has an expired end time using inline</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_StatusOf_FutureRecWith_Expired_Endtime_Inline_353</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
