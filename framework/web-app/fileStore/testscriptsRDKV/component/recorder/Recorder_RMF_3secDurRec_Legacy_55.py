...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_55</test_case_id>
    <test_objective>Recorder-Create a recording of 3 seconds duration and get the details of recording using GET RWS (legacy). Status of this recording should be marked as Failed</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current a current recording with duration = 3seconds using leagacy mechanism
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_3secDurRec_Legacy_55</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
