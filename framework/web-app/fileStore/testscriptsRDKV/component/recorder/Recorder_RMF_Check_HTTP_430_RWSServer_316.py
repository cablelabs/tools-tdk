...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Check_HTTP_430_RWSServer_316</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>RWS server should send HTTP 430 when the server is enabled with HTTP 430 error and also after retry recorder should send error code RDK-10028</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_316</test_case_id>
    <test_objective>RWS server should send HTTP 430 when the server is enabled with HTTP 430 error and also after retry recorder should send error code RDK-10028</test_objective>
...
2. Configure RWS server with error 430
...
6.Clear the RWS server error 430
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_430_RWSServer_316</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_430_RWSServer_316');
