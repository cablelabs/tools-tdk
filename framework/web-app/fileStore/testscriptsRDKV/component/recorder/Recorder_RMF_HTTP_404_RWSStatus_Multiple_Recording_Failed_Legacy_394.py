...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_HTTP_404_RWSStatus_Multiple_Recording_Failed_Legacy_394</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_394</test_case_id>
    <test_objective>Check whether the Multiple Failed recording details using legacy are getting synced with RWS  or not when the server is up after reconnecting</test_objective>
...
3. In five seconds gap , Schedule two 1 min legacy recording with  invalid ocap id's 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Multiple_Recording_Failed_Legacy_394</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Multiple_Recording_Failed_Legacy_394');
