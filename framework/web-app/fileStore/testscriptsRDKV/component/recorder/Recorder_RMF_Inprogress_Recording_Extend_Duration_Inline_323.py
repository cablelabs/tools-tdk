...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Inprogress_Recording_Extend_Duration_Inline_323</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To extend the duration of an inprogress recording</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_323</test_case_id>
    <test_objective>To extend the duration of an inprogress recording using inline</test_objective>
...
4.After 30 sec , extend the duration of recording by 3 minutes using updateSchedule message 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Recording_Extend_Duration_Inline_323</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Recording_Extend_Duration_Inline_323');
