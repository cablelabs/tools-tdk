...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_97</test_case_id>
    <test_objective>Recorder- This test is to test the DVR Protocol Version being advertised during Cancel Recording through Inline Mechanism</test_objective>
...
4. Cancel the recording which in progressusing inline mechanism,.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_DVR_Protocol_Ad_DuringInlineCancel_97</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
