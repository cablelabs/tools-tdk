...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_185</test_case_id>
    <test_objective>Check that recording status of hot inline recording that have not been sent due to RWS connection failure, need to be re-sent once RWS connectivity is re-established</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a hot recording using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_HotRecWithRWSDown_CheckRecStatus_185</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
