...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Same_RequestedStart_And_StartTime_Legacy_372</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recording with same requestedStart and start time values</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_372</test_case_id>
    <test_objective>To check a recording which has RequestedStart  value same as of start time using legacy</test_objective>
...
3.Schedule a hot recording with RequestedStart has value same as of start time using legacy
4. Wait for the recording to complete
5. Check whether the recording is NOT have any undesirable values
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Same_RequestedStart_And_StartTime_Legacy_372</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Same_RequestedStart_And_StartTime_Legacy_372');
