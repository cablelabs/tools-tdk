...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_172</test_case_id>
    <test_objective>Verify that generation ID is reset on reboot if corruption happens after scheduling legacy hot recording</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot recording using legacy mechanism with genid=test3b and send to TDK Recorder Simulator server which is present in TM.
...
2.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_GenerationId_Reset_OnCorruption_LegacyHotRec_172</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
