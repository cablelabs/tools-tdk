...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Update_Restore_InprogressRec_Deletion_Priority_Inline_363</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_363</test_case_id>
    <test_objective>To update and restore the deletion priority of an in progress recording using inline</test_objective>
...
3.Schedule a hot P4 recording of 3 minute duration  using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Update_Restore_InprogressRec_Deletion_Priority_Inline_363</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Update_Restore_InprogressRec_Deletion_Priority_Inline_363');
