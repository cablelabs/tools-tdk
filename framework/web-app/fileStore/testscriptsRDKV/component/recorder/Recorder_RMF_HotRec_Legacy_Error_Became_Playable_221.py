...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_221</test_case_id>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule 4 hot recordings of 10 min duration using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
2.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HotRec_Legacy_Error_Became_Playable_221</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
