...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_RecStartedEarly_StartedIncomplete_Inline_86</name>
  <primitive_test_id/>
...
more than 30 seconds from requested (note: not to be confused with expectedStart, which is the air time listed in the guide)</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_86</test_case_id>
...
3.Frame the in line json message through RecorderAgent/Python lib interface to schedule the current recording of 5 minutes and 
...
recObj.configureTestCase(ip,port,'Recorder_RMF_RecStartedEarly_StartedIncomplete_Inline_86');
...
def ScheduleRec():
	...
	if "SUCCESS" in recLoadStatus.upper():
		...
		duration = "300000";
        	...
        	#Frame json message
		jsonMsg = "{\"updateSchedule\":{\"requestId\":\""+requestID+"\",\"schedule\":[{\"recordingId\":\""+ recordingID+"\",\"locator\":[\"ocap://"+ocapId+"\"],\"epoch\":"+now+",\"start\":"+startTime+",\"duration\":"+duration+",\"properties\":{\"requestedStart\":0,\"title\":\"Recording_"+recordingID+"\"},\"bitRate\":\"HIGH_BIT_RATE\",\"deletePriority\":\"P3\"}]}}"
