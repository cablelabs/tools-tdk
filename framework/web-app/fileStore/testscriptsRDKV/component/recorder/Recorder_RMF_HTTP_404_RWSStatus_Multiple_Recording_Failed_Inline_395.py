...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HTTP_404_RWSStatus_Multiple_Recording_Failed_Inline_395</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Checking whether the Multiple Failed recording details are getting synced with RWS  or not when the server is up after reconnecting</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_395</test_case_id>
    <test_objective>Check whether the Multiple Failed recording details using inline are getting synced with RWS  or not when the server is up after reconnecting</test_objective>
...
3. In five seconds gap , Schedule two 1 min  inline recordings with invalid ocap id's
4.Wait for 30 seconds for connection retry requests to happen
5. Clear the RWS status server error 404
6.Check whether Recorder has send the FAILED status for both the recordings after reconnecting to RWS Status Server
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Multiple_Recording_Failed_Inline_395</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_HTTP_404_RWSStatus_Multiple_Recording_Failed_Inline_395');
