...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_253</test_case_id>
    <test_objective>Schedule a recording using legacy and verify it is getting completed successfully and reboot the box and verify the recording status as complete</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Status_OfRecording_After_Reboot_Legacy_253</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
