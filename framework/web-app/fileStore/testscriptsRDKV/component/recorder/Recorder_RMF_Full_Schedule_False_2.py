...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Full_Schedule_False_2</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_2 - Recorder- To preserve all current and future schedules when updateSchedule is received with fullSchedule=false</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_2</test_case_id>
    <test_objective>Recorder- To preserve all current and future schedules when updateSchedule is received with fullSchedule=false</test_objective>
...
4.Another current recording will be scheduled with generation id = 0 and fullSchedule = false
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Full_Schedule_False_2</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Full_Schedule_False_2');
