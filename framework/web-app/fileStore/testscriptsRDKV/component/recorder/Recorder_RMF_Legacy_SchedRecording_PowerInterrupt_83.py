...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Legacy_SchedRecording_PowerInterrupt_83</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check that a legacy recording scheduled for future time is iterrupted by settop reboot is reported with Error=POWER_INTERRUPTION</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_83</test_case_id>
    <test_objective>Check that a legacy recording scheduled for future time is iterrupted by settop reboot is reported with Error=POWER_INTERRUPTION</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Legacy_SchedRecording_PowerInterrupt_83</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_Legacy_SchedRecording_PowerInterrupt_83');
