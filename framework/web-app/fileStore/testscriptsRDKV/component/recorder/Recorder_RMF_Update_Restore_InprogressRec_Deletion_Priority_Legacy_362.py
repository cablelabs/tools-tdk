...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Update_Restore_InprogressRec_Deletion_Priority_Legacy_362</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Update and restore the deletion priority of an in progress recording</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_362</test_case_id>
    <test_objective>To update and restore the deletion priority of an in progress recording using legacy</test_objective>
...
3.Schedule a hot P4 recording of 3 minute duration  using legacy
4. Update the delete priority to P0 and restore the delete priority to P4 when the recording is in progress.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Update_Restore_InprogressRec_Deletion_Priority_Legacy_362</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Update_Restore_InprogressRec_Deletion_Priority_Legacy_362');
			    ...
			    expResponse = "updateRecordings";
			        ...
			        if 'acknowledgement' not in actResponse:
                                    ...
                                    if 'NOTFOUND' not in recordingData:
                                        ...
                                        reqRecording = {"recordingId":recordingID,"duration":180000,"deletePriority":"P4"}
