...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Hot_Future_Rec_Same_OcapId_Legacy_382</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Hot and Future recording with same OCAP id.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_382</test_case_id>
    <test_objective>To do Hot and Future recording with same OCAP id using legacy</test_objective>
...
3. Schedule a hot recording of 3 minte duration and a future recording of 1 minute duration with start time 1 minute on same channel using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Hot_Future_Rec_Same_OcapId_Legacy_382</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Hot_Future_Rec_Same_OcapId_Legacy_382');
		...
		if 'acknowledgement' not in actResponse:
                    ...
                    print "Received Empty/Error status";
                        ...
                        if 'NOTFOUND' not in recordingData1:
                                ...
                                if  "FALSE" in ret1 and "FALSE" not in ret2:
                                    tdkTestObj.setResultStatus("SUCCESS");
