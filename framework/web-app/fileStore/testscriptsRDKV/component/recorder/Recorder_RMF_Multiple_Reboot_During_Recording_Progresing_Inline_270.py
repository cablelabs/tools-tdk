...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_270</test_case_id>
    <test_objective>To check the status of recording which is interrupted multiple times using reboot using inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a   recording with long duration  using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Multiple_Reboot_During_Recording_Progresing_Inline_270</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
