...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Verify_RedundantStatus_CancelRecording_144</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_144 - Recorder should not send redundant recording statuses; new status only needs to be sent if number of playable segments has changed or status has changed (change in Error code only does not require status to be re-sent) - Checking with cancel recording status message</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_144</test_case_id>
    <test_objective>Recorder should not send redundant recording statuses; new status only needs to be sent if number of playable segments has changed or status has changed (change in Error code only does not require status to be re-sent) - Checking with cancel recording status message</test_objective>
...
4. Schedule another recording to cancel the recording which in progress using inline mechanism.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_RedundantStatus_CancelRecording_144</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_RedundantStatus_CancelRecording_144');
