...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_386</test_case_id>
    <test_objective>Recordings with missing XML's should report as Status=Erased, Error=ORPHANED in the next full sync using legacy</test_objective>
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Rec_Erased_Delete_XML_Legacy_386</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
