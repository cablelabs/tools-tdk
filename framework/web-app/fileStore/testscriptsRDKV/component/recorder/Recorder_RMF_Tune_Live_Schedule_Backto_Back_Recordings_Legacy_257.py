...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Tune_Live_Schedule_Backto_Back_Recordings_Legacy_257</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_257 - Check whether back to back recordings are completed successfully when live playback happens on the same channel</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_257</test_case_id>
    <test_objective>To check whether back to back recordings are completed successfully when the live playback also happens on the same channel usnig legacy</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a  recording of 6 min duration with  using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
5.Wait for  5 more mins after the recording completion .Then schedule an another recording on same channel for 6 mins 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Tune_Live_Schedule_Backto_Back_Recordings_Legacy_257</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Tune_Live_Schedule_Backto_Back_Recordings_Legacy_257');
	        ...
	        #Execute updateSchedule
                ...
                if expResponse in actResponse:
                    ...
                    if 'acknowledgement' not in actResponse:
                        ...
                        #waiting for 5 mins after recording completes
                        sleep(660);
                        ...
                        tdkTestObj.executeTestCase(expectedResult);
                        actResponse = recorderlib.callServerHandlerWithMsg('updateMessage',jsonMsg_new,ip);
