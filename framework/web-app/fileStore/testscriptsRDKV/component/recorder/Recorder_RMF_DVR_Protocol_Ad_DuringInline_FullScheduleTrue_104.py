...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_DVR_Protocol_Ad_DuringInline_FullScheduleTrue_104</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder- This test is to test the DVR Protocol Version being advertised during full schedule true Inline Mechanism		-CT_DVR_Protocol_104</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_104</test_case_id>
    <test_objective>Recorder- This test is to test the DVR Protocol Version being advertised during full schedule true Inline Mechanism</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_DVR_Protocol_Ad_DuringInline_FullScheduleTrue_104</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_DVR_Protocol_Ad_DuringInline_FullScheduleTrue_104');
