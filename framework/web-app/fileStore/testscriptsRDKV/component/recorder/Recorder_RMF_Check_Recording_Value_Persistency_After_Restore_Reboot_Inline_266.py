...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_Recording_Value_Persistency_After_Restore_Reboot_Inline_266</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_266 - To check whether there is no recording field value changes after restoring and reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_266</test_case_id>
    <test_objective>To check whether there is no recording field value changes after restoring and reboot a recording using legacy</test_objective>
...
4.Update the priority to P1 and after that restore the priority to P4
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Recording_Value_Persistency_After_Restore_Reboot_Inline_266</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_Recording_Value_Persistency_After_Restore_Reboot_Inline_266');
