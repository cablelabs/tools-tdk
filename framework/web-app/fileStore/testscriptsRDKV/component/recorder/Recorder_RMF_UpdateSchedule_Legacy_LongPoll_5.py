...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>Recorder_RMF_UpdateSchedule_Legacy_LongPoll_5</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_5 - Recorder- To accept updateSchedule messages via legacy style</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_5</test_case_id>
    <test_objective>Recorder- To accept updateSchedule messages via legacy style</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the current recording generation id = 0 and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_UpdateSchedule_Legacy_LongPoll_5</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_UpdateSchedule_Legacy_LongPoll_5');
