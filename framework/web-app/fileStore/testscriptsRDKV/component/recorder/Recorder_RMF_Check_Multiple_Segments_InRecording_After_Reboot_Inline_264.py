...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_Multiple_Segments_InRecording_After_Reboot_Inline_264</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_264 -Check whether after Reboot segmented recordings are created for In progress recordings</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_264</test_case_id>
    <test_objective>To Check whether after Reboot segments are created for recordings which are In progress using inline</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording of 15 min duration with  using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
5.Rebbot the box when the  recording is in progress
6.Then wait for the recording to complete and getrecordings message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
7. Check whether the content field of corresponding recording have multiple segements
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Multiple_Segments_InRecording_After_Reboot_Inline_264</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_Check_Multiple_Segments_InRecording_After_Reboot_Inline_264');
