...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_273</test_case_id>
    <test_objective>To test for segmented recordings by rebooting the box when that recording is in StartedWithError using legacy</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording of long min duration with  using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Multiple_Segments_ForRecording_StartedWithError_Legacy_273</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
