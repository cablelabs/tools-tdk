...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_PowerInterrupt_For_CompletedRec_197</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_197 - Recorder should not send impossible out-of-sequence statuses - Do a power interrupt for a completed recording. Status should not be COMPLETE followed by FAILED</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_197</test_case_id>
    <test_objective>Recorder should not send impossible out-of-sequence statuses - Do a power interrupt for a completed recording. Status should not be COMPLETE followed by FAILED</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_PowerInterrupt_For_CompletedRec_197</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_PowerInterrupt_For_CompletedRec_197');
			...
			value = msg['recordingStatus']["initializing"];
	            ...
	            if "TRUE" in value.upper():
                        ...
                        if 'NOTFOUND' not in recordingData:
                            ...
                            if "COMPLETE" in value.upper() and "INCOMPLETE" not in value.upper():
                                tdkTestObj.setResultStatus("SUCCESS");
