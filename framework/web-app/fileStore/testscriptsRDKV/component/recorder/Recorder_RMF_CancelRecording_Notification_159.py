...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <test_objective>Recoder to send USER_STOP error notification at different timestamp when multiple recording in progress are cancelled</test_objective>
...
4. Send cancel recording message for all the scheduled recordings using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_CancelRecording_Notification_159</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
