...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Same_RequestedStart_And_StartTime_Inline_373</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_373</test_case_id>
    <test_objective>To check a recording which has RequestedStart  value same as of start time using inline</test_objective>
...
3.Schedule a hot recording with RequestedStart has value same as of start time using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Same_RequestedStart_And_StartTime_Inline_373</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Same_RequestedStart_And_StartTime_Inline_373');
