...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_RecStatus_InvalidSRC_Fullsync_Inline_246</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_246 - Recorder- To check whether Recordings transitioned to failed not appearing as erased</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_246</test_case_id>
    <test_objective>To check whether  Recordings transitioned to failed are not appearing as Erased using inline.</test_objective>
...
3. Schedule a recording with an invalid/non existent ocap Id
4. Recorder should send "Failed" status to the simulator
5. After that check whether the recording is not transitioned to erased state by using getrecordings msg.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_RecStatus_InvalidSRC_Fullsync_Inline_246</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_RecStatus_InvalidSRC_Fullsync_Inline_246');
