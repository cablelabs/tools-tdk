...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_359</test_case_id>
    <test_objective>To check recordings by rebooting the box when that recording is in StartedWithError using inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording of long  duration with  using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
4.Reboot the box before recording starts adn wait for the recording to complete
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Recording_StartedWithError_Incomplete_Inline_359</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
