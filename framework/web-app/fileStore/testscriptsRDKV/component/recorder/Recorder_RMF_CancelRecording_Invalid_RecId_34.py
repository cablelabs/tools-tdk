...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_CancelRecording_Invalid_RecId_34</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_34</test_case_id>
    <test_objective>Recorder to send error when trying to cancel an invalid recording Id.</test_objective>
...
4. Schedule another recording to cancel the recording for an invalid recording id.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_CancelRecording_Invalid_RecId_34</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_CancelRecording_Invalid_RecId_34');
