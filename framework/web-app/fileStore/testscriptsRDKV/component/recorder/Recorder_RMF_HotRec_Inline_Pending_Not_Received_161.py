...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_HotRec_Inline_Pending_Not_Received_161</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should never send Pending status when a hot inline recording is scheduled</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_161</test_case_id>
    <test_objective>Check that recorder not sending status = Pending when a inline hot recording is scheduled</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot recording using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
Checkpoint 2 Get the response from recorder and verify that status=Pending not sent for the recording from recorder.</except_output>
    <priority>High</priority>
    <test_stub_interface>RecorderAgent
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_HotRec_Inline_Pending_Not_Received_161</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_HotRec_Inline_Pending_Not_Received_161');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	loadmoduledetails = obj.getLoadModuleDetails();
        ...
        #Schedule Hot Inline Recording with 3 mins duration
        duration = "180000";
        startTime = "0";
        genIdInput = "TDK456";
