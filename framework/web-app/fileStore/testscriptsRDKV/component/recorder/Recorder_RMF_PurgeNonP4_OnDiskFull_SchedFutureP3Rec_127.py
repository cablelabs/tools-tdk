...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_PurgeNonP4_OnDiskFull_SchedFutureP3Rec_127</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Verify that recorder deletes non-P4 recordings before disk is completely full to allow new scheduled future P3 recording</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_127</test_case_id>
    <test_objective>Verify that recorder deletes non-P4 recordings before disk is completely full to allow new scheduled future P3 recording</test_objective>
...
5. hdd should be full with atleast 1 P3 and P4 recordings.</pre_requisite>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a future P3 recording for 1 min and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_PurgeNonP4_OnDiskFull_SchedFutureP3Rec_127</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_PurgeNonP4_OnDiskFull_SchedFutureP3Rec_127');
