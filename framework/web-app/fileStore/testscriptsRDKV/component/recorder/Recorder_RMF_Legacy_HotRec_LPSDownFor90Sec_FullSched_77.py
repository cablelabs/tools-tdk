...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Legacy_HotRec_LPSDownFor90Sec_FullSched_77</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check that recorder requests a full schedule when heartbeat dots are not received on Longpoll connection for 90 seconds when legacy hot recording is scheduled</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_77</test_case_id>
    <test_objective>Check that recorder requests a full schedule when heartbeat dots are not received on Longpoll connection for 90 seconds when legacy hot recording is scheduled</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Legacy_HotRec_LPSDownFor90Sec_FullSched_77</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Legacy_HotRec_LPSDownFor90Sec_FullSched_77');
