...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Delete_Rec_Cancel_Rec_Reboot_Legacy_454</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_454</test_case_id>
    <test_objective>Recorder should persist the recording field values after cancelling a legacy recording which was updated to priority P0 followed by a reboot</test_objective>
...
2.Schedule a hot legacy P4 recording of 4 minutes duration
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Delete_Rec_Cancel_Rec_Reboot_Legacy_454</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Delete_Rec_Cancel_Rec_Reboot_Legacy_454');
