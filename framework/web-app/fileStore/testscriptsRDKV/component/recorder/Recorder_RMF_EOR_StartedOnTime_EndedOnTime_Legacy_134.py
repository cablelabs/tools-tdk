...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_EOR_StartedOnTime_EndedOnTime_Legacy_134</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_135</test_case_id>
    <test_objective>check that Recorder sends an end-of-recording status if it ever sent any start-of-recording status for recording started on time  and ended on time.</test_objective>
...
3.Frame the inline json message through RecorderAgent/Python lib interface to schedule the current recording 
  of 5 minutes and send to TDK Recorder Simulator server which is present in TM.
4.Wait for the recording to completes.
5.Reboot the STB.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_EOR_StartedOnTime_EndedOnTime_Legacy_134</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_EOR_StartedOnTime_EndedOnTime_Legacy_134');
