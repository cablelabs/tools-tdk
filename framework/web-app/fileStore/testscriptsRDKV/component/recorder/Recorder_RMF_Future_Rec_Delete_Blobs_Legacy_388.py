...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Future_Rec_Delete_Blobs_Legacy_388</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_388</test_case_id>
    <test_objective>Future recording with missing standard blob should 
 resume after reboot  and report as Status=INCOMPLETE ,Error=STARTED_LATE using legacy. It should not be reported as ORPHANED.</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a future recording of 13 minutes duration with 40 seconds as start time using legacy
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Future_Rec_Delete_Blobs_Legacy_388</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Rec_Delete_Blobs_Legacy_388');
