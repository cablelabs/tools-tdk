...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_366</test_case_id>
    <test_objective>Recorder should send the full sync details for an updateSchedule message if the last full sync was suppressed with server connection issue using legacy</test_objective>
...
9.Send an updateSchedule message using legacy and check whether reocrder responds to this updateSchedule message with full sync details
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_HTTP_404_RWSStatus_Suppress_Fullsync_UpdateSchedule_Legacy_366</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
