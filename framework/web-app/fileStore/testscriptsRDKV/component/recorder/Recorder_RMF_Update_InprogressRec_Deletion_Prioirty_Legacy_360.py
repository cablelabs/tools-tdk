...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Update_InprogressRec_Deletion_Prioirty_Legacy_360</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_360</test_case_id>
    <test_objective>To update the deletion priority of an in progress recording using legacy</test_objective>
...
3.Schedule a hot P4 recording of 2 minute duration  using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Update_InprogressRec_Deletion_Prioirty_Legacy_360</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Update_InprogressRec_Deletion_Prioirty_Legacy_360');
