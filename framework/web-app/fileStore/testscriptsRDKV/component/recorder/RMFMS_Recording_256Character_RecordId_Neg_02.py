...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RECORDER_RECORDID_256CHARCTER_02</test_case_id>
    <test_objective>To Initiate recording with recording Id of length 256 characters and value given is negative.</test_objective>
...
2.TestMgr_Recorder_checkRecording_status</test_stub_interface>
    <test_script>RMFMS_Recording_256Character_RecordId_Neg_02</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
	...
	genIdInput = requestID;
        ...
        if Id:
                ...
                actualresult = tdkTestObj.getResult();
     	        RequestURL = "{\"updateSchedule\":{\"requestId\":\""+requestID+"\",\"generationId\":\""+genIdInput+"\",\"schedule\":[{\"recordingId\":\""+recording_id+"\",\"locator\":[\"ocap://0x125d\"],\"epoch\":curTime,\"start\":0,\"duration\":"+duration+",\"properties\":{\"requestedStart\":0,\"title\":\"Recording_"+recording_id+"\"},\"bitRate\":\"HIGH_BIT_RATE\",\"deletePriority\":\"P3\"}]}}"
