...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_146</test_case_id>
    <test_objective>Recorder should not send redundant recording statuses; new status only needs to be sent if number of playable segments has changed or status has changed (change in Error code only does not require status to be re-sent) - Checking by creating power interruption failure</test_objective>
...
4. Reboot the STB when the recordings are in progress.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_RedundantStatus_PowerInterrupt_146</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
