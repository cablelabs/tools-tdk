...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Recording_PowerInterrupt_Resume_StartedLate_Inline_413</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recording with first segment duration less than five seconds should report as STARTED_LATE even if the recording is NOT corrupted before reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_413</test_case_id>
    <test_objective>Recording with first segment duration less than five seconds should report as STARTED_LATE using inline</test_objective>
...
3.Schedule a hot recording of 7 minute duration with 30 seconds start time using inline
4.Wait for the 25 seconds and reboot the box
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Recording_PowerInterrupt_Resume_StartedLate_Inline_413</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Recording_PowerInterrupt_Resume_StartedLate_Inline_413');
