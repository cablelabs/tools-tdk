...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Check_StatusOf_FutureRecWith_Expired_Endtime_Legacy_352</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_352</test_case_id>
    <test_objective>To check the status of a future recording which has an expired end time using legacy</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording with an expired end time using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_StatusOf_FutureRecWith_Expired_Endtime_Legacy_352</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_StatusOf_FutureRecWith_Expired_Endtime_Legacy');
