...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_245</test_case_id>
    <test_objective>To check whether  Recordings transitioned to failed are not appearing as Erased using legacy.</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_RecStatus_InvalidSRC_Fullsync_Legacy_245</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
