...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Extend_Future_Recording_EndtimeIn_Past_Inline_357</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Extend a future recording with an end time in past</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_357</test_case_id>
    <test_objective>To extend a future recording with end time in past using inline</test_objective>
...
3.Schedule a future recording of 2 minutes duration with start time  1 minutes using inline
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Extend_Future_Recording_EndtimeIn_Past_Inline_357</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Extend_Future_Recording_EndtimeIn_Past_Inline_357');
	...
	sleep(10);
		...
		print "Retrieve Status Details: %s"%actResponse;
                if 'acknowledgement' in actResponse:
                    ...
                    jsonMsg = "{\"updateSchedule\":{\"requestId\":\""+requestID+"\",\"generationId\":\"TDK123\",\"fullSchedule\":false,\"dvrProtocolVersion\":\"7\",\"schedule\":[{\"recordingId\":\""+recordingID+"\",\"epoch\":"+epoch_time+",\"start\":"+startTime+",\"duration\":"+newDuration+",\"bitRate\":\"HIGH_BIT_RATE\"}]}}";
			...
			print "Retrieve Status Details: %s"%actResponse;
				...
				if "ERASED" in statusValue.upper():
                                    ...
                                    print "Future recording extended to a past end time";
                            else:
                                tdkTestObj.setResultStatus("FAILURE");
