...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inprogress_Rec_Delete_Blobs_Reboot_Legacy_414</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check the status of an in-progress recording after deleting the blobs followed by a reboot.</synopsis>
  <groups_id/>
...
3.Schedule a hot recording of 7 minute duration  using legacy
4.Wait for the recording to complete partailly.
5. Delete the blobs of the recording (Do NOT delete backup file) and reboot the box
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Rec_Delete_Blobs_Reboot_Legacy_414</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Rec_Delete_Blobs_Reboot_Legacy_414');
