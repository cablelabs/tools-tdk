...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_301</test_case_id>
    <test_objective>RWS status server should send HTTP 404 when the server is enabled with HTTP 404 error and also after retry recorder should send error code RDK-10028 using inline</test_objective>
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_404_RWSStatus_Inline_301</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
