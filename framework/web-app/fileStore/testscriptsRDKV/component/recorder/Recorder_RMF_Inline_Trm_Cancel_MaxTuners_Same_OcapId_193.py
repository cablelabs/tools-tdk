...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_193</test_case_id>
    <test_objective>Recorder to send TRM_CANCELLED error if recording is scheduled for the max number of tuners available with different ocap id and then again scheduling one more recording with same ocap id already used via inline</test_objective>
...
4.Again schedule one more recording with same ocap id which is already in use via inline long poll notification
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_Trm_Cancel_MaxTuners_Same_OcapId_193</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
