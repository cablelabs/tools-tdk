...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_314</test_case_id>
    <test_objective>RWS status server should send HTTP 401 when the server is enabled with HTTP 401 error and also during full sync after retry recorder should send error code RDK-10028</test_objective>
...
3.Configure RWS status server and RWS secure status server with error 401 and reboot the box
...
4.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_HTTP_401_RWSStatus_Fullsync_314</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
