...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_RECORDER_RECORDID_256CHARCTER_05</test_case_id>
    <test_objective>To Initiate recording with recording Id of length more then 256 characters.</test_objective>
...
4. In rmfconfig.ini file the parameters “FEATURE.LONGPOLL.URL”,"FEATURE.RWS.GET.URL" and "FEATURE.RWS.POST.URL" should be pointing to DVRSimulator</pre_requisite>
    ...
    <input_parameters>Json Interface- source id = &lt; greater than 256 character length&gt;, duration recording_id, start_time.</input_parameters>
    <automation_approch>1. Test Mgr loads the RecorderAgent via tdk test agent.
2. Test Mgr fetches the source_id/ocap_id mapped in streaming details page in test manager, frames greater than 256 character length recordId, duration, 
...
2.TestMgr_Recorder_checkRecording_status</test_stub_interface>
    <test_script>RMFMS_Recording_Grt_Than_256Character_RecordId_05</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
