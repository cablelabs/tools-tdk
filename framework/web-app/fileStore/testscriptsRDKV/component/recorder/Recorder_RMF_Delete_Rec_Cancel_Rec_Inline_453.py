...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Delete_Rec_Cancel_Rec_Inline_453</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_453</test_case_id>
    <test_objective>Recorder should persist the recording field values after cancelling a  inline recording which was updated to priority P0.</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Delete_Rec_Cancel_Rec_Inline_453</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Delete_Rec_Cancel_Rec_Inline_453');
