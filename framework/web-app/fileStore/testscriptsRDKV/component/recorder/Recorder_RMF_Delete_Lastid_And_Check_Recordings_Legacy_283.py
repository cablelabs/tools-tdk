...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_283</test_case_id>
    <test_objective>Reboot the box after removing lastid.dat file from recdbser folder and reboot.All the recordings  should be available in box using legacy</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Delete_Lastid_And_Check_Recordings_Legacy_283</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
