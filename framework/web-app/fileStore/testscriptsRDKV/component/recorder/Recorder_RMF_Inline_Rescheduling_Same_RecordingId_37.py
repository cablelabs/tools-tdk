...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_37</test_case_id>
    <test_objective>Recorder-To support canceling of a recording when rescheduling it with the same Recording ID via inline</test_objective>
...
4. Reschedule will be done with the same recording Id via inline mechanism.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_Rescheduling_Same_RecordingId_37</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
