...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_DVR_Protocol_Changed_Fullsync_Pending_Legacy_428</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_428</test_case_id>
    <test_objective>Recorder should sent fullsync response to notify pending status for recordings using legacy which are yet to start by ignoring the dvr protocol versions</test_objective>
...
2.Schedule a hot recording and wait for full sync to happen then Schedule a  future legacy recording of 10 minute duration with 1 minute start time using dvr protocol version as 6.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_DVR_Protocol_Changed_Fullsync_Pending_Legacy_428</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_DVR_Protocol_Changed_Fullsync_Pending_Legacy_428');
