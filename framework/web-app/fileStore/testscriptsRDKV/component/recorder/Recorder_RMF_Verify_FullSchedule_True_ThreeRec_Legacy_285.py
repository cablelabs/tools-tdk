...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Legacy_285</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_285</test_case_id>
    <test_objective>Recorder should cancel all the three recordings when an update schedule message is received with Full Schedule as true using legacy</test_objective>
...
3.Schedule 1 hot recording and 2 future recording using legacy
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Legacy_285</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Legacy_285');
