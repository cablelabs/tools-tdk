...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Inline_PowerInterrupt_Notification_54</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_54 - Recoder to send power interruption error notification for multiple scheduling at different timestamp via inline</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_54</test_case_id>
    <test_objective>Recoder to send power interruption error notification for multiple scheduling at different timestamp using inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule the multiple current recordings using inline mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_PowerInterrupt_Notification_54</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inline_PowerInterrupt_Notification_54');
 	...
 	ScheduleResponse = recorderlib.callServerHandlerWithMsg('updateInlineMessage',SchedulejsonMsg,ip);
		...
		print "Retrieve Status Details: %s"%actResponse;
			...
			print "Recording 1 data : " , recordingData
                        ...
                        print "\nRecording 2 data : ", SecondrecordingData
