...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Check_RecStatus_After_Delete_Lastid_Metadata_Inline_447</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_447</test_case_id>
    <test_objective>Recorder should persist the inline recording details when lastid.dat file and meta data (including backup )are corrupted</test_objective>
...
2.Schedule a hot inline recording of 2 minutes duration.
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Check_RecStatus_After_Delete_Lastid_Metadata_Inline_447</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_RecStatus_After_Delete_Lastid_Metadata_Inline_447');
