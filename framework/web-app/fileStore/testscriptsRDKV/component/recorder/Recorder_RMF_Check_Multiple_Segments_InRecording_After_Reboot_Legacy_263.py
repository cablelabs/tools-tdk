...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_263</test_case_id>
    <test_objective>To Check whether after Reboot segments are created for recordings which are In progress using leagcy</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording of 15 min duration with  using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Check_Multiple_Segments_InRecording_After_Reboot_Legacy_263</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
