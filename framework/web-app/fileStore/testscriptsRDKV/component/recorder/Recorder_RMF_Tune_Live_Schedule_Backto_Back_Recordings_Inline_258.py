...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Tune_Live_Schedule_Backto_Back_Recordings_Inline_258</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_258 - Check whether back to back recordings are completed successfully when live playback happens on the same channel</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_258</test_case_id>
    <test_objective>To check whether back to back recordings are completed successfully when the live playback also happens on the same channel usnig inline</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Tune_Live_Schedule_Backto_Back_Recordings_Inline_258</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Tune_Live_Schedule_Backto_Back_Recordings_Inline_258');
