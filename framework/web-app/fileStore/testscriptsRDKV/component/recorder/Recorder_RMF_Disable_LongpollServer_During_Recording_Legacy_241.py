...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Disable_LongpollServer_During_Recording_Legacy_241</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recorder_DVR_Protocol_241 -  Recorder- To check whether recorder sends error or not for  the loss of connection with Long poll Server during recording operations</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_241</test_case_id>
    <test_objective>To check whether recorder sends error or not for  the loss of connection with Long poll Server during recording operations using legacy</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot P3 recording of 1min duration with using legacy mechanism and send to TDK Recorder Simulator server which is present in TM
3.Configure alternate URL for the long poll server
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_Disable_LongpollServer_During_Recording_Legacy_241</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Disable_LongpollServer_During_Recording_Legacy_241');
