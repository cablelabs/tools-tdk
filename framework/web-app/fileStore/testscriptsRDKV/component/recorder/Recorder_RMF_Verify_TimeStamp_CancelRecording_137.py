...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Verify_TimeStamp_CancelRecording_137</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_137 - Recorder should send timestamp=&lt;the time in millis that something last changed&gt; in recording status while cancelling the recording in progress</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_137</test_case_id>
    <test_objective>Recorder should send timestamp=&amp;lt;the time inÂ millis that something last changed&amp;gt; in recording status while cancelling the recording in progress</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Verify_TimeStamp_CancelRecording_137</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_TimeStamp_CancelRecording_137');
