...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>Recorder_RMF_Inprogress_Recording_Extend_Duration_Before_Reboot_Legacy_326</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_326</test_case_id>
    <test_objective>To extend the duration of an inprogress recording before reboot using legacy</test_objective>
...
4.Extend the duration of  recording by 8 minutes using updateSchedule message 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inprogress_Recording_Extend_Duration_Before_Reboot_Legacy_326</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Inprogress_Recording_Extend_Duration_Before_Reboot_Legacy_326');
