...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>CT_Recoder_DVR_Protocol_1 - Recorder-To replace all current and future schedules when updateSchedule is received with fullSchedule=true</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_1</test_case_id>
    <test_objective>Recorder-To replace all current and future schedules when updateSchedule is received with fullSchedule=true</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Full_Schedule_True_1</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Full_Schedule_True_1');
