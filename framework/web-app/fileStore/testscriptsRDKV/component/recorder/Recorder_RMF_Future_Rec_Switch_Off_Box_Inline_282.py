...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Future_Rec_Switch_Off_Box_Inline_282</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_282</test_case_id>
    <test_objective>Recorder should sent erased status for a recording where the  box is in off state for the whole duration of that recording using inline</test_objective>
...
3.Schedule a future recording and reboot the box before recording starts
4.Recording end time should be before the box is up
5.Do a full sync
6Check whether the recording status is erased or not
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Future_Rec_Switch_Off_Box_Inline_282</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Future_Rec_Switch_Off_Box_Inline_282');
