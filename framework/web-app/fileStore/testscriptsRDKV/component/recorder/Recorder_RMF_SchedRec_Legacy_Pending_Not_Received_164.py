...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_SchedRec_Legacy_Pending_Not_Received_164</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recorder should never send Pending status when a future legacy recording is scheduled</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_164</test_case_id>
    <test_objective>Check that recorder not sending status = Pending when a legacy future recording is scheduled</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_SchedRec_Legacy_Pending_Not_Received_164</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'Recorder_RMF_SchedRec_Legacy_Pending_Not_Received_164');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	loadmoduledetails = obj.getLoadModuleDetails();
        ...
        #Schedule Future Legacy Recording with 3 mins duration
        duration = "180000";
        startTime = "60000";
        genIdInput = "TDK456";
