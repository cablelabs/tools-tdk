...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Recording_Corrupt_Resume_StartedLate_Inline_411</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_411</test_case_id>
    <test_objective>Recording which is corrupted and with first segment duration less than five seconds should report as STARTED_LATE using inline</test_objective>
...
4.Wait for the recording to complete partially and delete the Meta data of the recording (Do NOT delete backup file)
...
2.TestMgr_Recorder_ExecuteCmd</test_stub_interface>
    <test_script>Recorder_RMF_Recording_Corrupt_Resume_StartedLate_Inline_411</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Recording_Corrupt_Resume_StartedLate_Inline_411');
