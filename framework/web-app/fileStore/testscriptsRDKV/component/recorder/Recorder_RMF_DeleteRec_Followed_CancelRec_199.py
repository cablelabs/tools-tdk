...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_199</test_case_id>
    <test_objective>Recorder not to send Erased status followed by Incomplete if a deleted recording is cancelled</test_objective>
...
4. Once the recording is completed, delete the completed recording Id.
5. Now, cancel the deleted recording id and then reboot the STB
6. noUpdate schedule message will be send to TDK Recorder Simulator server once STB is up to get the list of recordings.
7. Recorder to send ERASED status and not Incomplete/Failed
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_DeleteRec_Followed_CancelRec_199</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
