...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_126</test_case_id>
    <test_objective>Verify that recorder deletes non-P4 recordings before disk is completely full to allow new scheduled future P4 recording</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a future P4 recording for 1 min and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_PurgeNonP4_OnDiskFull_SchedFutureP4Rec_126</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
