...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Delete_Rec_Cancel_Rec_Reboot_Inline_455</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Recording field values should persist after cancelling a recording which was updated to priority P0 followed by a reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_455</test_case_id>
    <test_objective>Recorder should persist the recording field values after cancelling a inline recording which was updated to priority P0 followed by a reboot</test_objective>
...
2.Schedule a hot inline P4 recording of 4 minutes duration
3.Update the recording priority to P0 from P4
...
6.Reboot the box and Check the recording details using getRecordings message also
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Delete_Rec_Cancel_Rec_Reboot_Inline_455</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Delete_Rec_Cancel_Rec_Reboot_Inline_455');
		...
		if 'acknowledgement' not in actResponse:
			...
			if 'acknowledgement' not in actResponse:
                            ...
                            if 'NOTFOUND' not in recordingData:
                                ...
                                if "INCOMPLETE" in status.upper() and "USER_STOP" in error.upper() and "P0" in deletePriority.upper():
                                    tdkTestObj.setResultStatus("SUCCESS");
