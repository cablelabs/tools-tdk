...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>Recorder_RMF_Tune_Live_Schedule_Future_Rec_Reboot_Legacy_261</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_261</test_case_id>
    <test_objective>To check whether recordings should always transition to "StartedInComplete" Not "Started" if it has started with status "StartedWithError" using legacy</test_objective>
...
4.RecorderAgent / Python lib interface will frame the json message to schedule a  future recording of 2 min duration with  using legacy mechanism and send to TDK Recorder Simulator server which is present in TM.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Tune_Live_Schedule_Future_Rec_Reboot_Legacy_261</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Tune_Live_Schedule_Future_Rec_Reboot_Legacy_261');
