...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>Recorder_RMF_Recording_PowerInterrupt_Resume_StartedLate_Legacy_412</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_412</test_case_id>
    <test_objective>Recording with first segment duration less than five seconds should report as STARTED_LATE using legacy</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Recording_PowerInterrupt_Resume_StartedLate_Legacy_412</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Recording_PowerInterrupt_Resume_StartedLate_Legacy_412');
