...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_WITH_REQUESTED_START_Legacy_175</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_175</test_case_id>
...
3.Frame the legacy json message with requestedStart in it through RecorderAgent/Python lib interface to schedule the 
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_WITH_REQUESTED_START_Legacy_175</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_WITH_REQUESTED_START_Legacy_175');
