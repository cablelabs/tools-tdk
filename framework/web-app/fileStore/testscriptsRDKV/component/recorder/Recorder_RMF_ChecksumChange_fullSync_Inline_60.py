...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_60</test_case_id>
    <test_objective>Recorder should do a full sync only on reboot, but only if there has been any change in completed recordings checksum.(inline)</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_ChecksumChange_fullSync_Inline_60</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
