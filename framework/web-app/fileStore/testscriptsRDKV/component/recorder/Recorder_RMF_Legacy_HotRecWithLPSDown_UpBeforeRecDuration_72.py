...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>Recorder_RMF_Legacy_HotRecWithLPSDown_UpBeforeRecDuration_72</name>
  <primitive_test_id/>
  <primitive_test_name>Recorder_SendRequest</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test that a legacy hot recording scheduled while Longpoll is down starts as soon as connection is re-established before duration of recording.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_72</test_case_id>
    <test_objective>Test that a legacy hot recording scheduled while Longpoll is down starts as soon as connection is re-established before duration of recording.</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Legacy_HotRecWithLPSDown_UpBeforeRecDuration_72</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Legacy_HotRecWithLPSDown_UpBeforeRecDuration_72');
