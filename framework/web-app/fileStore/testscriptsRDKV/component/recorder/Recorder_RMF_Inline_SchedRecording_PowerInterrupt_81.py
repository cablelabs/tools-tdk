...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recoder_DVR_Protocol_81</test_case_id>
    <test_objective>Check that an inline recording scheduled for future time is iterrupted by settop reboot is reported with Error=POWER_INTERRUPTION</test_objective>
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_Inline_SchedRecording_PowerInterrupt_81</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
