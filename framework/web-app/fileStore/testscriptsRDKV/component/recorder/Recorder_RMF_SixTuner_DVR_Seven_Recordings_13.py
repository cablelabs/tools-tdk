...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_13</test_case_id>
    <test_objective>Recorder-To check scheduling seven consecutive current recording.</test_objective>
...
6.Get all the Tuner States using the TRM_Agent to confirm all the tuner are occupied and check the state of the seventh recording.
...
1.TestMgr_Recorder_SendRequest</test_stub_interface>
    <test_script>Recorder_RMF_SixTuner_DVR_Seven_Recordings_13</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
