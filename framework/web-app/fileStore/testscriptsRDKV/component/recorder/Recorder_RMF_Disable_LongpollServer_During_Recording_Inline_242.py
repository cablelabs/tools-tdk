...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_Recorder_DVR_Protocol_242</test_case_id>
    <test_objective>To check whether recorder sends error or not for  the loss of connection with Long poll Server during recording operations using inline</test_objective>
...
3.RecorderAgent / Python lib interface will frame the json message to schedule a hot P3 recording of 1min duration with using inline mechanism and send to TDK Recorder Simulator server which is present in TM
...
3.TestMgr_Recorder_checkOcapri_log</test_stub_interface>
    <test_script>Recorder_RMF_Disable_LongpollServer_During_Recording_Inline_242</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
