...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1089</id>
  <version>2</version>
  <name>E2E_DVRTrickPlay_Fwd_4x_05</name>
  <primitive_test_id>530</primitive_test_id>
  <primitive_test_name>TDKE2E_Get_Record_URLS</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests rewind operation sequentially on all recorded urls at the speed 4x than normal speed for playback  in End-to-End scenario.
Test Case ID : E2E_DVRTrickPlay_Fwd_4x_05</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVRTrickPlay_Fwd_4x_05</test_case_id>
    <test_objective>DVR – To verify Full Frame Fast forward operation at speed “4x” than normal speed for playback.</test_objective>
...
4. TM reads the log file to extract each recorded url and appends Play_speed = 4x and time_pos = 8000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVRTrickPlay_Fwd_4x_05</test_script>
    <skipped>No</skipped>
    <release_version>M21</release_version>
    <remarks>Parameters are Play_speed = 4.000000 and time_position =8000</remarks>
  </test_cases>
</xml>
