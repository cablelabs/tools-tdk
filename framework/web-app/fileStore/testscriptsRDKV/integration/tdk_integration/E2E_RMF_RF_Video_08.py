...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1111</id>
  <version>1</version>
  <name>E2E_RMF_RF_Video_08</name>
  <primitive_test_id>557</primitive_test_id>
  <primitive_test_name>TDKE2E_RMF_Linear_simultuning</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_RF_Video_08: To verify 6 SD services are playing from six XI3 boxes simultaneously.	
Note: Tested only with 2 XI3 client Boxes.</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RF_Video_08</test_case_id>
    <test_objective>To verify 6 SD services are playing from six XI3 boxes simultaneously.</test_objective>
    ...
    <automation_approch>1)Connect six XI3 client boxes through XG1.                              2)Agent will be running in all the 6 xi3 boxes.              3)Framework schedules to select six linear TV channels in each box simultaneously.                    4)And requests agent to tune to 6 SD channels.                       5)There should not be any issue to watch six linear TV channels simultaneously</automation_approch>
    ...
    <test_script>E2E_RMF_RF_Video_08</test_script>
    <skipped>Yes</skipped>
