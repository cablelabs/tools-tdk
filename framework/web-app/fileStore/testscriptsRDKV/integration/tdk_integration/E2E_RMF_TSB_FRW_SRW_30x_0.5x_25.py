...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1194</id>
  <version>1</version>
  <name>E2E_RMF_TSB_FRW_SRW_30x_0.5x_25</name>
  <primitive_test_id>577</primitive_test_id>
  <primitive_test_name>TDKE2E_RMF_TSB_Play</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check tsb live trickplay playback with -30x FRW speed followed by -0.5x SRW speed. 
Test case ID - E2E_RMF_TSB_25</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_RMF_TSB_25</test_case_id>
    <test_objective>E2E_TSB- To check tsb live trickplay playback with -30x FRW speed followed by -0.5x SRW speed.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-X13_1</test_setup>
    <pre_requisite>Requesturl: http://Ipaddress:port /videoStreamInit?live=ocap://ID 
SpeedRate:-30.0 SpeedRate: -0.5</pre_requisite>
...
TestMgr_TSB_Play</test_stub_interface>
    <test_script>E2E_RMF_TSB_FRW_SRW_30x_0.5x_25</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Rmf_TSB_25');
