...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1012</id>
  <version>9</version>
  <name>E2E_RMF_DVR_TrickPlay_17</name>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_17: To verify the video playback when Fast rewind is done at -64x speed from the middle of the playback.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_17</test_case_id>
    <test_objective>To verify the video playback when Rewind is done at 64x max speed from the middle of the playback</test_objective>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_17</test_script>
    <skipped>No</skipped>
