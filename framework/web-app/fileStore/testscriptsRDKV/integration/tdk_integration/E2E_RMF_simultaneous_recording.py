...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_17</test_case_id>
    <test_objective>Recorder-Simultaneous Record 2 Clear Programme Instances with no Live view</test_objective>
...
Checkpoint 2 Verifying the ocapRI_log to check the state of Recording.</except_output>
    ...
    <test_script>E2E_RMF_simultaneous_recording</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
