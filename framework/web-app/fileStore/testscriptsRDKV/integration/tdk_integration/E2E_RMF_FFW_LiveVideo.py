...
<xml>
  ...
  <name>E2E_RMF_FFW_LiveVideo</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test performs Fast Forward with speed 30x on buffered live video.
Test case ID: E2E_RMF_TSB_58</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_RMF_FFW_LiveVideo');
