...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_21</test_case_id>
    <test_objective>LinearTV – To Verify Playback of a stream with MPEG-2(Transport Stream) Video with MP3.</test_objective>
...
4.TM sends the Response Url to the LinearTV_agent for playback with the mplayer application.</automation_approch>
    <except_output>Checkpoint 1.Verifying the mplayer log for successful playback of MPEG-2/MP3 streams. Mplayer log will have the pattern "+++" for Successful play back.
Checkpoint 2 Error code parameter of Json response is verified as success or failure.</except_output>
    ...
    <test_script>E2E_LinearTV_MPEG2_MP3_21</test_script>
    <skipped>No</skipped>
