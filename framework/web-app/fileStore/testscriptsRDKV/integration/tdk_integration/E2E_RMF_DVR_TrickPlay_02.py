...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>997</id>
  <version>19</version>
  <name>E2E_RMF_DVR_TrickPlay_02</name>
  <primitive_test_id>556</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_LinearTv_Dvr_Play</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_02: To verify the video playback when Fast Forward is done at 8x speed from the starting point of the video</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_02</test_case_id>
    <test_objective>To verify the video playback when Fast Forward is done at 8x speed from the starting point of the video</test_objective>
...
PlayURL: 'http://192.168.30.80:8080/vldms/dvr?rec_id=114556&amp;1&amp;play_speed = 8.00&amp;time_pos=0.00'</input_parameters>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_02</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in result.upper():
	 ...
	 streamDetails = tdkTestObj.getStreamDetails("01");	 
         if matchList:
             ...
             url = url + "&play_speed=8.00&time_pos=0.00"
