...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_27</test_case_id>
    <test_objective>Try to delete the ongoing record content when live recording is in progress in  XG1 .</test_objective>
...
TDKIntegration_Stub</test_stub_interface>
    <test_script>E2E_RMF_delete_ongoingRecord_liverecord_Inprogress</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
rec_obj.configureTestCase(ip,port,'E2E_RMF_delete_ongoingRecord_liverecord_Inprogress');
media_obj.configureTestCase(ip,port,'E2E_RMF_delete_ongoingRecord_liverecord_Inprogress');
