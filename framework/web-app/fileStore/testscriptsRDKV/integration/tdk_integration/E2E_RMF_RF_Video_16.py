...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_RF_Video_16: To verify the fast channel change when 4 SD services  &amp; 1 HD services  are decoded simultaneously.
Note: Tested only with 2 XI3 client Boxes.</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RF_Video_16</test_case_id>
    <test_objective>To verify the fast channel change when 4 SD services  &amp; 1 HD services  are decoded simultaneously.</test_objective>
...
4) And framework schedules the agent to fast change the channel to another HD channel on the boxes</automation_approch>
    ...
    <test_script>E2E_RMF_RF_Video_16</test_script>
    <skipped>Yes</skipped>
