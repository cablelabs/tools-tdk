...
TestCase ID: E2E_RMF_TSB_56</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RMF_TSB_56</test_case_id>
    <test_objective>E2E_TSB- To check tsb live trickplay playback with different trick rates for  long duration.</test_objective>
...
Checkpoint 2 Error code parameter of Json response is verified as success or failure.</except_output>
    ...
    <test_stub_interface>tdkIntegrationstub.so</test_stub_interface>
    <test_script>TDK_E2E_LinearTv_LinearTrickplay_LongDuration_8hr_Test</test_script>
    <skipped>No</skipped>
