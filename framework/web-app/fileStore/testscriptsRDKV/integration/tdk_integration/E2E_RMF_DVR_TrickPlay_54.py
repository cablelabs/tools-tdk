...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1044</id>
  <version>4</version>
  <name>E2E_RMF_DVR_TrickPlay_54</name>
  <primitive_test_id>538</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Play_Pause_Pause</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_54: To verify the dvr pause on already paused playback.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_54</test_case_id>
    <test_objective>To verify the dvr pause on already paused playback.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-XI3_1</test_setup>
    <pre_requisite>- No other recording is scheduled to start during the test.                                                                       - XG1 and XI3 board should be up and running in same network</pre_requisite>
...
Checkpoint 3. Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_54</test_script>
    <skipped>No</skipped>
