...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1084</id>
  <version>4</version>
  <name>E2E_RMF_DVR_TrickPlay_30</name>
  <primitive_test_id>555</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Skip_Forward_Play</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_30: To verify the video playback when Skip forward is done multiple times from the starting point of the video</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_30</test_case_id>
    <test_objective>To verify the video playback when Skip forward is done multiple times from the starting point of the video</test_objective>
...
Checkpoint 2: Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_30</test_script>
    <skipped>No</skipped>
