...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1085</id>
  <version>2</version>
  <name>E2E_DVR_Invalid_TimePosition_13</name>
  <primitive_test_id>530</primitive_test_id>
  <primitive_test_name>TDKE2E_Get_Record_URLS</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests rewind operation sequentially on all recorded urls at the speed -300x than normal speed for playback  in End-to-End scenario.
Test Case ID: E2E_ DVRTrickPlay_13</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_Invalid_TimePosition_13</test_case_id>
    <test_objective>DVR – To verify the invalid time position scenario in playback feature.</test_objective>
...
4. TM reads the log file to extract each recorded url and appends time_pos = -3000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVR_Invalid_TimePosition_13</test_script>
    <skipped>No</skipped>
    <release_version>M21</release_version>
    <remarks>Parameters are time_position =-3000 / time_position =abcd</remarks>
  </test_cases>
</xml>
