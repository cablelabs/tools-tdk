...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1009</id>
  <version>12</version>
  <name>E2E_RMF_DVR_TrickPlay_14</name>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_14: To verify the video playback when Fast rewind is done at -8x speed from the middle of the playback.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_14</test_case_id>
    <test_objective>To verify the video playback when Rewind is done at 8x speed from the middle of the playback</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-XI3_1</test_setup>
    <pre_requisite>- At least one video must be selected for playing from recording list with minimum duration of 3mins.      
- No other recording is scheduled to start during the test.                                                                       - XG1 and XI3 board should be up and running in same network                                                                   - XG1 should have one or more recordings in it.</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>Parameters:
PlayURL: 'http://192.168.30.80:8080/vldms/dvr?rec_id=114556&amp;1&amp;play_speed=4.00&amp;time_pos=0.00' 
Speed: -8.0</input_parameters>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_14</test_script>
    <skipped>No</skipped>
