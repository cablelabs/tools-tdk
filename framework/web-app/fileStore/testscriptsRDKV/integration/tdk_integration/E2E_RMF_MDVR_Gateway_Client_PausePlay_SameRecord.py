...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_MDVR_20</test_case_id>
    <test_objective>To verify that when XG1 playback pause on the recorded content  try to playback the same recorded content in 2 client boxes from XG1</test_objective>
...
4) TM reads Success or Failure message from each connected client and sends final result.</automation_approch>
    ...
    <test_script>E2E_RMF_MDVR_Gateway_Client_PausePlay_SameRecord</test_script>
    <skipped>No</skipped>
