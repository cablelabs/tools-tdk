...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_03</test_case_id>
    <test_objective>To verify the video playback when Fast Forward is done at 16x speed from the starting point of the video</test_objective>
...
PlayURL: 'http://192.168.30.80:8080/vldms/dvr?rec_id=114556&amp;1&amp;play_speed = 16.00&amp;time_pos=0.00'</input_parameters>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_03</test_script>
    <skipped>No</skipped>
