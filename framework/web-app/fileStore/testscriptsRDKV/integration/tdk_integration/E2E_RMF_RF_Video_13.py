...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_RF_Video_13: To verify that fast channel change feature supports in all five linear TV signals tuned to XG1 from all six XI3 client boxes decoding only  SD services simultaneously.
Note: Tested only with 2 XI3 client Boxes.</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RF_Video_13</test_case_id>
    <test_objective>To verify that fast channel change feature supports in all five 5 linear TV signals tuned to XG1 from all five XI3 client boxes decoding only  SD services simultaneously.</test_objective>
    ...
    <automation_approch>1)Connect XI3 client box through XG1.                                2)Agent will be running in the xi3 box.                   3)Framework requests agents to tune to a SD channel.                       4) And framework schedules the agent to fast change the channel to another SD channel on the boxes</automation_approch>
    ...
    <test_script>E2E_RMF_RF_Video_13</test_script>
    <skipped>Yes</skipped>
