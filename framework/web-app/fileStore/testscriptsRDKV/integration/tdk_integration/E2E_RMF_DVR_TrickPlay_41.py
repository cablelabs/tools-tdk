...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1034</id>
  <version>4</version>
  <name>E2E_RMF_DVR_TrickPlay_41</name>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_41: To verify the transition in the video playback by allowing the video to play for sometime and then do Fast Forward to the ending point and then do Rewind at various speeds.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_41</test_case_id>
    <test_objective>To verify the transition in the video playback by allowing the video to play for sometime and then do Fast Forward to the ending point and then do Rewind at various speeds</test_objective>
...
Checkpoint 3. Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_41</test_script>
    <skipped>No</skipped>
