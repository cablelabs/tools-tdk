...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1207</id>
  <version>1</version>
  <name>E2E_RMF_TSB_FFW_FFW_60x_30x_51</name>
  <primitive_test_id>541</primitive_test_id>
  <primitive_test_name>TDKE2E_RMFLinearTV_GetURL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check tsb live trickplay playback with 60x FFW speed followed by 30x FFW speed. Test case ID-E2E_RMF_TSB_51</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_RMF_TSB_51</test_case_id>
    <test_objective>E2E_TSB- To check tsb live trickplay playback with 60x FFW speed followed by 30x FFW speed.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-X13_1</test_setup>
    <pre_requisite>Requesturl: http://Ipaddress:port /videoStreamInit?live=ocap://ID
SpeedRate:60.0 SpeedRate: 30.0</pre_requisite>
...
TestMgr_TSB_Play</test_stub_interface>
    <test_script>E2E_RMF_TSB_FFW_FFW_60x_30x_51</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Rmf_TSB_51');
