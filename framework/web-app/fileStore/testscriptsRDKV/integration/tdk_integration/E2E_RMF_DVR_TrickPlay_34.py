...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1027</id>
  <version>5</version>
  <name>E2E_RMF_DVR_TrickPlay_34</name>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_34: To verify the video playback when Skip backward is done once after the video has reached the end point.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_34</test_case_id>
    <test_objective>To verify the video playback when Skip backward is done after the video has reached the end point</test_objective>
...
Checkpoint 2: Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_34</test_script>
    <skipped>No</skipped>
