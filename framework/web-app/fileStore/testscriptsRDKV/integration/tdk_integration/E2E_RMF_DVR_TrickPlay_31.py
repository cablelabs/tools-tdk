...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1024</id>
  <version>4</version>
  <name>E2E_RMF_DVR_TrickPlay_31</name>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_31:To verify the video playback when Skip forward is done once from the middle of the video playback.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_31</test_case_id>
    <test_objective>To verify the video playback when Skip forward is done once from the middle of the video playback</test_objective>
...
Checkpoint 2: Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_31</test_script>
    <skipped>No</skipped>
