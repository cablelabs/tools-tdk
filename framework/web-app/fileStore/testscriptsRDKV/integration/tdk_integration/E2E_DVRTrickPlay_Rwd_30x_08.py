...
Test Case ID: E2E_DVRTrickPlay_Rwd_30x_08</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_DVRTrickPlay_Rwd_30x_08</test_case_id>
    <test_objective>DVR – To verify trickplay rate of 30x than normal stream speed in reverse direction for playback .</test_objective>
...
4. TM reads the log file to extract each recorded url and appends Play_speed = -30x and time_pos = 8000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVRTrickPlay_Rwd_30x_08</test_script>
    <skipped>No</skipped>
