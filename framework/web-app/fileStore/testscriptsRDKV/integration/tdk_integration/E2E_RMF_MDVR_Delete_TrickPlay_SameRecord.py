...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To verity that recorded content deleted from XG1 when 2 client boxes perform trick play on  the same recorded content from XG1. 	CT_MDVR_5</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_MDVR_16</test_case_id>
    <test_objective>To verity that recorded content delected from XG1 when 2 client boxes perform trick play on  the same recorded content from XG1</test_objective>
...
4) TM reads Success or Failure message from each connected client and sends final result.</automation_approch>
    ...
    <test_script>E2E_RMF_MDVR_Delete_TrickPlay_SameRecord</test_script>
    <skipped>No</skipped>
