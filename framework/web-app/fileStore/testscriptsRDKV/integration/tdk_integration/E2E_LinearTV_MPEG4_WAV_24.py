...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1079</id>
  <version>2</version>
  <name>E2E_LinearTV_MPEG4_WAV_24</name>
  <primitive_test_id>529</primitive_test_id>
  <primitive_test_name>TDKE2E_LinearTV_URL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests the playback of MPEG4 video with WAV audio service in End-to-End scenario Test Case ID : E2E_LinearTV_24</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_24</test_case_id>
    <test_objective>LinearTV – To Verify Playback of a stream with MPEG-4(Transport Stream) Video with WAV.</test_objective>
...
Checkpoint 2 Error code parameter of Json response is verified as success or failure.</except_output>
    ...
    <test_script>E2E_LinearTV_MPEG4_WAV_24</test_script>
    <skipped>No</skipped>
