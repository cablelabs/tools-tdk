...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1224</id>
  <version>1</version>
  <name>E2E_RMF_TSB_FRW_FRW_30x_15x_47</name>
  <primitive_test_id>541</primitive_test_id>
  <primitive_test_name>TDKE2E_RMFLinearTV_GetURL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check tsb live trickplay playback with -30x FRW speed followed by -15x FRW speed. Test case ID-E2E_RMF_TSB_47</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_RMF_TSB_47</test_case_id>
    <test_objective>E2E_TSB- To check tsb live trickplay playback with -30x FRW speed followed by -15x FRW speed.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1-X13_1</test_setup>
    <pre_requisite>Requesturl: http://Ipaddress:port /videoStreamInit?live=ocap://ID 
SpeedRate:-30.0 SpeedRate: -15.0</pre_requisite>
...
TestMgr_TSB_Play</test_stub_interface>
    <test_script>E2E_RMF_TSB_FRW_FRW_30x_15x_47</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'E2E_Rmf_TSB_47');
