...
Testcase ID:E2E_LinearTV_43</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_43</test_case_id>
    <test_objective>LinearTV-Continuous Channel change, DVR playback, DVR forward and rewind for a period of time (8hr)</test_objective>
...
8 TM run the ffw trickplay in 4x 15x 30x and 60x speeds
9 TM run the frw trickplay in -4x -15x -30x and -60x speeds
...
Checkpoint 4. Script to check whether the audio pid and video pid is set</except_output>
    ...
    <test_script>TDK_E2E_LinearTv_SwitchingChannel_DVRForwardAndRewind_LongDuration_8hr_test</test_script>
    <skipped>No</skipped>
