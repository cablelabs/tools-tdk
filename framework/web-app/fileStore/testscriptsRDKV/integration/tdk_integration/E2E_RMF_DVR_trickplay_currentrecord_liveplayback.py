...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_08</test_case_id>
    <test_objective>Recorder-Try to Trick playback the ongoing record content when current live record is in progress</test_objective>
...
6. Perform Trick Play on the recorded content using HnSrc-&gt; Mpsink pipeline.
...
TDKIntegration_Stub</test_stub_interface>
    <test_script>E2E_RMF_DVR_trickplay_currentrecord_liveplayback</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
