...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1021</id>
  <version>11</version>
  <name>E2E_RMF_DVR_TrickPlay_28</name>
  <primitive_test_id>544</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Play_Pause_Play_Repeat</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_28: To verify the pause/play in a video playback by doing pause and play multiple times between the starting and end point of the video</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_28</test_case_id>
    <test_objective>To verify the pause/play in a video playback by doing pause and play multiple times between the starting and end point of the video</test_objective>
...
Rcount: 5</input_parameters>
    <automation_approch>1.TM loads endtoendrmf stub agent via the test agent.
2.TM frames and sends the request URL and number of times play pause sequence as to repeat  for endtoendrmf agent to play a video.
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_28</test_script>
    <skipped>No</skipped>
