...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_RF_Video_15: To verify the fast channel change when 3 SD services  &amp; 2 HD services  are decoded simultaneously. 
Note: Tested only with 2 XI3 client Boxes.</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RF_Video_15</test_case_id>
    <test_objective>To verify the fast channel change when 3 SD services  &amp; 2 HD services  are decoded simultaneously.</test_objective>
    ...
    <automation_approch>1)Connect XI3 client box through XG1.                                2)Agent will be running in the xi3 box.                   3)Framework requests agents to tune to a HD channel on 2 client boxes and 3 boxes with SD chanel.
4) And framework schedules the agent to fast change the channel to another HD channel on the boxes</automation_approch>
    ...
    <test_script>E2E_RMF_RF_Video_15</test_script>
    <skipped>Yes</skipped>
