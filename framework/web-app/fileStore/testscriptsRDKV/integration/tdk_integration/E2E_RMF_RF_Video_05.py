...
Note: Tested only with 2 XI3 client Boxes</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RF_Video_05</test_case_id>
    <test_objective>To verify 4 SD service &amp; 2 HD services are playing from six XI3 boxes simultaneously.</test_objective>
    ...
    <automation_approch>1)Connect six XI3 client boxes through XG1.                              2)Agent will be running in all the 6 xi3 boxes.              3)Framework schedules to select six linear TV channels in each box simultaneously.                    4)And requests agent to tune to 4 SD and 2 HD channels.          5)There should not be any issue to watch six linear TV channels simultaneously</automation_approch>
    ...
    <test_script>E2E_RMF_RF_Video_05</test_script>
    <skipped>Yes</skipped>
