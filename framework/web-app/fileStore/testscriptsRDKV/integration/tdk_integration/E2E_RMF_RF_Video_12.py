...
Note: Tested only with 2 XI3 client Boxes.</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_RF_Video_12</test_case_id>
    <test_objective>To verify that fast channel change feature supports in all five 5 linear TV signals tuned to XG1 from all five XI3 client boxes simultaneously.</test_objective>
    ...
    <automation_approch>1)Connect XI3 client box through XG1.                                2)Agent will be running in the xi3 box.                   3)Framework requests agent to tune to a channel.                       4) And framework request the agent to schedule the box for long time duration.</automation_approch>
    ...
    <test_script>E2E_RMF_RF_Video_12</test_script>
    <skipped>Yes</skipped>
