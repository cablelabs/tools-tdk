...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>E2E_RMF_LIVE_playback_delete_recording</name>
  <primitive_test_id>541</primitive_test_id>
  <primitive_test_name>TDKE2E_RMFLinearTV_GetURL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Try to delete the recorded when XG1  is in live playback</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_24</test_case_id>
    <test_objective>Try to delete the recorded when XG1  is in live playback</test_objective>
...
5.Play the live content using HnSrc-&gt; Mpsink pipeline.
...
TDKIntegration_Stub</test_stub_interface>
    <test_script>E2E_RMF_LIVE_playback_delete_recording</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
import time;
from tdkintegration import deleteRecording
src_element=["HNSrc"]
...
tdk_obj.configureTestCase(ip,port,'E2E_RMF_LIVEplayback_delete_recording');
                ...
                if Expected_Result in result.upper():
                    ...
                    if Expected_Result in result.upper():
						...
						if ("SUCCESS" in result2.upper()):                                        
                                                     ...
                                                     print "Delete Recording failure"
