...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1613</id>
  <version>1</version>
  <name>E2E_RMF_RadioChanneltoHD</name>
  <primitive_test_id>541</primitive_test_id>
  <primitive_test_name>TDKE2E_RMFLinearTV_GetURL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>LinearTV-To check tuning from radio channel to HD video channel. E2E_LinearTV_07</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_45</test_case_id>
    <test_objective>LinearTV-Try to tune from Radio channel to HD channel</test_objective>
...
Checkpoint 2 Error code parameter of Json response is verified as success or failure.</except_output>
    ...
    <test_script>E2E_RMF_RadioChanneltoHD</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'E2E_RMF_RadioChanneltoHD');
