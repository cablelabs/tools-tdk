...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1520</id>
  <version>1</version>
  <name>E2E_RMF_MDVR_Delete_SameRecord</name>
  <primitive_test_id>583</primitive_test_id>
  <primitive_test_name>TDKE2E_MDVR_GetResult</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verity that recorded content delected from XG1 when 2 client boxes playback the same recorded content from XG1 . CT_MDVR_4</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_MDVR_15</test_case_id>
    <test_objective>To verity that recorded content delected from XG1 when 2 client boxes playback the same recorded content from XG1</test_objective>
...
4) TM reads Success or Failure message from each connected client and sends final result.</automation_approch>
    ...
    <test_script>E2E_RMF_MDVR_Delete_SameRecord</test_script>
    <skipped>No</skipped>
...
def TDKE2E_mDVR_PlayUrl(IP,PORT,args=(),kwargs={}):
    ...
    obj.configureTestCase(ip,port,'E2E_RMF_MDVR_Delete_SameRecord');
...
globalObj.configureTestCase(ip,port,'E2E_RMF_MDVR_Delete_SameRecord');
