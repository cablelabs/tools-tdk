...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1043</id>
  <version>5</version>
  <name>E2E_RMF_DVR_TrickPlay_52</name>
  <primitive_test_id>534</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Play_FF_FR_SF_SB</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_52: To verify the playback of a long duration video when (Fast Forward/Rewind) is done at various speeds from the starting point of the video and then (Skip Forward/Skip Backward) is done multiple times.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_52</test_case_id>
    <test_objective>To verify the playback of a long duration video when (Fast Forward/Rewind) is done at various speeds from the starting point of the video and then (Skip Forward/Skip Backward) is done multiple times</test_objective>
...
Checkpoint 3. Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_52</test_script>
    <skipped>No</skipped>
