...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_01</test_case_id>
    <test_objective>Recorder-To check scheduling current recording for radio channel.</test_objective>
...
Checkpoint 2 Verifying the ocapRI_log to check the state of Recording.</except_output>
    ...
    <test_script>E2E_RMF_RadioChannel_Recording</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
if "FAILURE" in result.upper():
        if "RMF_STREAMER_NOT_RUNNING" in loadmoduledetails:
                ...
                print "Module loading status :  %s" %result;
