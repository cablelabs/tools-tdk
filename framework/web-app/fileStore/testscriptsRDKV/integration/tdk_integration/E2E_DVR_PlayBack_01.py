...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1097</id>
  <version>2</version>
  <name>E2E_DVR_PlayBack_01</name>
  <primitive_test_id>530</primitive_test_id>
  <primitive_test_name>TDKE2E_Get_Record_URLS</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests playback feature on all recorded content.
Test Case ID: E2E_DVR_PlayBack_01</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_PlayBack_01</test_case_id>
    <test_objective>DVR – To verify playback feature on all recorded content.</test_objective>
...
4. TM reads the log file to extract each recorded url and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    <except_output>Checkpoint 1.A gstreamer symbol (+++) in e2emplayerappend.txt file.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>DVR_agent</test_stub_interface>
    <test_script>E2E_DVR_PlayBack_01</test_script>
    <skipped>No</skipped>
