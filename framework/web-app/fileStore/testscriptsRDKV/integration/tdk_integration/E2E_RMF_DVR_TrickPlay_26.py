...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1019</id>
  <version>8</version>
  <name>E2E_RMF_DVR_TrickPlay_26</name>
  <primitive_test_id>542</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Pause_Play</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_26: To verify play on a video which is paused.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_26</test_case_id>
    <test_objective>To verify play on a video which is paused.</test_objective>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_26</test_script>
    <skipped>No</skipped>
