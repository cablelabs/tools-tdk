...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_LiveTrickplay_14</test_case_id>
    <test_objective>LinearTV – To verify trickplay rates of 15x than normal stream speed in reverse directions for playback.</test_objective>
...
5. LinearTV_agent creates the t2p message request and sends it to video proxy. Upon receiving the t2p message response the LinearTV_agent extracts Success or Failure message and sends it to TM.</automation_approch>
    <except_output>Checkpoint 1. Verifying the response of t2p message from the video proxy for successful playback trick play with “15x”  reverse direction. T2p message will have the response message as rate=-15, status=”OK” and statusMessage=”Trick Mode request successful”.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>TDKIntegration_Stub</test_stub_interface>
    <test_script>E2E_LinearTV_Live_Trickplay_FRW_15x_14</test_script>
    <skipped>No</skipped>
