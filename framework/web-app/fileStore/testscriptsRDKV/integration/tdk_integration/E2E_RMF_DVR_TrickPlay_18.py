...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1013</id>
  <version>11</version>
  <name>E2E_RMF_DVR_TrickPlay_18</name>
  ...
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_18: To verify the video playback when Rewind is done at 4x speed from the end point of the video</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_18</test_case_id>
    <test_objective>To verify the video playback when Rewind is done at 4x speed from the end point of the video</test_objective>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_18</test_script>
    <skipped>No</skipped>
