...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_46</test_case_id>
    <test_objective>To verify the transition in the video playback by allowing the video to play for sometime, then pause the video and then do Fast Rewind at 4x speed while the video is paused</test_objective>
...
Checkpoint 4: Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_46</test_script>
    <skipped>No</skipped>
