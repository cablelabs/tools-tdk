...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1091</id>
  <version>2</version>
  <name>E2E_DVRTrickPlay_Invalid_PlaySpeed_12</name>
  <primitive_test_id>530</primitive_test_id>
  <primitive_test_name>TDKE2E_Get_Record_URLS</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests invalid time position scenario in playback feature.
Test Case ID : E2E_DVRTrickPlay_Invalid_PlaySpeed_12</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVRTrickPlay_Invalid_PlaySpeed_12</test_case_id>
    <test_objective>DVR – To verify trickplay rate of 27x than normal stream speed in forward direction for playback .</test_objective>
...
4. TM reads the log file to extract each recorded url and appends Play_speed = 27x and time_pos = 8000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVRTrickPlay_Invalid_PlaySpeed_12</test_script>
    <skipped>No</skipped>
    <release_version>M21</release_version>
    <remarks>Parameters are Play_speed= 27.000000 and time_position =8000</remarks>
  </test_cases>
</xml>
