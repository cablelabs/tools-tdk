...
<xml>
  ...
  <name>E2E_LinearTV_Live_Trickplay_FFW_4x_10</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This script tests the playback of fast forward with play speed 4X in LinearTV trickplay scenario Test Case ID : E2E_LinearTV_10</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
