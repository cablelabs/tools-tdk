...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1039</id>
  <version>4</version>
  <name>E2E_RMF_DVR_TrickPlay_48</name>
  <primitive_test_id>545</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Play_Pause_Play_SF_SB</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_48: To verify the video playback by playing the video from the starting point and pausing it after sometime and again playing the video and then doing a (skip forward/skip backward) multiple times.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_48</test_case_id>
    <test_objective>To verify the video playback by playing the video from the starting point and pausing it after sometime and again playing the video and then doing a (skip forward/skip backward) multiple times.</test_objective>
...
Skip Back: 10
Skip Forward: 10
Repeat Count: 5</input_parameters>
    <automation_approch>1.TM loads endtoendrmf stub agent via the test agent.
2.TM frames and sends the request URL,skip forward/backward and number of times to repeat for endtoendrmf agent to play a video.
...
Checkpoint 3. Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_48</test_script>
    <skipped>No</skipped>
