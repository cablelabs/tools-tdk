...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1026</id>
  <version>5</version>
  <name>E2E_RMF_DVR_TrickPlay_33</name>
  <primitive_test_id>553</primitive_test_id>
  <primitive_test_name>TDKE2E_Rmf_Dvr_Skip_Forward_From_End</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>E2E_RMF_DVR_TrickPlay_33: To verify the video playback when Skip forward is done after the video has reached the end point.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_33</test_case_id>
    <test_objective>To verify the video playback when Skip forward is done after the video has reached the end point</test_objective>
...
2.TM frames and sends the request URL and number of seconds to skip for endtoendrmf agent to play a video.
...
Checkpoint 2: Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_33</test_script>
    <skipped>No</skipped>
