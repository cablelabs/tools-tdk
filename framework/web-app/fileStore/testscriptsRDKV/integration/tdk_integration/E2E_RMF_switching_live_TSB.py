...
<xml>
  ...
  <name>E2E_RMF_switching_live_TSB</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Switching between live and TSB modes</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'E2E_RMF_switching_live_TSB');
