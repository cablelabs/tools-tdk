...
Test Case ID : E2E_DVRTrickPlay_Rwd_4x_04</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVRTrickPlay_Rwd_4x_04</test_case_id>
    <test_objective>DVR – To verify Full Frame Fast rewind operation at speed “4x” than normal speed for playback from a http file.</test_objective>
...
4. TM reads the log file to extract each recorded url and appends Play_speed = -4x and time_pos = 8000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVRTrickPlay_Rwd_4x_04</test_script>
    <skipped>No</skipped>
