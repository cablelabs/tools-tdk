...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_TrickPlay_27</test_case_id>
    <test_objective>To verify the pause and play by playing the video from the starting point and pausing it after sometime and then again playing it till the end</test_objective>
...
Checkpoint 3.Check the /proc/video_status for video playing or not. If playing it will be “yes” else “no”.</except_output>
    ...
    <test_script>E2E_RMF_DVR_TrickPlay_27</test_script>
    <skipped>No</skipped>
