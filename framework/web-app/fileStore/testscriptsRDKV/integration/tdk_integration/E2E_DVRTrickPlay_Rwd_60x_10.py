...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1096</id>
  <version>2</version>
  <name>E2E_DVRTrickPlay_Rwd_60x_10</name>
  <primitive_test_id>530</primitive_test_id>
  <primitive_test_name>TDKE2E_Get_Record_URLS</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests rewind operation sequentially on all recorded urls at the speed 60x than normal speed for playback in End-to-End scenario.
Test Case ID : E2E_DVRTrickPlay_Rwd_60x_10</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVRTrickPlay_Rwd_60x_10</test_case_id>
    <test_objective>DVR – To verify trickplay rate of 60x than normal stream speed in reverse direction for playback .</test_objective>
...
4. TM reads the log file to extract each recorded url and appends Play_speed = -60x and time_pos = 8000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVRTrickPlay_Rwd_60x_10</test_script>
    <skipped>No</skipped>
