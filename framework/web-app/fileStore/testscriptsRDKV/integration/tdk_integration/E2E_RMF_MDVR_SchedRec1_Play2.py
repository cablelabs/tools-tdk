...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1291</id>
  <version>3</version>
  <name>E2E_RMF_MDVR_SchedRec1_Play2</name>
  <primitive_test_id>583</primitive_test_id>
  <primitive_test_name>TDKE2E_MDVR_GetResult</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verify if recording scheduled from one XI3 can be viewed in another XI3 connected to same XG1.
Test Case Id: CT_MDVR_10</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_MDVR_10</test_case_id>
    <test_objective>To verify if recording scheduled from one XI3 can be viewed in another XI3 connected to same XG1.</test_objective>
...
4) TM frames a request url to playback the recorded content in step3 on second XI3.
5) TM reads the log file to extract each recorded url and send it to the XI3 agent to play through mplayer.</automation_approch>
    ...
    <test_script>E2E_RMF_MDVR_SchedRec1_Play2</test_script>
    <skipped>Yes</skipped>
...
def TDKE2E_Schedule_Recording(IP,PORT,args=(),kwargs={}):
   ...
   obj.configureTestCase(ip,port,'E2E_RMF_MDVR_SchedRec1_Play2');
...
globalObj.configureTestCase(ip,port,'E2E_RMF_MDVR_SchedRec1_Play2');
...
if "SUCCESS" in result.upper():
	...
	URL2 = tdkintegration.E2E_getStreamingURL(globalObj, "DVR" , streamDetails2.getGatewayIp() , recordID[:-1]);
	if URL2 == "NULL":
		print "Failed to generate the Streaming URL";
		tdkTestObj.setResultStatus("FAILURE");
