...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1144</id>
  <version>1</version>
  <name>E2E_LinearTV_Live_Trickplay_SRW_0.5x_07</name>
  <primitive_test_id>575</primitive_test_id>
  <primitive_test_name>TDKE2E_LinearTV_T2p_Tuning</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests the playback of slow rewind with play speed -0.5 in LinearTV trickplay scenario Test Case ID : E2E_LinearTV_07.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_LiveTrickplay_07</test_case_id>
    <test_objective>LinearTV – To verify Slow rewind  operation at speed 0.5x than normal speed for playback.</test_objective>
...
5. LinearTV_agent creates the t2p message request and sends it to video proxy. Upon receiving the t2p message response the LinearTV_agent extracts Success or Failure message and sends it to TM.</automation_approch>
    <except_output>Checkpoint 1. Verifying the response of t2p message from the video proxy for successful playback with “0.5x” slow rewind. T2p message will have the response message as rate=-0.5, status=”OK” and statusMessage=”Trick Mode request successful”.</except_output>
    <priority>Medium</priority>
    <test_stub_interface>TDKIntegration_Stub</test_stub_interface>
    <test_script>E2E_LinearTV_Live_Trickplay_SRW_0.5x_07</test_script>
    <skipped>No</skipped>
