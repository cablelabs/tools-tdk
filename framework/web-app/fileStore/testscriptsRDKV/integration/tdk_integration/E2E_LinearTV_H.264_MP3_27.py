...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1082</id>
  <version>2</version>
  <name>E2E_LinearTV_H.264_MP3_27</name>
  <primitive_test_id>529</primitive_test_id>
  <primitive_test_name>TDKE2E_LinearTV_URL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script tests the playback of H.264 video with MP3 audio service in End-to-End scenario Test Case ID : E2E_LinearTV_27</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_LinearTV_27</test_case_id>
    <test_objective>LinearTV – To Verify Playback of a stream with H.264 (Transport Stream) Video with MP3.</test_objective>
...
4.TM sends the Response Url to the LinearTV_agent for playback with the mplayer application.</automation_approch>
    <except_output>Checkpoint 1.Verifying the mplayer log for successful playback of H.264/MP3 streams. Mplayer log will have the pattern "+++" for Successful play back.
Checkpoint 2 Error code parameter of Json response is verified as success or failure.</except_output>
    ...
    <test_script>E2E_LinearTV_H.264_MP3_27</test_script>
    <skipped>No</skipped>
