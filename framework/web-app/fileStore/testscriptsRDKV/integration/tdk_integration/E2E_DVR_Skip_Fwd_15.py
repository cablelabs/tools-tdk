...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1098</id>
  <version>2</version>
  <name>E2E_DVR_Skip_Fwd_15</name>
  <primitive_test_id>530</primitive_test_id>
  <primitive_test_name>TDKE2E_Get_Record_URLS</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This testcase tests skip forward operation than normal stream speed in reverse direction for playback.
Test Case ID: E2E_ DVR_Skip_Fwd_15</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_Skip_Fwd_15</test_case_id>
    <test_objective>DVRTrick – To verify the skip forward operation than normal stream speed in reverse direction for playback.</test_objective>
...
2. TM Frames the request url and makes a RPC call to the DVR_agent to get the list of recorded urls.
...
4. TM reads the log file to extract each recorded url and appends  time_pos = 30000 and send it to the DVR_agent to play trhough mplayer.</automation_approch>
    ...
    <test_script>E2E_DVR_Skip_Fwd_15</test_script>
    <skipped>No</skipped>
