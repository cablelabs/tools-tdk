...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>10</version>
  <name>E2E_RMF_DVRPlayback_StandbyMode_to_ONMode</name>
  <primitive_test_id>541</primitive_test_id>
  <primitive_test_name>TDKE2E_RMFLinearTV_GetURL</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Verify DVR playback during and After the STB is from Standby Mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>E2E_DVR_34</test_case_id>
    <test_objective>Try to playback when box is in STANDBY mode and changed to On mode</test_objective>
...
TDK_Integration_Stub</test_stub_interface>
    <test_script>E2E_RMF_DVRPlayback_StandbyMode_to_ONMode</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
