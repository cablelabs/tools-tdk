...
<xml>
  ...
  <name>E2E_LinearTV_Live_Trickplay_FRW_4x_09</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This script tests the playback of fast rewind with play speed -4x in LinearTV trickplay scenario scenario Test Case ID : E2E_LinearTV_09</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
