...
Test Case ID : CT_MDVR_05</synopsis>
  ...
  <test_cases>
    <test_case_id>E2E_MDVR_05</test_case_id>
    <test_objective>To verify that 2 client boxes [XI3] connected to an XG1 box can perform live trickplay on one client box and playback recorded content on another client box simultaneously without any issues.</test_objective>
...
3) TM frames 2 different request urls, one with the ocapId of the channel to be tuned for live trickplay and one with recordingId from the list of recorded urls on DVR agent XG1 and passed it XI3 agents simultaneously to play through mplayer.
4) TM reads Success or Failure message from each connected client and sends final result.</automation_approch>
    ...
    <test_script>E2E_RMF_MDVR_LivePlay_DvrPlay</test_script>
    <skipped>No</skipped>
