...
<xml>
  ...
  <name>TR069_Get_DeviceXCOMFirmwareFileName_15</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective: To fetch the device image name by querying  the tr69Hostif through curl.  Query string "Device.DeviceInfo.X_COMCAST-COM_FirmwareFilename". No set operation avaliable for this parameter.
TestCaseID: CT_TR69_15
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceXCOMFirmwareFileName_15');
...
profilePath = "Device.DeviceInfo.X_COMCAST-COM_FirmwareFilename"
