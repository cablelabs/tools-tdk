...
<xml>
  ...
  <name>RMF_HNSrc_MPSink_DVR_RW_FF_SB_CheckMacroblocking_47</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective: RMF_HNSRC_MPSink –  Do RW FW  and Skip back on the recorded (DVR) content and make sure no freeze/erratic behaviour on doing the trickplays.
Test CaseID: CT_RMF_HNSRC_MPSink_47
...
obj.configureTestCase(ip,port,'RMF_HNSrc_MPSink_DVR_RW_FF_SB_CheckMacroblocking_47');
