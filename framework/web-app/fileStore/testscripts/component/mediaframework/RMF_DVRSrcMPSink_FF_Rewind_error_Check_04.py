...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>On 4X FF trickplay and when it reaches to live point, if Rewind trick play applied, it continues in playback from live point</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RMF_DVRSrcMPSink_FF_Rewind_error_Check_04');
                                                                        ...
                                                                        if expected_Result in result.upper() and "PLAYING" in details.upper():
                                                                                ...
                                                                                if expected_Result in result.upper():
                                                                                        ...
                                                                                        if expected_Result in result.upper():
                                                                                                ...
                                                                                                time.sleep(5);
                                                                                                trickPlay2 = -4.0;																								                                                     src_parameter=["rmfElement","defaultPlay","playSpeed","playTime"];
                                                                                                src_element=["DVRSrc",1,trickPlay2,currentTime];
                                                                                                result=Create_and_ExecuteTestStep('RMF_Element_Play',obj,expected_Result,src_parameter,src_element);
                                                                                                time.sleep(10);
                                                                                                if expected_Result in result.upper():
                                                                                                        src_parameter=["rmfElement"];
