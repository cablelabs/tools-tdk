...
<xml>
  ...
  <name>SM_HdmiCec_DisableCec_SetGetDeviceName</name>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_DisableCec_SetGetDeviceName');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_DisableCec_SetGetDeviceName');
