...
<xml>
  ...
  <name>SM_HdmiCec_DisableCec_SendMsg</name>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_DisableCec_SendMsg');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_DisableCec_SendMsg');
