...
<xml>
  ...
  <name>SM_HdmiCec_EnableCec_SetName_FiveTimes</name>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SetName_FiveTimes');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SetName_FiveTimes');
