...
<xml>
  ...
  <name>SM_HdmiCec_EnableCec_SendMsg</name>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SendMsg');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SendMsg');
        ...
        if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                        if "PRESENT" in existdetails:
                                ...
                                expectedresult = "SUCCESS"
				valueToSetEnabled = 1
				print "Hdmicec enabled: ",valueToSetEnabled
				tdkTestObj.addParameter("valueToSetEnabled",valueToSetEnabled);
					...
					#Clear Cec.txt and the msg to be sent.	
					time.sleep(15)
