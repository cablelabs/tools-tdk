...
<xml>
  ...
  <name>SM_HdmiCec_EnableCec_SetGetSpecialChar_DevName</name>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SetGetSpecialChar_DevName');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SetGetSpecialChar_DevName');
        ...
        if expectedresult in actualresult:
				...
				tdkTestObj.addParameter("valueToSetEnabled",valueToSetEnabled);
					...
					#Set the device Name.
	                                ...
	                                expectedresult = "SUCCESS"
					#Name length as to be 14 Characters
