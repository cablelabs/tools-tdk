...
<xml>
  ...
  <name>SM_HdmiCec_DisableCec_SendReceiveMsg</name>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_DisableCec_SendReceiveMsg');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_DisableCec_SendReceiveMsg');
