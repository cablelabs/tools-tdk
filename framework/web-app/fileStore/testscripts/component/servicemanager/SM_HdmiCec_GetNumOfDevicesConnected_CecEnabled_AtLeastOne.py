...
<xml>
  ...
  <name>SM_HdmiCec_GetNumOfDevicesConnected_CecEnabled_AtLeastOne</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Objective: Service Manager – Checking the number of cec devices connected after enabling CEC. Atleast one hdmicec device is connected.
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SM_HdmiCec_GetNumOfDevicesConnected_CecEnabled_AtLeastOne');
iarm_obj.configureTestCase(ip,port,'SM_HdmiCec_EnableCec_SetGetDeviceName');
...
if expected_Result in loadModuleStatus.upper():
        ...
        if expectedresult in actualresult:
				...
				tdkTestObj.addParameter("valueToSetEnabled",valueToSetEnabled);
					...
					#Get the number of devices connected after enabling the CEC support.
