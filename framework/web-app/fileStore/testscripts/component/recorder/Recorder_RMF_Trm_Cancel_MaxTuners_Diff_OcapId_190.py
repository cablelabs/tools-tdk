...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>CT_Recoder_DVR_Protocol_190 - Recorder to send TRM_CANCELLED error if recording is scheduled for the max number of tuners available with different ocap id and then again scheduling one more recording with different ocap id</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
