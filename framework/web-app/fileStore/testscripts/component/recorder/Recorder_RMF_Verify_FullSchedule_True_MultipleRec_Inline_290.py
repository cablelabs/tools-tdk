...
<xml>
  ...
  <name>Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Inline_290</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Inline_290');
