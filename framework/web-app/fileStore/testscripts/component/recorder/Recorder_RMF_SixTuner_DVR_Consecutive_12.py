...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This is to test Six tuner DVR for consecutive recording	(Schedule every 5 mins)
TC ID: CT_Recorder_12</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Recorder_RMF_SixTuner_DVR_Consecutive_12');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if Id:
                RequestURL = "{\"updateSchedule\" : {\"requestId\" : \"7\", \"schedule\" : [{\"recordingId\" : \""+str(int(recording_id))+"\",\"locator\" : [ \"ocap://"+validid1+"\" ] ,\"epoch\" : ${now} ,\"start\" : "+str(int(start_time))+" ,\"duration\" : "+duration+" ,\"properties\":{\"title\":\"Recording_"+str(int(recording_id))+"\"},\"bitRate\" : \"HIGH_BIT_RATE\" ,\"deletePriority\" : \"P3\" },{\"recordingId\" : \""+str(int(recording_id)+1)+"\",\"locator\" : [ \"ocap://"+validid2+"\" ] ,\"epoch\" : ${now} ,\"start\" : "+str(int(start_time)+30000)+" ,\"duration\" : "+duration+" ,\"properties\":{\"title\":\"Recording_"+str(int(recording_id)+1)+"\"},\"bitRate\" : \"HIGH_BIT_RATE\" ,\"deletePriority\" : \"P3\" },{\"recordingId\" : \""+str(int(recording_id)+2)+"\",\"locator\" : [ \"ocap://"+validid3+"\" ] ,\"epoch\" : ${now} ,\"start\" : "+str(int(start_time)+60000)+" ,\"duration\" : "+duration+" ,\"properties\":{\"title\":\"Recording_"+str(int(recording_id)+2)+"\"},\"bitRate\" : \"HIGH_BIT_RATE\" ,\"deletePriority\" : \"P3\" },{\"recordingId\" : \""+str(int(recording_id)+3)+"\",\"locator\" : [ \"ocap://"+validid4+"\" ] ,\"epoch\" : ${now} ,\"start\" : "+str(int(start_time)+90000)+" ,\"duration\" : "+duration+" ,\"properties\":{\"title\":\"Recording_"+str(int(recording_id)+3)+"\"},\"bitRate\" : \"HIGH_BIT_RATE\" ,\"deletePriority\" : \"P3\" },{\"recordingId\" : \""+str(int(recording_id)+4)+"\",\"locator\" : [ \"ocap://"+validid5+"\" ] ,\"epoch\" : ${now} ,\"start\" : "+str(int(start_time)+120000)+" ,\"duration\" : "+duration+" ,\"properties\":{\"title\":\"Recording_"+str(int(recording_id)+4)+"\"},\"bitRate\" : \"HIGH_BIT_RATE\" ,\"deletePriority\" : \"P3\" },{\"recordingId\" : \""+str(int(recording_id)+5)+"\",\"locator\" : [ \"ocap://"+validid6+"\" ] ,\"epoch\" : ${now} ,\"start\" : "+str(int(start_time)+150000)+" ,\"duration\" : "+duration+" ,\"properties\":{\"title\":\"Recording_"+str(int(recording_id)+5)+"\"},\"bitRate\" : \"HIGH_BIT_RATE\" ,\"deletePriority\" : \"P3\" }]}}";
                ...
                if status_expected in status_actual:
                        ...
                        if expectedresult in actualresult:
                                ...
                                tdkTestObj.setResultStatus("FAILURE");
                        #Sleep till the Recording is complete 
                        time.sleep(900);
                else:
                        tdkTestObj.setResultStatus("FAILURE");
