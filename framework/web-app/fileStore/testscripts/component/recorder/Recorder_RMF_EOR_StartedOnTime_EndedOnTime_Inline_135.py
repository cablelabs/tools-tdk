...
<xml>
  ...
  <name>Recorder_RMF_EOR_StartedOnTime_EndedOnTime_Inline_135</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_EOR_StartedOnTime_EndedOnTime_Inline_135');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	jsonMsg = "{\"updateSchedule\":{\"requestId\":\""+requestID+"\",\"generationId\":\""+genIdInput+"\",\"dvrProtocolVersion\":\"7\",\"schedule\":[{\"recordingId\":\""+ recordingID+"\",\"locator\":[\"ocap://"+ocapId+"\"],\"epoch\":"+now+",\"start\":"+startTime+",\"duration\":"+duration+",\"properties\":{\"title\":\"Recording_"+recordingID+"\"},\"bitRate\":\"HIGH_BIT_RATE\",\"deletePriority\":\"P3\"}]}}"
		...
		print "Retrieve Status Details: %s"%actResponse;
			...
			sleep(300);
		    	print "Sending getRecording to get the recording list "
		    	recorderlib.callServerHandler('clearStatus',ip);
		    	recorderlib.callServerHandlerWithMsg('updateInlineMessage','{\"getRecordings\":{}}',ip)
                       	print "Wait for 60 seconds to getresponse from the recorder"
			sleep(60);
