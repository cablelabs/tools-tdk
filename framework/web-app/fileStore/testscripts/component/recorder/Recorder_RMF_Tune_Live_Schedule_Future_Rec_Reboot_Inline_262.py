...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>CT_Recoder_DVR_Protocol_262 -Recordings should always transition to "StartedInComplete" Not "Started" if it has started with status "StartedWithError"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
