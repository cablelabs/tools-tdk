...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test is to verify 6 Tuner DVR for Future Recording		
TC ID: CT_Recorder_11</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'Recorder_RMF_SixTuner_DVR_Future_11');
