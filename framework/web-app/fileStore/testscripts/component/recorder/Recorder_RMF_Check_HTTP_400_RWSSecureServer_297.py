...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_400_RWSSecureServer_297</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>RWS secure server should send HTTP 400 when the server is enabled with HTTP 400 error and recording should get complete after falling back to HTTP connection</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_400_RWSSecureServer_297');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	loadmoduledetails = recObj.getLoadModuleDetails();
        ...
        if "true" in actResponse:
            ...
            print "Waiting for fallback to HTTP Connection and recording to get completed"
            sleep(180);
