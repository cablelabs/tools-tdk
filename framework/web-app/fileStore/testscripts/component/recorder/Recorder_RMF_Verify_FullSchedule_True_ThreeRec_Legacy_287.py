...
<xml>
  ...
  <name>Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Legacy_287</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Legacy_287');
