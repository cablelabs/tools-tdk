...
<xml>
  ...
  <name>Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Legacy_289</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_MultipleRec_Legacy_289');
