...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_500_RWSSecureStatus_Fullsync_332</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>RWS secure status server should send HTTP 500 when the server is enabled with HTTP 500 error and recorder should send full sync in boot up after falling back to HTTP connection</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_500_RWSSecureStatus_Fullsync_332');
...
obj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_500_RWSSecureStatus_Fullsync_332');
