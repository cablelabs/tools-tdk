...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>CT_DVR_PROTOCOL_154 - Recorder should not send Erased state while canceling a future recording using Inline fullschedule=true mechanism</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
