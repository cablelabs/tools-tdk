...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_400_RWSSecureStatus_Legacy_302</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>RWS secure status server should send HTTP 400 when the server is enabled with HTTP 400 error and recorder should send failed status for leagcy recording after falling back to HTTP connection</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_400_RWSSecureStatus_Legacy_302');
