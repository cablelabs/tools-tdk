...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_404_LPSecureServer_Inline_308</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Long poll secure server should send HTTP 404 when server is enabled with HTTP 404 error and after clearing the error  inline recording should get complete</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_404_LPSecureServer_Inline_308');
