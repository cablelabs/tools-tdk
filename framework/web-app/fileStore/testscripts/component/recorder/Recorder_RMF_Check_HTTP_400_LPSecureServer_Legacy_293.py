...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_400_LPSecureServer_Legacy_293</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Long poll secure server should send HTTP 400 when server is enabled with HTTP 400 error and after clearing the error  legacy recording should get complete.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_400_LPSecureServer_Legacy_293');
