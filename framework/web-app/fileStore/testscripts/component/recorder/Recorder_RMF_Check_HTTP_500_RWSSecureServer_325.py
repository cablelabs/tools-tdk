...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_500_RWSSecureServer_325</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>RWS secure server should send HTTP 500 when the server is enabled with HTTP 500 error and recording should get complete after falling back to HTTP connection</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_500_RWSSecureServer_325');
