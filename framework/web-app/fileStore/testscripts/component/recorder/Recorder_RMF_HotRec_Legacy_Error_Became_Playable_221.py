...
<xml>
  ...
  <name>Recorder_RMF_HotRec_Legacy_Error_Became_Playable_221</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Recorder should send Error=BECAME_PLAYABLE for hot legacy recording if 5-second requirement is subsequently met after already sending NOT_YET_PLAYABLE</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'Recorder_RMF_HotRec_Legacy_Error_Became_Playable_221');
