...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_400_RWSSecureServer_Bootup_298</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>RWS secure server should send HTTP 400 when the server is enabled with HTTP 400 error and recording scheduled in boot up should get complete after falling back to HTTP</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_400_RWSSecureServer_Bootup_298');
...
obj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_400_RWSSecureServer_Bootup_298');
