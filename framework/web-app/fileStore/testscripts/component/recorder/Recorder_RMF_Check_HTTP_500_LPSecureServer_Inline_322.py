...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_500_LPSecureServer_Inline_322</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Long poll secure server should send HTTP 500 when server is enabled with HTTP 500 error and after clearing the error  inline recording should get complete</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_500_LPSecureServer_Inline_322');
...
if "SUCCESS" in recLoadStatus.upper():
	...
	loadmoduledetails = recObj.getLoadModuleDetails();
        ...
        actResponse = recorderlib.callServerHandlerWithTypeAndError('enableError','LPSecureServer',ip,'500');
