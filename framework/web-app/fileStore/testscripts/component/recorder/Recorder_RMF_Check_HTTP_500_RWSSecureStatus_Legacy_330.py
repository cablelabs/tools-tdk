...
<xml>
  ...
  <name>Recorder_RMF_Check_HTTP_500_RWSSecureStatus_Legacy_330</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Check_HTTP_500_RWSSecureStatus_Legacy_330');
