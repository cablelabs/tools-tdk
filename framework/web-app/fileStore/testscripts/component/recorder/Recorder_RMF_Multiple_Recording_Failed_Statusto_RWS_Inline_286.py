...
<xml>
  ...
  <name>Recorder_RMF_Multiple_Recording_Failed_Statusto_RWS_Inline_286</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Multiple_Recording_Failed_Statusto_RWS_Inline_286');
