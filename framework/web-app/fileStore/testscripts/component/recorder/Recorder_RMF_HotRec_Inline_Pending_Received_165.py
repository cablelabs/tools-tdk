...
<xml>
  ...
  <name>Recorder_RMF_HotRec_Inline_Pending_Received_165</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Recorder should send Pending status in a full sync when a recording is scheduled.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'Recorder_RMF_HotRec_Inline_Pending_Received_165');
	...
	loadmoduledetails = obj.getLoadModuleDetails();
        ...
        if "updateSchedule" in serverResponse:
                ...
                if "acknowledgement" in recResponse:
                        ...
                        # After reboot schedule Hot Inline recording in order to get pending status
                        startTime2 = "0";
