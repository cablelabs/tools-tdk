...
<xml>
  ...
  <name>Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Inline_288</name>
...
recObj.configureTestCase(ip,port,'Recorder_RMF_Verify_FullSchedule_True_ThreeRec_Inline_288');
