...
<xml>
  ...
  <name>DS_SetTime_STRING_FORMAT_43</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test script Sets and gets the STRING Time Format  display of given Front panel Indicator
Test Case ID : CT_DS_43</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <remarks>Time format not supported</remarks>
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if expectedresult in actualresult:
                ...
                print "TimeFormat set %s" %time_format;
                actualresult = tdkTestObj.getResult();
