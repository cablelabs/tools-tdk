...
<xml>
  ...
  <name>DS_SetDFC_PanScan_ZOOM_test_78</name>
  ...
  <!--  -->
  <synopsis>This test script Sets and gets the PanScan Zoom Settings of Video Device
Test Case ID : CT_DS_78</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
if "SUCCESS" in loadmodulestatus.upper():
		...
		print "Details: ",dfcdetails
                ...
                if expectedresult in actualresult:
                        print "SUCCESS :Application successfully gets and sets the zoom settingt as PanScan for the video device";
			tdkTestObj.setResultStatus("SUCCESS");
                else:
