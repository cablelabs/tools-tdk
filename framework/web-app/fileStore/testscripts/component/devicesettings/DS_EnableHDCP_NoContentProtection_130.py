...
<xml>
  ...
  <name>DS_EnableHDCP_NoContentProtection_130</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test HDCP authentication without content protection.
TestcaseID: CT_DS130</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <remarks>There is no mechanism to disable HDCP by Bcom Soc</remarks>
...
obj.configureTestCase(ip,port,'DS_EnableHDCP_NoContentProtection_130');
