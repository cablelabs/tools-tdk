...
<xml>
  ...
  <name>DS_SetPowerMode_Invalid_test_98</name>
  ...
  <!--  -->
  <synopsis>This test script Sets and gets the Power Mode to an Invalid value
Test Case ID:CT_DS_98.	NOTE: This test fails due tio bug in DS component.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
