...
<xml>
  ...
  <name>DS_SetDFC_Zoom16x9_test_79</name>
  ...
  <!--  -->
  <synopsis>This test script Sets and gets the Zoom 16x9 Zoom Settings of Video Device
Test Case ID : CT_DS_79</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
if "SUCCESS" in loadmodulestatus.upper():
		...
		print "Details: ",dfcdetails
                ...
                if expectedresult in actualresult:
                        print "SUCCESS :Application successfully gets and sets the zoom settingt as Zoom 16x9 for the video device";
			tdkTestObj.setResultStatus("SUCCESS");
                else:
