...
<xml>
  ...
  <name>DS_SetDFC_CCO_ZOOM_test_77</name>
  ...
  <!--  -->
  <synopsis>This test script Sets and gets the CCO Zoom Settings of Video Device
Test Case ID : CT_DS_77</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
if "SUCCESS" in loadmodulestatus.upper():
		...
		print "Details: ",dfcdetails
                ...
                if expectedresult in actualresult:
                        print "SUCCESS :Application successfully gets and sets the zoom settingt as CCO for the video device";
			tdkTestObj.setResultStatus("SUCCESS");
                else:
