...
<xml>
  ...
  <name>DS_SetDFC_PLATFORM_ZOOM_test_76</name>
  ...
  <!--  -->
  <synopsis>This test script Sets and gets the PLATFORM Zoom Settings of Video Device
Test Case ID : CT_DS_76</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
