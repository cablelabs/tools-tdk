...
<xml>
  ...
  <name>DS_SetDFC_Pillarbox4x3_ZOOM_test_80</name>
  ...
  <!--  -->
  <synopsis>This test script Sets and gets the Pillarbox4x3 Zoom Settings of Video Device
Test Case ID : CT_DS_80</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <remarks>This Zoom type is not supported</remarks>
...
if "SUCCESS" in loadmodulestatus.upper():
		...
		print "Details: ",dfcdetails
                ...
                if expectedresult in actualresult:
                        print "SUCCESS :Application successfully gets and sets the zoom settingt as Pillarbox 4x3 for the video device";
			tdkTestObj.setResultStatus("SUCCESS");
                else:
