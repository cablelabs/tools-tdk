...
<xml>
  ...
  <name>DS_PowerMode Listener test_13</name>
  ...
  <!--  -->
  <synopsis>This script will check for adding and removing powermode change listener.
TestCase ID:13
Note:This script will not work becaus "setPowerMode" API is not yet implemented in devicesettings component</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
