...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP –  To check TIME_ZONE event is receieved or not when the event is trigerred from the IARM test app			TCID: CT_XUPNP_14</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'CT_XUPNP_14');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj1.addParameter("evtName","timeZone");
  tdkTestObj1.addParameter("evtValue","TimeZone");
