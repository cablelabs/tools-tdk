...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP –  To check the tune ready event is received or not when the event is trigerred from the IARM test app	TCID:CT_XUPNP_09</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj1.configureTestCase(ip,port,'CT_XUPNP_09');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj1.addParameter("evtName","tuneReady");
  tdkTestObj1.addParameter("evtValue","TuneReady");
