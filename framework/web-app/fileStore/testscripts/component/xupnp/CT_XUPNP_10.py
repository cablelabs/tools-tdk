...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP –  To check the channel map event is receieved or not when the event is trigerred from the IARM test app	TCID:CT_XUPNP_10</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj1.configureTestCase(ip,port,'CT_XUPNP_10');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj1.addParameter("evtName","channelMap");
  tdkTestObj1.addParameter("evtValue","Channelmap");
