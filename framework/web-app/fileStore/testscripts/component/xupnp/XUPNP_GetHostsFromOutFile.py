...
Testcase ID: CT_XUPNP_10</synopsis>
  ...
  <remarks>TDK agent is not able to hold huge string value in "details" field</remarks>
...
iarmObj.configureTestCase(ip,port,'XUPNP_GetHostsFromOutFile');
...
if "SUCCESS" in iarmLoadStatus.upper():
        ...
        if "SUCCESS" in result:
                ...
                if "SUCCESS" in result:
                        ...
                        xUpnpObj.configureTestCase(ip,port,'XUPNP_GetHostsFromOutFile');
                        #Get the result of connection with test component and STB
