...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP –  To check the plant id event is received or not when the event is triggered from the IARM test app   TCID	:CT_XUPNP_12</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'CT_XUPNP_12');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj1.addParameter("evtName","plantID");
  tdkTestObj1.addParameter("evtValue","PLANT ID");
