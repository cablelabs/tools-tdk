...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP – To check whether the recordID is correct or not.
TCID:CT_XUPNP_05</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_XUPNP_05');
...
if "Success" in loadmodulestatus:
  ...
  #calling XUPNP API "TestMgr_XUPNPAgent_recordId"
  tdkTestObj = obj.createTestStep('TestMgr_XUPNPAgent_recordId');
  ...
  if "SUCCESS" in actualresult.upper():
    ...
    print "SUCCESS: XUPNPAgent_recordId";
  else:
    tdkTestObj.setResultStatus("FAILURE");
    print "FAILURE:  XUPNPAgent_recordId %s " %details;   
