...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP –  To check the vod server id update event is receieved or not when the event is trigerred from the IARM test app	TCID:CT_XUPNP_13</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
        ...
        if ("SUCCESS" in actualresult):
                ...
                if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                                ...
                                print "setstate: %d"%setstate;
                                print "seterror: %d"%seterror;
                                print "setpayload: %s"%setpayload;
...
obj1.configureTestCase(ip,port,'CT_XUPNP_13');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj1.addParameter("evtName","vodID");
  tdkTestObj1.addParameter("evtValue","VOD AD");
