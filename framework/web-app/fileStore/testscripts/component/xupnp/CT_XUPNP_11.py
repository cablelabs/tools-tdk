...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>XUPNP –  To check the  controller id (DAC ID)event  is receieved or not when the event is trigerred from the IARM test app TCID:CT_XUPNP_11</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj1.addParameter("evtName","controllerID");
  tdkTestObj1.addParameter("evtValue","DAC ID");
