...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –  To sets DTCP Manager's logging verbosity level.	TCID:CT_DTCP_11</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_11');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj.addParameter("param1", 3);
  ...
  if "SUCCESS" in dtcp_Init_actualresult.upper():
    ...
    print "Details of the result : %s" %dtcp_Init_actualresult;
