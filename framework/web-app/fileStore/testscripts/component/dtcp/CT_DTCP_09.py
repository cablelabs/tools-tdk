...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –  To  retrieve the total number of active sessions for the specified device type.		TCID:CT_DTCP_09</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_09');
