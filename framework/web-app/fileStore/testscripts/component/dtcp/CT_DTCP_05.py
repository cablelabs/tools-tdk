...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –To create a new authenticated session with a remote DTCP-IP sink.		TCID:CT_DTCP_05</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_05');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj.addParameter("param1", "NULL");
  tdkTestObj.addParameter("param2", 8080);
  tdkTestObj.addParameter("param3", 8);
  tdkTestObj.addParameter("param4", 1);
