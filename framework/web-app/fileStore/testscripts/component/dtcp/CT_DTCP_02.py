...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –to start the DTCP-IP source and begins listening for AKE requests
 * on the specified interface and port number.			TCID:CT_DTCP_02</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_02');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj.addParameter("param1", "ipaddress");
  tdkTestObj.addParameter("param2", 80);
