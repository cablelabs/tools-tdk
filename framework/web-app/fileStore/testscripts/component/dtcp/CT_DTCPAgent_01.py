...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –initializes the DTCP-IP Manager sub-system. - TC ID - CT_DTCP_01</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCPAgent_01');
...
if "Success" in loadmodulestatus:
  ...
  if "SUCCESS" in dtcp_Init_actualresult.upper():
    ...
    print "SUCCESS: Application successfully initialized with DTCP";
  else:
    tdkTestObj.setResultStatus("FAILURE");
    print "FAILURE: In Initializing DTCP with %s " %details;   
