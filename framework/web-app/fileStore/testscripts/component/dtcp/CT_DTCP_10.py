...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –  To  retrieves information related to an active session.				TCID:CT_DTCP_10</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_10');
