...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP –  releases the DTCP-IP packet.The processed packet may contain DTCP Manager allocated/owned
 * buffers/memory - this call frees up these resources. TCID:CT_DTCP_07</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_07');
