...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP – stops the DTCP-IP source and removes all AKE request listeners
 * added with ::DTCPMgrStartSource().   	TCID: CT_DTCP_03</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_03');
