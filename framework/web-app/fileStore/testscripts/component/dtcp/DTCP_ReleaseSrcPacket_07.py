...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To release source DTCP-IP packet. The processed packet may contain DTCP Manager allocated/owned buffers/memory - this call frees up these resources. 
TestType: Positive
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_ReleaseSrcPacket_07');
