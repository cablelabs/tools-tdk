...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>DTCP – To create a new authenticated session with a remote DTCP-IP source TCID :CT_DTCP_04</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'CT_DTCP_04');
...
if "Success" in loadmodulestatus:
  ...
  tdkTestObj.addParameter("param2", 8);
  tdkTestObj.addParameter("param3", 0);
