...
<xml>
  ...
  <name>IARMBUS_Init_with_Invalidparameter_test_43</name>
  ...
  <!--  -->
  <synopsis>This test script tests Initializing IARMBUS with parameter as symbols as input
TEST CASE ID:CT_IARMBUS_43</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
