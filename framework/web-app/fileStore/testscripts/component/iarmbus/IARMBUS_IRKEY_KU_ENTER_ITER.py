...
<xml>
  ...
  <name>IARMBUS_IRKEY_KU_ENTER_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on ENTER key KEYUP events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KU_ENTER_ITER');
