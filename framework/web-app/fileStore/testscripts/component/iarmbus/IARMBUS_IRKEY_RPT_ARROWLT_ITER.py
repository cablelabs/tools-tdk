...
<?xml version="1.0" encoding="iso-8859-1" ?><xml>
	...
	<name>IARMBUS_IRKEY_RPT_ARROWLT_ITER</name>
	...
	<status>FREE</status>
	<!---->
	<synopsis>				Iterate on ARROW LEFT key KEYREPEAT events, time and average.</synopsis>
	<!---->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_RPT_ARROWLT_ITER');
