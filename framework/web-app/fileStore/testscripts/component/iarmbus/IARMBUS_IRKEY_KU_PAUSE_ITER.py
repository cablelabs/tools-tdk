...
<?xml version="1.0" encoding="iso-8859-1" ?><xml>
	...
	<name>IARMBUS_IRKEY_KU_PAUSE_ITER</name>
	...
	<status>FREE</status>
	<!---->
	<synopsis>				Iterate on PAUSE key KEYUP events, time and average.</synopsis>
	<!---->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KU_PAUSE_ITER');
