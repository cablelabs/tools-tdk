...
<xml>
  ...
  <name>IARMBUS_IRKEY_KD_NUMPOUND_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on NUMPOUND key KEYDOWN events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KD_NUMPOUND_ITER');
