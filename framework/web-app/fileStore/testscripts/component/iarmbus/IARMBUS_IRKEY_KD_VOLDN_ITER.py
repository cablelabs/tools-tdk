...
<xml>
  ...
  <name>IARMBUS_IRKEY_KD_VOLDN_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on VOLDN key KEYDOWN events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KD_VOLDN_ITER');
