...
<xml>
  ...
  <name>IARMBUS_IRKEY_KU_KEYC_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on KEYC key KEYUP events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KU_KEYC_ITER');
