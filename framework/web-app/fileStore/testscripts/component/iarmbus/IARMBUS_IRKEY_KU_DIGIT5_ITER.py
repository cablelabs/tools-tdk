...
<xml>
  ...
  <name>IARMBUS_IRKEY_KU_DIGIT5_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on DIGIT5 key KEYUP events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KU_DIGIT5_ITER');
