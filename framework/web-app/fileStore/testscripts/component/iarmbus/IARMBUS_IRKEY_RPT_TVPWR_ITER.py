...
<xml>
  ...
  <name>IARMBUS_IRKEY_RPT_TVPWR_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on TVPWR key KEYREPEAT events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_RPT_TVPWR_ITER');
