...
<xml>
  ...
  <name>IARMBUS_IRKEY_KD_ARROWDN_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on ARROWDN key KEYDOWN events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KD_ARROWDN_ITER');
