...
<xml>
  ...
  <name>IARMBUS_IRKEY_KU_ARROWLT_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on ARROW LEFT key KEYUP events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KU_ARROWLT_ITER');
