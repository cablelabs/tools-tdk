...
<xml>
  ...
  <name>IARMBUS_PowerModeToggle_Trickplay</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Tests if STB is able to tune to linear channel when going from standby to on state.
Testcase ID: CT_IARMBUS_114</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
iarmObj.configureTestCase(ip,port,'IARMBUS_PowerModeToggle_Trickplay');
...
tdkIntObj.configureTestCase(ip,port,'IARMBUS_PowerModeToggle_Trickplay');
