...
<xml>
  ...
  <name>IARMBUS_IRKEY_KD_DIGIT4_ITER</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Iterate on DIGIT4 key KEYDOWN events, time and average.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'IARMBUS_IRKEY_KD_DIGIT4_ITER');
