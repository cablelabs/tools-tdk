...
<xml>
  ...
  <!--  -->
  <synopsis>This test script will execute webkit-5 test suite.
This test script will be applicable to XG1 with RDK version 1.3 running boxes.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
