...
def TDKE2E_mDVR_PlayUrl(IP,PORT,args=(),kwargs={}):
   ...
   obj.configureTestCase(ip,port,'E2E_RMF_MDVR_TrickPlay_Gateway_Client_SameRecord');
...
globalObj.configureTestCase(ip,port,'E2E_RMF_MDVR_TrickPlay_Gateway_Client_SameRecord');
