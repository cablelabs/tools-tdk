...
<xml>
  ...
  <name>E2E_Rmf_LinearTV_MPEG2_AC3_17</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This script tests the playback of MPEG2 video with AC3 audio service in End-to-End scenario Test Case ID : E2E_LinearTV_17</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
