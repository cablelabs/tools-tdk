...
<xml>
  ...
  <name>E2E_RMF_HDtoRadioChannel</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>LinearTV-To check tuning from HD channel to Radio channel - E2E_LinearTV_06</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
obj.configureTestCase(ip,port,'E2E_RMF_HDtoRadioChannel');
