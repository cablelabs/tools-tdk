...
<xml>
  ...
  <name>E2E_Rmf_LinearTV_TuneSD-SD_03</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This script tests tuning of an SD service from another SD service in End-to-End scenario
Test Case ID : E2E_LinearTV_03</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
