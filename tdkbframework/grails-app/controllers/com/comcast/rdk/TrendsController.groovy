...
class TrendsController {
	...
	def chart() {
		...
		if('RDKV'.equals(category.trim())){
			/*executionList = c.list {
			 eq('category', Category.RDKV)
			 eq('isBenchMarkEnabled',true)
			 eq('isSystemDiagnosticsEnabled',true)
		...
		//render(template : 'chart', model:[executionList : executionList, category:category])
