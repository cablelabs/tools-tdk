...
//		output += new ScriptExecutor(opFile).execute( getCommand( executionData ), execTime)
	...
	public String executeTclScript(final String tclExecutableFile, final String configFile, int execTime, final String executionName, final String scriptName, final String scriptDir) {
		...
		output += new ScriptExecutor(opFile).executeTCL( command, execTime,executionName,executionProcessMap, scriptDir)
...
//	}
	...
	public boolean saveExecutionDetailsOnMultipleScripts(final String execName, String scriptName, String deviceName,
		String scriptGroupInstance , String appUrl,String isBenchMark , String isSystemDiagnostics,String rerun,String isLogReqd, final int scriptCount, final String category){
