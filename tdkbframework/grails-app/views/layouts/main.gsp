...
%>	
			...
			<td nowrap="nowrap"
				...
				<div id="header" align="left">
						<ul id="test">
							...
							<g:if test="${SecurityUtils.getSubject().hasRole('ADMIN')}">
								<%--<li id="padded"><g:link controller="module" action="configuration">
									...
									<span>Configure</span>
									<ul>
										<li><g:link action="configuration" controller="module"	params="[category:'RDKV']">RDK-V</g:link></li>
										<li><g:link action="configuration" controller="module"	params="[category:'RDKB']">RDK-B</g:link></li>
									</ul>
									</a>
							--%></g:if>
	...
	<div>
		<label> <b> RDK Test Development Kit Broadband - M01 </b></label>
	</div>
	</div>
