			...
			<tr>
				...
				<td style="width: 84%;">
					<div style="width: 100%; overflow: auto;">
							...
							<g:form controller="execution">
								<table>
									...
									<tr>
										...
										<td valign="middle"><input type="text" id="datepicker"
											name="fromDate" /></td>
										<td valign="middle">To</td>
										<td valign="middle"><input type="text" id="todatepicker"
											name="toDate" /></td>
										<td></td>
										<td valign="middle"></td>
									</tr>
									<tr>
										...
										<td valign="middle"><select name="resultStatus"
											id="resultStatus" style="width: 150px">
									...
									<tr>
										...
										<td valign="middle"><select name="scriptType"
											id="scriptType" onchange="showScriptTypes();"
											style="width: 150px">
												<option value="">--Please Select--</option>
												<option value="Script">SINGLE SCRIPT</option>
												<option value="TestSuite">SCRIPTGROUP</option>
										</select></td>
										<td valign="middle"><span id="scriptLabel"
											style="display: none;">Script/ScriptGroup</span></td>
										<td valign="middle"><span id="scriptVal"
											style="display: none;"><g:textField id="scriptValue"
													name="scriptVal" /></span></td>
										<td></td>
										<td valign="middle" width="20%"><span class="buttons">
												<g:submitToRemote before="displayWaitSpinner();"
													class="find" action="multisearch" update="searchResultDiv"
													value="Search" onSuccess="hideWaitSpinner();" />
										</span> <img src="../images/less.png" title="Simple Search"
											onclick="showMinSearch();"></img> <span id="spinnr"
											style="display: none;"> <img id="ss"
												src="${resource(dir:'images',file:'spinner.gif')}" />
										</span></td>
									</tr>
									<tr>
						...
						<div id="searchResultDiv" style="width: 100%; overflow: auto;"
							class="veruthe"></div>
