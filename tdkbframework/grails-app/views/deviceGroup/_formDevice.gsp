...
<div class="fieldcontain ${hasErrors(bean: deviceInstance, field: 'stbName', 'error')} required">
	...
	<g:if test="${deviceInstance?.category}">
...
<g:if test= "${deviceInstance.isChild  == 0}">
	...
	<g:if test="${deviceInstance.category == Category.RDKB}">
	<div class="fieldcontain ${hasErrors(bean: deviceInstance, field: 'serialNo', 'error')} ">
		<label for="serialNo">
			<g:message code="device.serialNo.label" default="Serial No" />
		</label>
		<g:textField name="serialNo" id="serialNo" required="" value="${deviceInstance?.serialNo}" class="textwidth"/>
	</div>
	</g:if>
	<div class="fieldcontain ${hasErrors(bean: deviceInstance, field: 'boxType', 'error')} required">
		...
		<g:select onchange="javascript:showFields();" id="boxType" name="boxType.id" noSelection="['' : 'Please Select']" from="${com.comcast.rdk.BoxType.findAllByCategory(category)}" optionKey="id" required="" value="${deviceInstance?.boxType?.id}" class="many-to-one selectCombo"/>
	</div>
	...
	<div class="fieldcontain ${hasErrors(bean: deviceInstance, field: 'boxManufacturer', 'error')} required">
		...
		<g:select id="boxManufacturer" name="boxManufacturer.id" noSelection="['' : 'Please Select']" from="${com.comcast.rdk.BoxManufacturer.findAllByCategory(category)}" optionKey="id" required="" value="${deviceInstance?.boxManufacturer?.id}" class="many-to-one selectCombo"/>
	</div>
	...
	<div class="fieldcontain ${hasErrors(bean: deviceInstance, field: 'soCVendor', 'error')} required">
		...
		<g:select id="soCVendor" name="soCVendor.id" noSelection="['' : 'Please Select']" from="${com.comcast.rdk.SoCVendor.findAllByCategory(category)}" optionKey="id" required="" value="${deviceInstance?.soCVendor?.id}" class="many-to-one selectCombo"/>
	</div>
</g:if>
<g:if  test="${ (deviceInstance?.boxType?.type?.toLowerCase() != 'gateway')  && (deviceInstance?.category == Category.RDKV)}" >
