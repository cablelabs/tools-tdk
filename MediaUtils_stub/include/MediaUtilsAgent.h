...
class MediaUtilsAgent : public RDKTestStubInterface  , public AbstractServer<MediaUtilsAgent>
{
        public:
                ...
                MediaUtilsAgent(TcpSocketServer &ptrRpcServer) : AbstractServer <MediaUtilsAgent>(ptrRpcServer)
                {
                 ...
                 this->bindAndAddMethod(Procedure("TestMgr_MediaUtils_Get_DefaultSettings", PARAMS_BY_NAME, JSON_STRING,NULL), &MediaUtilsAgent::MediaUtils_Get_DefaultSettings);
                 this->bindAndAddMethod(Procedure("TestMgr_MediaUtils_Get_Current_Settings", PARAMS_BY_NAME, JSON_STRING,"paramHandle", JSON_STRING,NULL), &MediaUtilsAgent::MediaUtils_Get_Current_Settings);
                 this->bindAndAddMethod(Procedure("TestMgr_MediaUtils_Get_Status", PARAMS_BY_NAME, JSON_STRING,NULL), &MediaUtilsAgent::MediaUtils_Get_Status);
