...
int main(int argc,char **argv)
{
    ...
    DEBUG_PRINT(DEBUG_TRACE,"[gen_single_event pid=%d] Client Entering \n", getpid());
    DEBUG_PRINT(DEBUG_TRACE,"[gen_single_event pid=%d] Connect second application\n", getpid());
    ...
    else if(strcmp(ownerName,"DummyTestMgr")==0)
    {
        ...
        DEBUG_PRINT(DEBUG_LOG,"[gen_single_event pid=%d] DummyTestMgr Triggering events.. \n",getpid());
        if(eventId == 0)
        {
    ...
    DEBUG_PRINT(DEBUG_TRACE,"[gen_single_event pid=%d] Disconnect second application\n",getpid());
    IARM_Bus_Disconnect();
    IARM_Bus_Term();
    DEBUG_PRINT(DEBUG_TRACE,"[gen_single_event pid=%d] Bus Client Exiting\r\n",getpid());
    DEBUG_PRINT(DEBUG_TRACE,"[gen_single_event pid=%d] <-----------SECOND APPLICATION---Exit-------------->\n",getpid());
}
